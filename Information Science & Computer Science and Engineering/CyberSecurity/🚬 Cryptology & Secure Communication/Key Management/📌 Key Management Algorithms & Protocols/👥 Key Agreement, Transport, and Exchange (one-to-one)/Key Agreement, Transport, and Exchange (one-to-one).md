# Key Agreement, Transport, and Exchange (one-to-one)
...
> 🤖 GPT 5.2
> https://chatgpt.com/share/699c1f05-da30-800f-8197-e60181ff86a8

In cryptography, a **key transport protocol** is ==a mechanism where one party (the sender) generates a secret session key and securely transfers it to another party (the receiver)==. This differs from _key agreement_ (like Diffie-Hellman), where both parties contribute to the key's creation.

- **Key transport** → I create a password and securely send it to you.
- **Key agreement** → We each provide a secret ingredient and independently cook the same dish.
- **Key exchange** → Any method we use to end up with the same password.
- **Key distribution** → The entire system for managing and delivering passwords.
