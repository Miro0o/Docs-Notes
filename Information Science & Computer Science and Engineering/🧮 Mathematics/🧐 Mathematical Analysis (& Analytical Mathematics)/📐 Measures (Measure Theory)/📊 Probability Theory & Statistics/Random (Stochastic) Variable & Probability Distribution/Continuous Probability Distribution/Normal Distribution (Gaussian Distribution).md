...
In probability theory and statistics, a normal distribution or Gaussian distribution is a type of continuous probability distribution for a real-valued random variable. The general form of its probability density function is[2][3][4] $$f(x)={\frac {1}{\sqrt {2\pi \sigma ^{2}}}}e^{-{\frac {(x-\mu )^{2}}{2\sigma ^{2}}}}$$
![](../../../../../../../Assets/Pics/Pasted%20image%2020260322154531.png)
<small><a>https://analystprep.com/cfa-level-1-exam/quantitative-methods/key-properties-normal-distribution/</a></small>
