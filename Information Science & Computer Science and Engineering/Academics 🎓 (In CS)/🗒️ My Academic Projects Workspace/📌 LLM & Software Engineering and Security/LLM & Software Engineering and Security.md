...
- [Screening decisions](Literature-Corpus/screening.csv) make every formal record auditable; unresolved high-recall candidates are visible rather than silently discarded.
