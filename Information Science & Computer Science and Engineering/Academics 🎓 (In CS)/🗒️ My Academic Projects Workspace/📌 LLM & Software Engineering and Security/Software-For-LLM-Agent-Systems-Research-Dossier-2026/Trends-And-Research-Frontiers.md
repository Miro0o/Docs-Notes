...
| Human supervision | From a final approval button toward designed control boundaries throughout specification, composition, diagnosis, release, escalation, and maintenance. | Make uncertainty, compiled behavior, causal evidence, authority, and ownership legible without creating automation bias or approval fatigue. | [Shared Human Factor](../LLM-Software-Security-Research-Dossier-2026/Human-Factor.md) |
