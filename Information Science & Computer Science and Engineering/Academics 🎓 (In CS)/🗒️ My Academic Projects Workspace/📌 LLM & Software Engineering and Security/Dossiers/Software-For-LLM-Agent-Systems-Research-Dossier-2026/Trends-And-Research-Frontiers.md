...
| Human supervision | From a final approval button toward designed control boundaries throughout specification, composition, diagnosis, release, escalation, and maintenance. | Make uncertainty, compiled behavior, causal evidence, authority, and ownership legible without creating automation bias or approval fatigue. | [Shared Human Factor](../../Human-Factor%20in%20LLM%20&%20Software.md) |
