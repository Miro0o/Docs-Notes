...
| Review and change governance | Can reviewers validate and trace agent-generated changes without being overwhelmed by plausible but low-value evidence? | [Code review, change governance, and traceability](Academic-Status/Code-Review-Change-Governance-And-Traceability.md); [Shared Human Factor](../../Human-Factor%20in%20LLM%20&%20Software.md) |
...
| User interaction and learning | Do multimodal tools improve accessible software and durable developer capability? | [Human-facing software](Academic-Status/Human-Facing-Software-UI-UX-Education-And-Developer-Experience.md); [Shared Human Factor](../../Human-Factor%20in%20LLM%20&%20Software.md) |
