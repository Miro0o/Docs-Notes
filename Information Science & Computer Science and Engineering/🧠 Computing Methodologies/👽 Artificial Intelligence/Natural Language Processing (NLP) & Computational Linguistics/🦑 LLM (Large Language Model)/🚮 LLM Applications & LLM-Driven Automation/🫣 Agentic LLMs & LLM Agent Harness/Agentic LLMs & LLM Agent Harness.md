...
### LLM Agent Workflows, Dev, and Utilization
↗ [LLM Utilization & Prompt, Context, and Harness Engineering](../../LLM%20Training,%20Utilization,%20and%20Evaluation/LLM%20Utilization%20&%20Prompt,%20Context,%20and%20Harness%20Engineering/LLM%20Utilization%20&%20Prompt,%20Context,%20and%20Harness%20Engineering.md)
...
A coding agent actually has several layers:
```
┌─────────────────────────────────────────────┐
│ Product interface                           │
│ Terminal, IDE, desktop UI, installation     │
├─────────────────────────────────────────────┤
│ Coding-agent harness                        │
│ Prompts, tools, context, permissions, loop  │
├─────────────────────────────────────────────┤
│ Framework / SDK / runtime                   │
│ LangGraph, Agent SDK, Pi core, custom code  │
├─────────────────────────────────────────────┤
│ Model API                                   │
...
The cleanest final map
```
Claude / GPT / Gemini
        │
        │ model APIs
        ▼
Agent SDK or runtime
LangGraph / Claude Agent SDK / Pi core / Vercel AI SDK / custom code
        │
        │ developers assemble
        ▼
Agent harness
Prompts + tools + loop + context + permissions + skills
        │
        │ add product experience
        ▼
Coding-agent product
Pi / Claude Code / OpenCode / dcode
```
