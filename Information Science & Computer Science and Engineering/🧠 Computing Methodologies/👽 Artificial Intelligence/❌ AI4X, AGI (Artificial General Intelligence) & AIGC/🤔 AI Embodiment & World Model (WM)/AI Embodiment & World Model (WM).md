...
## Ref
[93 【关于具身智能领域的两座大山 - Blake Yang | 小红书 - 你的生活兴趣社区】 😆 nkvkWPWx5xpBLC2 😆]: https://www.xiaohongshu.com/discovery/item/69251b7a000000001e00db4d?source=webshare&xhsshare=pc_web&xsec_token=ABzM_SKeQ5lgpfdyJw1-YI2FLjaNLTGjeyNT1LtJQd3a0=&xsec_source=pc_share
目前在具身领域，最火的两条路莫过于vla和world model。 vla是一种统一的多模态模型，详见图2。 但是，vla本身虽然发展迅速（诸如近期的pi0.6，generalist ai）但也存在很多局限性，详见图3。 此外，Li feifei，Yann LeCun等诸多学者为“world model”站台，他们认为语言对于智能来说不是必须的，动物没有掌握语言，依旧可以对外界信息作出本能的反应（比如逃避天敌）。因此，之前被广泛应用于视频生成领域的world model走上了具身领域的历史舞台，详见图4。 在当前的研究中，诸多学者选择将vla与world model结合起来（取其精华去其糟粕），构建一个既能“听懂指令”，又能“预见未来”的统一智能体，详见图5。 总之，在未来的发展中，vla和wm这两条赛道的发展既会相互借鉴，又会相互融合，走向一个统一的端到端框架，详见图6。
