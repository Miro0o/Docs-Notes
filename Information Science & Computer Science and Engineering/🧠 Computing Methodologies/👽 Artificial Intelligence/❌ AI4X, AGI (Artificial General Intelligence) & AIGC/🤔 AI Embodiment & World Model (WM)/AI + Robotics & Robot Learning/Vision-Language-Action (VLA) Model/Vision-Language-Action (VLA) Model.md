...
## Ref
[Vision Language Action Models (VLA) Overview: LeRobot Policies Demo]: https://learnopencv.com/vision-language-action-models-lerobot-policy/
...
- [What are Policies in Robots?](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-what-is-generalist-policy)
- [Why we need VLA?](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-why-we-need-vlms)
- [RT-2 from Google](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-rt-2)
- [Octo from UC Berkeley](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-octo)
- [OpenVLA from Stanford](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-openvla)
- [QUAR-VLA: Quadruped Robots from MiLAB](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-4-quar-vla-quadruped-robots-from-milab)
- [ALOHA from Google Deepmind](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-5-aloha-from-google-deepmind)
- [π0: Physical Intelligence](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-0-a-vision-language-action-flow-model-for-general-robot-control)
- [Helix by Figure AI](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-system-1-system-2)
- [GR00T N1 from Nvidia](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-code-walkthrough)
- [Gemini Robotics](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-gemini-robots)
- [Conclusion](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-conclusion)
- [References](https://learnopencv.com/vision-language-action-models-lerobot-policy/#aioseo-references)