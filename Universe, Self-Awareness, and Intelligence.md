...
↗ [Social Science](Other%20Networks%20of%20Knowledge/Social%20Science/Social%20Science.md)
###### 权力与等级
权力是一种社会关系，贯穿整个人类社会。事实上我认为权力关系一切社会关系的原型。同时，一切社会关系皆围绕社会发展的问题形成；而一切社会发展的问题，都可以从社会的构成分方面来看。
...
由于这里讨论社会关系（讨论对象是人），故社会相关的自然资源（本质是自然物体）不会**单独**拿出来作为一个方面讨论，因为这不是我们讨论的对象。但是注意，人是可以支配自然资源的。
...
下节关于人类社会存在（即人类社会发展）的讨论会指出，人类社会发展围绕两个主题：资源的获取与使用。而围绕资源的获取，归纳为两种：权力斗争与科技发展。
- 每一个个人（微观）发展的主题：权力斗争；
...
下图是对此的一些举例。这些例子属于不同的知识学科领域，但他们都表现出相同的核心，即信息的运动就是信息的相互联系。图中用 A -> B 的形式表示这种联系。

![computing.excalidraw | 800](Assets/Illustrations/Computer%20Science%20Philosophy/computing.excalidraw.md)

我们把事物之间的一个联系作为一个操作单位，对这些操作单位再进行联系，我们就得到了“规律”，或者说“知识”。本篇之前说过，知识就是信息的组织。那么这里的组织是什么意思呢？这种联系的联系，就是组织。
- 也就是说，知识就是信息的组织 <=> 信息的联系的联系就是知识，这两个命题是等价的。
...
不过，本节是关于个人发展的话题，故对阶级的讨论重点放在了阶级的跨越，而不是阶级斗争。
