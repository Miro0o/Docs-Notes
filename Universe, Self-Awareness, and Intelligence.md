...
站在现代的角度，这种取向，或者说社会认可的信息运动轨迹，或者说我们所认为的那些可以被称为“正确”的知识，主要有两种方向：科学与逻辑。科学的知识，就是用实验（客观宇宙）验证后的知识（观测宇宙）；逻辑的知识，就是从已知宇宙进行推理后得到的关于未知宇宙的知识。根据这种信息运动的取向，我们可以对知识的领域不断细分，这就好比不断对一个图求它的子图的划分。所以，这其实就是知识领域的分类。比如，科学 -> 自然科学 -> 物理学 -> 凝聚态物理学。
