...
这里引用一个无意中看到的非常喜欢的文章：↗ [光明与觉醒：宇宙自我认知的千年回音](Information%20Science%20&%20Computer%20Science%20and%20Engineering/🗺%20CS%20Overview/Appendix/光明与觉醒：宇宙自我认知的千年回音.md)。这篇文章深刻地结合理性与感性的认知，讨论了自我，自指，自我意识，宇宙等一系列事物的关系。很大程度上我想在我的这篇文章表达的思想也在这位作者的文章中被从另一个角度和例子表达了出来。不过我们的区别在于，我的笔记注重系统、全面、结构化、模块化的记录，且没有什么情感的流露（语言表述也比较粗糙），而这篇文章浑然一体，既有深刻的理性思考也有浪漫的感性认知，文笔流畅。
##### 主体视角下的宇宙：物质，能量，信息 ⭐
给出如下（我认为正确的）结论：
...
站在现代的角度，这种取向，或者说社会认可的信息运动轨迹，或者说我们所认为的那些可以被称为“正确”的知识，主要有两种方向：科学与逻辑（基于演绎法的逻辑）。科学的知识，就是用实验（客观宇宙）验证后的知识（观测宇宙）；逻辑的知识，就是从已知宇宙进行推理后得到的关于未知宇宙的知识。根据这种信息运动的取向，我们可以对知识的领域不断细分，这就好比不断对一个图求它的子图的划分。所以，这其实就是知识领域的分类。比如，科学 -> 自然科学 -> 物理学 -> 凝聚态物理学。
- 在人类文明发展的历史中，我们还有很多其他对知识的取向。最容易想到的就是宗教信仰。

在实际中，这种知识刻画，或者说自我意识对宇宙的反映（思考），分为三个方面：自我意识对自我的反映，自我意识对非我的反映，及自我意识对自我和非我间关系的反映。即，这三个方面就是：情感，逻辑，时间。基于情感的知识和基于逻辑的知识分别对应人文艺术，及科学（自然科学+社会科学）。时间是情感和逻辑的起源/基石/主体。
...
###### 人工智能：现状与未来
人工智能目前还处于上述所说的计算机智能的范围（狭义的智能）。未来，人工智能的愿景是实现与人类智能水平同等级的类人智能（广义的智能）。从狭义的智能到广义的智能有两个重要的里程碑。第一个就是智能体拥有自我意识，即所谓的“奇点”。这个过程见图 “From CS to AGI: Computing and Intelligence”。第二个就是智能体不再停留在信息层面，智能体拥有与真实世界交互的能力，即具身智能。
