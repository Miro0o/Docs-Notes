...
### Learning Resources
#### For Basics & Short-time Learning
...
- book contents
	- [_Chapter 1: Fundamentals_](https://algs4.cs.princeton.edu/10fundamentals) introduces a scientific and engineering basis for comparing algorithms and making predictions. It also includes our programming model.
	- [_Chapter 2: Sorting_](https://algs4.cs.princeton.edu/20sorting) considers several classic sorting algorithms, including insertion sort, mergesort, and quicksort. It also features a binary heap implementation of a priority queue.
	- [_Chapter 3: Searching_](https://algs4.cs.princeton.edu/30searching) describes several classic symbol-table implementations, including binary search trees, red–black trees, and hash tables.
	- [_Chapter 4: Graphs_](https://algs4.cs.princeton.edu/40graphs) surveys the most important graph-processing problems, including depth-first search, breadth-first search, minimum spanning trees, and shortest paths.
	- [_Chapter 5: Strings_](https://algs4.cs.princeton.edu/50strings) investigates specialized algorithms for string processing, including radix sorting, substring search, tries, regular expressions, and data compression.
	- [_Chapter 6: Context_](https://algs4.cs.princeton.edu/60context) highlights connections to systems programming, scientific computing, commercial applications, operations research, and intractability.
