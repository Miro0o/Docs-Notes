...
- **`PXELINUX`**, used for booting from a network server using the ↗ [PXE (Preboot Excution Environment)](Network%20Booting/PXE%20(Preboot%20Excution%20Environment).md) system
