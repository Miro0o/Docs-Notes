...
## Router
> 🏃‍♂ For more info, check out [Router](Data%20Plane/Router.md) 



## 👾 IP(Internet Protocol)
> 🏃‍♂ For more info, check out [Internet Protocol](Internet Protocol.md) 
...
## IP Multicasting
> 🏃‍♂ For more info, check out  [Multicasting](Data%20Plane/Multicasting.md).



## Mobile IP
> 🏃‍♂ For more info, check out [Mobile IP](Mobile IP.md) 



## SDN
> 🏃‍♂ For more info, check out [SDN](../../SDN/SDN.md) 
