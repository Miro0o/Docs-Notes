...
The [*box visual style](http://openbox.org/wiki/Openbox:Themes "Openbox:Themes") is well known for its minimalistic appearance. Openbox uses the *box visual style, while providing a greater number of options for theme developers than previous *box implementations. The [theme documentation](http://openbox.org/wiki/Help:Themes "Help:Themes") describes the full range of options found in Openbox themes.
...
Take a look at the [getting started guide](http://openbox.org/wiki/Help:Getting_started "Help:Getting started") and change how you manage your desktop.
