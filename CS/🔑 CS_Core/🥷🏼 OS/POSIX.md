...
<img src="../../../Assets/Pics/400px-Diagram_of_Mac_OS_X_architecture.svg.png" alt="img" style="zoom:150%;" />
...
- [MKS Toolkit](https://en.wikipedia.org/wiki/MKS_Toolkit), originally created for MS-DOS, is a software package produced and maintained by [MKS Inc.](https://en.wikipedia.org/wiki/MKS_Inc.) that provides a [Unix-like](https://en.wikipedia.org/wiki/Unix-like) environment for scripting, connectivity and porting [Unix](https://en.wikipedia.org/wiki/Unix) and [Linux](https://en.wikipedia.org/wiki/Linux) software to both 32- and 64-bit [Microsoft Windows](https://en.wikipedia.org/wiki/Microsoft_Windows) systems. A subset of it was included in the first release of [Windows Services for UNIX](https://en.wikipedia.org/wiki/Windows_Services_for_UNIX) (SFU) in 1998.[[40\]](https://en.wikipedia.org/wiki/POSIX#cite_note-40)[[41\]](https://en.wikipedia.org/wiki/POSIX#cite_note-41)
- [Windows C Runtime Library](https://en.wikipedia.org/wiki/Microsoft_Windows_library_files#Runtime_libraries) and [Windows Sockets API](https://en.wikipedia.org/wiki/Winsock) implement commonly used POSIX API functions for file, time, environment, and socket access,[[42\]](https://en.wikipedia.org/wiki/POSIX#cite_note-42) although the support remains largely incomplete and not fully interoperable with POSIX-compliant implementations.

### Mostly POSIX-compliant[[edit source](https://en.wikipedia.org/w/index.php?title=POSIX&action=edit&section=14)]
