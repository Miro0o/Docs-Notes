...
- _n._ [inactive](dic://inactive)
	...
	- [approximately](dic://approximately) 多用于书面语，指精确度接近某个标准以致误差可忽略不计。  
...
- angelica
- angelic
	- [angelical](dic://angelical), [beatific](dic://beatific), [saintlike](dic://saintlike), [saintly](dic://saintly), [sainted](dic://sainted)
...
- [blunder](dic://blunder), [blooper](dic://blooper), [bloomer](dic://bloomer), [bungle](dic://bungle), [pratfall](dic://pratfall), [foul-up](dic://foul-up), [fuckup](dic://fuckup), [flub](dic://flub), [boner](dic://boner), [boo-boo](dic://boo-boo)
- botchy
- botcher
- botch-up
...
boner
- **dick**阴茎;**cock**公鸡;**pussy**猫咪;**dildo**假阴茎;**penis**阳物，阴茎;**twat**笨蛋;**asshole**屁眼儿,肛门;**cunt**女性阴部;**erection**直立;**boobs**乳房;**hottie**热水瓶;
...
boor
- - n. 农民；粗野的人；不懂礼貌的人
-  [peasant](dic://peasant), [barbarian](dic://barbarian), [churl](dic://churl), [Goth](dic://Goth), [tyke](dic://tyke), [tike](dic://tike)
- _n._ [unpleasant person](dic://unpleasant person), [disagreeable person](dic://disagreeable person)
- **vulgar**粗俗的;**pompous**浮夸的;**bigot**偏执的人;**moron**痴愚者;**rude**粗鲁的;**idiot**白痴;**crass**粗鲁的;**coward**懦夫，懦弱的人;**obnoxious**可憎的;**hypocrite**伪君子;**condescending**降低身份的,屈尊的;
- She has thrown herself away upon that boor from sheer ignorance that better individuals existed! /只因为她全然不知道天下还有更好的人，她就嫁给了那个乡下佬！
- boorish
	-  [loutish](dic://loutish), [neanderthal](dic://neanderthal), [neandertal](dic://neandertal), [oafish](dic://oafish), [swinish](dic://swinish)
	- _adj._ [unrefined](dic://unrefined)
	- _n._ [refined](dic://refined)
	- **obnoxious**可憎的;**crass**粗鲁的;**arrogant**自大的，傲慢的;**vulgar**粗俗的;**pompous**浮夸的;**condescending**降低身份的,屈尊的;**bigoted**顽固的;**rude**粗鲁的;**brash**仓促的，性急的;**belligerent**好战的;**insensitive**不敏感的;
	...
	-  He found Jobs's boorish behavior as despicable as Jobs found Sculley's lack of passion for product details /他觉得乔布斯的行为粗鲁可鄙，这程度就和乔布斯鄙视他对产品细节缺乏激情一样。
...
- jackboot
	...
	- _n. [boot](dic://boot)
	- **tyranny**暴政;**totalitarian**极权主义的;**fascist**法西斯主义者;**fascism**法西斯主义;**dictatorship**独裁;**oppression**压迫手段;**tyrannical**暴君的,暴君似的;**stomp**跺;**stomping**跺脚;**tyrant**暴君;**authoritarian**权力主义的,专制的;
	- _[jackboot tactics](dic://jackboot%20tactics)_ 战蹄政策; 强迫别人屈从的粗暴手段;
- freeboot
	- freebooter
- booty
	- [loot](dic://loot), [pillage](dic://pillage), [plunder](dic://plunder), [prize](dic://prize), [swag](dic://swag), [dirty money](dic://dirty money)
	- _n._ [stolen property](dic://stolen property)
	- **boobs**乳房;**ass**驴子;**butt**笑柄;**asses**屁股;**babe**婴儿，小孩;**dick**阴茎;**butts**托;**plunder**抢夺;**boob**蠢材，笨蛋;**bum**流浪汉;**pussy**猫咪;
	- _play booty_ ◎勾结；朋比为奸;◎合伙欺骗某个参赛者(或参加游戏者);◎参加故意输掉的游戏(或比赛);
- boottree
- bootstrapping
	- _[bootstrap](dic://bootstrap)_  n. [计] 引导程序，辅助程序；解靴带
	- _[bootstraping](dic://bootstraping)_  n. [计] 引导指令
	- _[bootstrapping](dic://bootstrapping)_  n. 自举电路；引导指令；自展; v. 依靠自己的努力获得成功；自展（bootstrap的ing形式）; 
	- _[bootstrap protocol](dic://bootstrap%20protocol)_  自举协议；[计] 引导协议
	- _[bootstrap memory](dic://bootstrap%20memory)_  [计] 引导存储器
- bootmaker
- bootlick
	- [fawn](dic://fawn), [toady](dic://toady), [truckle](dic://truckle), [kowtow](dic://kowtow), [kotow](dic://kotow), [suck up](dic://suck up)
	- _v._ [flatter](dic://flatter), [blandish](dic://blandish)
	- bootlicker
- bootless
	-  [fruitless](dic://fruitless), [futile](dic://futile), [sleeveless](dic://sleeveless), [vain](dic://vain)
	- _adj._ [unproductive](dic://unproductive)
	- _n._ [productive](dic://productive)
	- **fruitless**没有成果的, 无益的;**futile**无用的;**feeble**微弱的，无力的;**wretched**可怜的;**vain**徒劳的;**weary**疲倦的;**pitiful**可怜的，令人同情的;**abject**卑贱的;**nigh**近于;**scarcely**简直没有;
	- _[bootless bank](dic://bootless%20bank)_ 破产银行
	- _[answer bootless](dic://answer%20bootless)_ 应答失败
	- _[bootless call](dic://bootless%20call)_ 未完成呼叫
	- bootlessness
	- botlessly
- bootleg
	- [moonshine](dic://moonshine), [corn liquor](dic://corn liquor)
	- [black](dic://black), [black-market](dic://black-market), [contraband](dic://contraband), [smuggled](dic://smuggled)
	- _n._ [corn whiskey](dic://corn whiskey), [corn whisky](dic://corn whisky), [corn](dic://corn), [covering](dic://covering)
	- _v._ [sell](dic://sell), [produce](dic://produce), [make](dic://make), [create](dic://create)
	- _adj._ [illegal](dic://illegal)
	- _n._ [legal](dic://legal)
	- **pirated**盗版的;**VHS**家用录像系统;**re-release**再发行,重新发行;**reissue**重新发行;**tapes**胶纸带;**cassette**盒式磁带;**remix**使再混合;**compilation**编辑,编写;**counterfeit**仿制品, 伪造物;**vinyl**乙烯基;**videotape**录像带;
	- _[bootlegged](dic://bootlegged)_  非法制造或贩卖（bootleg 的过去式和过去分词）
	- _[bootlegs](dic://bootlegs)_  n. 私制唱片（bootleg的复数）; v. 非法携带（bootleg的第三人称单数）; 
	- _[bootlegging](dic://bootlegging)_  n. 穿靴筒；非法制造私酒; v. 非法制造；秘密得到（bootleg的ing形式）;
	- bootlegging
	- bootlegger
- bootlace
- bootjack
...
- twinborn
- trueborn
	- _[trueborn](dic://trueborn)_  adj. 嫡出的；道地的；真正的
- stubborn
- stillborn
	- _adj._ [unfruitful](dic://unfruitful), [dead](dic://dead)
	- _n._ [fruitful](dic://fruitful), [live](dic://live)
	- **aborted**流产的;**unborn**未来的;**newborn**新生的;**birth**出生;**baby**婴儿，婴孩;**infant**婴儿;**fetus**胎儿，胎;**miscarriage**流产;**gestation**怀孕;**twins**双生子，双胞胎;**premature**过早的, 提前的, 未到期的;
	- _[stillborn pig](dic://stillborn%20pig)_ 死胎猪
	- _[stillborn play](dic://stillborn%20play)_ 不能吸引观众的戏
	- _[stillborn fetus](dic://stillborn%20fetus)_ 死胎
- slave-born
	- _adj._ 出身于奴隶家庭的
- self-born
	- _adj._ 再生的,自生的
...
- reborner
- reborn
	-  [born-again](dic://born-again), [converted](dic://converted)
	- _adj._ [regenerate](dic://regenerate)
	- _n._ [unregenerate](dic://unregenerate), [unregenerated](dic://unregenerated)
	- **rebirth**复兴;**revived**复活的，再生的;**reincarnation**再投胎,再生,转世;**resurrect**使复活;**rejuvenated**回春的;**anew**重新;**immortal**长生的;**incarnation**化身;**alive**活着的;**revive**苏醒;**remade**再做的;
- newborns
- newborn
- newborns
- natural-born
...
- firstborn
- earthborn
	- _adj._ [mortal](dic://mortal), [human](dic://human), [earthly](dic://earthly)
	- _n._ [immortal](dic://immortal), [nonhuman](dic://nonhuman), [heavenly](dic://heavenly)
	- **mortal**致命的;**earthly**地球的;**angelic**天使的;**beings**人;**elemental**自然力的;
	- _[earthborn](dic://earthborn)_  adj. 地中长出的；会死的；尘世的；凡人的
- country-born
- bastborn
- baseborn
- aborning
...
- 1.buck（责任）：玩牌时代表庄家身份的鹿角猎刀  
	- 英语单词buck除了表示“雄鹿”、“美元”外，还可以表示“责任”，这种说法起源于玩牌时放在庄家面前代表庄家身份的物品，最初常常是鹿角握柄的猎刀（buckhorn knife），后来简略为buck。由于玩牌时为求公平，常常采用轮流坐庄的方式，buck放到谁面前就意味着谁要承担庄家的责任，故此buck一词衍生出“责任”的含义。pass the buck指的就是把buck传到下一家，后来幽默作家马克•吐温在其文章中，首先将其引申为“寻找借口、推诿责任或把过失推给别人”之义，因而一举成为流行一时的俚语。  
	- 20世纪40年代，美国总统杜鲁门为杜绝政府官僚推诿责任（pass the buck），乃根据此俚语创造出另一句话，也是他放在椭圆形办公桌上的著名座右铭“the buck stops here”，意思是“责任止于此，绝不推诿”。  
- buck：[bʌk] n.美元，钱，雄鹿，纨绔子弟，责任  
- the buck stops here：绝不推卸责任  
- pass the buck：推卸责任  
- 2.buck（美元）：作为衡量商品价值基本单位的鹿皮  
...
- buck：[bʌk] n.雄鹿，钱，美元
- waterbuck
	- _n._ [antelope](dic://antelope)
	- **elk**麋鹿;**buffalo**水牛;**herds**畜群;**rhino**钱;**Kruger**克鲁格;**giraffe**长颈鹿;**deer**鹿，梅花鹿;**lions**腰角;**bison**北美野牛;**herd**兽群，畜群;**zebra**斑马;
	- _[waterbuck](dic://waterbuck)_  n. 非洲大羚羊
- roebuck
- megabuck
	- megabucks
- bushbuck
...
- buckskin
- buckish
	- _[buckish](dic://buckish)_  adj. 浮华的；爱时髦的
- buckhorn
	- _[buckhorn pearl](dic://buckhorn%20pearl)_ 鹿角珍珠
- bucker
- buckboard
	- _n._ [carriage](dic://carriage), [equipage](dic://equipage), [rig](dic://rig)
	- **wagon**货车，四轮马车;**horseback**马背;**mule**骡子;**sleigh**乘雪橇;**cowboy**牧童;**horse**马;**saddle**鞍，鞍状物;**buggy**多虫的;**ranch**大牧场;**rode**骑;**truck**卡车;
- buck-passing
	- _[Buck Passing](dic://Buck%20Passing)_  完全通过; 推诿; 推卸责任;
- buck-jump
	- _[buckjump](dic://buckjump)_  n. 腾跃; vi. 突然拱背使骑者跌落;
- butcher
	-  [meatman](dic://meatman)
	-  [slaughterer](dic://slaughterer)
	-  [bungler](dic://bungler), [blunderer](dic://blunderer), [fumbler](dic://fumbler), [bumbler](dic://bumbler), [stumbler](dic://stumbler), [sad sack](dic://sad sack), [botcher](dic://botcher), [fuckup](dic://fuckup)
	-  [slaughter](dic://slaughter)
	- _n._ [merchant](dic://merchant), [merchandiser](dic://merchandiser), [murderer](dic://murderer), [liquidator](dic://liquidator), [manslayer](dic://manslayer), [skilled worker](dic://skilled worker), [trained worker](dic://trained worker)
	- _v._ [kill](dic://kill)
	- **grocer**杂货店;**deli**熟食店;**meat**肉，肉类;**barber**为…理发;**grocery**食品杂货店;**blacksmith**铁匠;**farmer**农夫，农民;**baker**面包师;**supermarket**超级市场;**bakery**面包店;**slaughter**残杀;
	- _[butchering](dic://butchering)_  v. 屠宰；屠杀；故意破坏（butcher 的现在分词）; n. 屠宰加工业; 
	- _[butchers](dic://butchers)_  n. 屠宰者（butcher的复数形式）
	- _[butcher knife](dic://butcher%20knife)_  n. 屠刀；切肉刀
	- _[the butcher](dic://the%20butcher)_  百业之人
	- _[butcher paper](dic://butcher%20paper)_  厚纸
	- _[butcher's](dic://butcher%27s)_  n. 肉店
...
- buffoon
	...
	- _[clown or buffoon player](dic://clown%20or%20buffoon%20player)_ 小丑演员
	- _[a buffoon in modern pantomimes](dic://a%20buffoon%20in%20modern%20pantomimes)_ 笑话里的笑柄
...
- bumper
	...
	- _adj._ [abundant](dic://abundant)
	- [glass](dic://glass), [drinking glass](dic://drinking glass), [mechanical device](dic://mechanical device)
	- _bumper harvest_ 丰收
	- _front bumper_ 前保险杠；前车挡；前缓冲铁
	- _rear bumper_ 后保险杠；后档
	- _bumper sticker_ 保险杆贴纸；车尾贴
	- _bumper car_ n. 碰撞用汽车
	- _bumper year_ 丰收年
...
- [bunkum](dic://bunkum), [buncombe](dic://buncombe), [guff](dic://guff), [rot](dic://rot), [hogwash](dic://hogwash)
- [berth](dic://berth), [built in bed](dic://built in bed)
- [nonsense](dic://nonsense), [nonsensicality](dic://nonsensicality), [meaninglessness](dic://meaninglessness), [hokum](dic://hokum)
- [manger](dic://manger), [trough](dic://trough), [bed](dic://bed), [drivel](dic://drivel), [garbage](dic://garbage), [message](dic://message), [content](dic://content)
- [cheat](dic://cheat), [rip off](dic://rip off), [chisel](dic://chisel), [bed](dic://bed), [leave](dic://leave), [go forth](dic://go forth), [go away](dic://go away)
- _bunk bed_ 双层床
...
- **ber**比特误差率;**ere**在…以前;**tor**岩山;
- 1. detach a check from the checkbook; detach burs from one's coat /从支票簿上撕下一张支票；取下大衣上粘附的东西

bureau
- [agency](dic://agency), [federal agency](dic://federal agency), [government agency](dic://government agency), [office](dic://office), [authority](dic://authority)
- [chest of drawers](dic://chest of drawers), [chest](dic://chest), [dresser](dic://dresser)
- _n._ [administrative unit](dic://administrative unit), [administrative body](dic://administrative body), [furniture](dic://furniture), [piece of furniture](dic://piece of furniture), [article of furniture](dic://article of furniture)
...
- _[calibrating burette](dic://calibrating%20burette)_  校准用滴定管
- _[syringe burette](dic://syringe%20burette)_  注射滴定管
- _[burette clamp](dic://burette%20clamp)_  滴定管夹
- _[certified burette](dic://certified%20burette)_  检定滴定管
- _[weighing burette](dic://weighing%20burette)_  称量滴定管
- _[burette stand](dic://burette%20stand)_  n. 滴定管架

burble
- [ripple](dic://ripple), [babble](dic://babble), [guggle](dic://guggle), [bubble](dic://bubble), [gurgle](dic://gurgle)
- _v._ [sound](dic://sound), [go](dic://go)
- **rumbling**隆隆声;**roar**吼;**bubbling**冒泡，鼓泡;**growl**咆哮着说;**muffled**听不清的;**howl**怒吼;**rumble**使隆隆响;**screeching**发动机啸声;**hum**发低哼声;**babbling**胡说;**chatter**唠叨;
- _[burbling](dic://burbling)_  v. 语无伦次地讲话；潺潺做声；（航空）产生气流（burble 的现在分词）; n. 潺潺的水声；（诗歌）汩汩的水声；激动人心的演讲;
- he wind burbled in his ear /风在他耳边呼呼作响。
- Companies appointed chief metaverse officers, and futurologists burbled about web 3.0 /各大公司任命了首席元宇宙总监，未来学家则对Web 3.0议论纷纷。
...
- _n._ [succulent](dic://succulent)
- **shrub**灌木;**succulent**汁多味美的;**flower**花;**prickly**多刺的;**desert**遗弃;**orchid**兰花;**fern**蕨类植物;**shrubs**灌木;**plants**植物;**agave**龙舌兰，龙舌兰属植物;**orchids**兰花，淡紫色;
- _[cacti](dic://cacti)_  n. [园艺] 仙人掌（cactus的复数形式）
- _[cactuses](dic://cactuses)_  n. [园艺] 仙人掌
- _[cactus flower](dic://cactus%20flower)_  仙人掌花
- 1. a cactus that radiates spines. /长满尖刺的仙人掌
- cactoid
	- _[cactoid](dic://cactoid)_ 仙人掌状的
- cactine
- cactin
- cacti
- cactaceous
...
Caesar
- [Julius Caesar](dic://Julius Caesar), [Gaius Julius Caesar](dic://Gaius Julius Caesar)
- _n._ [general](dic://general), [full general](dic://full general), [statesman](dic://statesman), [solon](dic://solon), [national leader](dic://national leader), [comedian](dic://comedian), [comic](dic://comic)**Brutus**布鲁特斯;**Julius**朱利叶斯;**Augustus**奥古斯都;**Cleopatra**克利奥帕特拉;**Cicero**西塞罗;**Claudius**克劳迪亚斯;**Nero**尼禄;**Cesar**恺撒，古罗马帝王;**Cassius**卡西乌斯;**Gaul**高卢;**Roman**罗马人;
- Caesarist
- Caesarism
- Caesarean
...
- 在军事领域，calibre一词最早用来表示用来制造火炮的模具，后来用来表示火炮的炮管及炮弹的口径。小型的火枪问世后，用来表示枪管及子弹的口径。后来这个单词的词义发生泛化，可以泛指各种度量衡，并引申出“水准、才干”等含义。  
	...
	- caliper：['kælɪpə] n. 卡尺；卡钳vt. 用测径规测量；用卡钳测量，等于calliper
...
- cannikin
- cannery
	- _n._ [factory](dic://factory), [mill](dic://mill), [manufacturing plant](dic://manufacturing plant), [manufactory](dic://manufactory)
	- **canning**罐头制造;**wharf**码头;**fishery**渔业;**tuna**金枪鱼，鲔鱼;**fisherman**渔夫, 渔民;**salmon**鲑鱼;**mill**磨坊;**shipyard**船坞;**whaling**捕鲸;**fishermen**渔夫,钓鱼者,渔船;**fish**捕鱼，钓鱼;
	- The biggest companies – the biggest employers are two tuna canneries. /最大的公司——最大的雇主是两家金枪鱼罐头厂
- canner
...
- canned
	...
	-  [tinned](dic://tinned)
	- _adj._ [recorded](dic://recorded), [preserved](dic://preserved)
	- _n._ [live](dic://live), [unrecorded](dic://unrecorded), [fresh](dic://fresh)
	- **frozen**冻结的;**bottled**瓶装的;**dried**弄干了的;**tuna**金枪鱼，鲔鱼;**pickled**盐渍的;**tomatoes**蕃茄;**homemade**自制的;**meats**肉类;**fresh**新鲜的;**meat**肉，肉类;**applesauce**苹果酱;
	- _canned vegetable_ 蔬菜罐头；罐头蔬菜
	- _canned laughter_ ［俚］预先录制的笑声
	- 1. a canned speech. 千篇一律的讲演
	- 1. he was canned because of a tiff over promotion. /他因升职一事与人发生口角，被解雇了。
	- dehydrocanned
- canful
	- n. 满罐
...
- canonical：[kə'nɑnɪkl] adj. 依教规的；权威的；牧师的n. 牧师礼服  
...
- canon /cannon
	...
	- (在大教堂任职的)教士
	- [canyon](dic://canyon)
	- _n._ [rule](dic://rule), [prescript](dic://prescript), [priest](dic://priest), [ravine](dic://ravine), [musical composition](dic://musical composition), [opus](dic://opus), [composition](dic://composition)
	- **Nikon**尼康牌照相机;**DSLR**单眼数位相机;**Pentax**宾得数码相机;**Leica**莱卡;**Olympus**天堂，天国;**Epson**爱普生;**SLR**单镜头反射;**Lexmark**美国利盟公司;**camera**照相机;**camcorder**便携式摄像机;**lens**透镜;
	- _canon law_ 教会法；教会法规
	- You can't pick out the canon /你根本听不出卡农的旋律。
	- These revamps are not the only way Disney is ransacking its canon. /这些改进并不是迪士尼翻拍经典的唯一方式。
	- And that's one of the big flaws with our current canon of folkloric recordings /
	- 这是我们目前的民间音乐记录的一大缺陷。
	- On the sixth day, he reached the Eagle Canon, from which they had commenced their ill-fated flight. /第六天，他就来到了鹰谷；他们就是从这里开始他们不幸的逃亡的。
	- cannonry
	- cannonproot
	- cannoneer
	- cannoball
	- cannon-shot
	- canonical
		- _adj._ [canon](dic://canon), [canon law](dic://canon law), [ecclesiastical law](dic://ecclesiastical law), [standard](dic://standard), [orthodox](dic://orthodox)
		- _n._ [nonstandard](dic://nonstandard), [unorthodox](dic://unorthodox)
		- **ecclesiastical**基督教会的;**liturgical**礼拜仪式的;**doctrinal**学说的;**scriptural**手稿的,圣经的,依据圣经的;**theological**神学的;**liturgy**礼拜仪式;**invariant**无变化的,不变的;**textual**本文的;**normative**标准的;**topological**拓扑的;**apostolic**使徒的;
		- _canonical correlation_ 典型相关
		- _canonical correlation analysis_ 典型相关分析；典范相关分析
		- _canonical form_ 规范形式；[语]语言的语音典型
		- _canonical transformation_ 正则变换
		- _canonical ensemble_ 正则系综，典范系综
		- _canonical analysis_ 典型相关分析；典型分析；双复式分析
		- _jordan canonical form_ [数]约当标准型；约当范式
		- the canonical method of comparative linguistics. /比较语言学的权威方法。
		- a canonical syllable pattern /规范的音节模式
		- The periods during which they worshipped were called the canonical hours /他们做礼拜的时候通常被称为祷告时刻。
		- These are known as the " canonical five" , meaning they were part of his killer canon /这些被称为“经典五” ，这意味着它们是他的杀手经典的一部分。
		- For wildlife ecologists, the story of the reintroduction of wolves to the Greater Yellowstone Ecosystem on January 12, 1995, has become canonical. /对于野生动物生态学家来说，1995年1月12日将狼重新引入大黄石生态系统的故事已经成为经典
	- canonize
- caning
- caner
- canebrake
...
- 英语单词canvas（帆布）和canvass（细查）的拼写只有一字之差，它们之间有什么关系呢？原来，它们来源相同，只是一个用作名词，一个用作动词。它们都来自希腊语kannabis（cannabis，大麻），本意是用大麻制成的粗帆布。由于古代人用这种粗布来筛东西，所以用作动词时表示“筛”，进而衍生出“细查、细究、详细讨论”等含义，后来又衍生出“劝诱、拉选票”的含义。而用作名词时，表示“帆布”。由于油画都使用帆布，所以还可以表示“画布”。  
	...
	- canvass： ['kænvəs] v.细究，彻底检查，游说，拉选票n.细查，讨论，劝诱  
	- cannabis：['kænəbɪs] n.印度大麻
- _on the canvas_ (拳击等中)被击倒在地；即将失败
- _canvas shoes_ 帆布鞋
...
- 词源同 cane,canal
- back channel
	- 秘密、非正式或不规则的沟通方式：指秘密、非正式或不规则的沟通方式。
	- It's all through back channels and go-between firms and fake names but it's—there's a digital paper trail for everything /这一切都是通过秘密渠道、公司之间的中间人和假名进行的， 但一切都有数字化的书面记录。
	- You seem to be implying an informational back channel between me and Penny where obviously none exists. No, I didn't /你说的倒像是我和佩妮背地里通了气，很明显这是没有的事。没，我没觉得。
	- But **back** **channel** negotiations, revealed by the Guardian last month, showed the two nations are searching for a deal /而据《卫报》上月披露，中美两国在秘密谈判中也在寻求达成协议。
- subchannel
- sole-channel
- rechannel
- multichannel
...
- 《旧约•以西结书》对基路伯的容貌进行了较多描绘。按照《以西结书》的描述，基路伯长有四张脸，分别是人脸、狮脸、公牛脸和鹰脸。另外，他还长有两对翅膀。直到此时，基路伯的形象还是怪物，跟我们印象中的“可爱天使”丝毫沾不上边。  
- 到了文艺复兴期间，在艺术大师的画笔下，基路伯通常被描绘为长有翅膀、脸蛋红扑扑的儿童形象。例如，在拉斐尔的名画《西斯廷圣母》中，画面最下面的两个长翅膀的小天使其实是两个基路伯。受此影响，在现代英语中，cherub（基路伯）一词现在常被用来比喻天真可爱的儿童。 
	- cherub：['tʃerəb] n.胖娃娃，天真可爱的儿童，小天使，基路伯，基路冰  
	- cherubic：[tʃɛ'rʊbɪk] adj. 可爱的；天使的；无邪的
...
- cherubic [美 /tʃəˈruːbɪk/](cmd://Speak/_us_/cherubic)
	...
	- **angelic**天使的;**chubby**圆胖的，丰满的;**childlike**天真的;**bearded**有芒的;**perky**得意洋洋的;**smiley**微笑符;**mischievous**淘气的, 顽皮的;**smiling**微笑的;**plump**丰满的;**youthful**年轻的;**goofy**傻瓜的，愚笨的;
...
- [lump](dic://lump)
- [collocate](dic://collocate), [lump](dic://lump)
- _n._ [agglomeration](dic://agglomeration), [large indefinite quantity](dic://large indefinite quantity), [large indefinite amount](dic://large indefinite amount)
...
1. of superior grade
	- choice wines
	- _synonymous：_ [prime(a)](dic://prime(a)), [prize](dic://prize), [quality](dic://quality), [select](dic://select)
2.  appealing to refined taste
	- choice wine

chowder
- n. 杂烩
- chowder - 昔日法国西北部布列塔尼半岛（Brittany）上的渔村有一个习俗，每次渔民从海上回来都要从自己的捕获物中取出少许，然后集中投进一个公用大锅，并加入蔬菜和佐料等一起炖煮，供大伙共享。大锅法语叫做chaudière，嗣后锅名被转用来作菜名。18世纪布列塔尼人把这种美味的海鲜杂烩浓汤带到加拿大的纽芬兰（Newfoundland）和美国东部，很受公众喜爱。chaudière一词也同时进入了英语，美国人将它英语化为chowder，用以指这种海鲜杂烩浓汤。汤料往往因人而异，其中海鲜以鱼和贝类为主，再加肉、牛奶、洋葱及其他蔬菜等。
- _n._ [soup](dic://soup)
- **soup**汤，羹;**lobster**龙虾;**stew**炖，炖汤;**soups**汤类;**risotto**意大利调味饭;**clam**蚌, 蛤;**seafood**海鲜;**chili**辣椒;**clams**蛤蚌;**crab**螃蟹;**broth**肉汤;
- _clam chowder_ 蛤蜊浓汤
- Given Simone's grasp of geography, I'm surprised we're not having clam chowder. /鉴于萨蒙妮的地理水平，我很惊讶我们没喝蛤蜊汤。
- There's a corn chowder recipe that looks really good. /上面有一篇玉米浓汤的食谱看上去很不错。
- 

cinch (kenk-, cing-,cinct-)
- cinching
...
- _synonymous：_ [coterie](dic://coterie), [ingroup](dic://ingroup), [inner circle](dic://inner circle), [pack](dic://pack), [camp](dic://camp)
- _n._ [set](dic://set), [circle](dic://circle), [band](dic://band), [lot](dic://lot)
- **cabal**阴谋;**elite**上层集团;**gang**一群;**faction**派别;**elitist**优秀人材;**group**组;**posse**一队;**outcast**流浪的人;**cadre**干部;**elites**精英;**clan**宗族;
- _[clique faction](dic://clique%20faction)_ 由私人利害关系结成的小集团; 朋党; 
- _[conspiratorial clique](dic://conspiratorial%20clique)_ 阴谋集团
- _[Similar cliques](dic://Similar%20cliques)_ 基团类型相似性
...
cloak
- **robe**长袍，礼服;**veil**面纱;**robes**礼服;**dagger**匕首，短剑;**shroud**寿衣;**tunic**束腰外衣;**garb**装束;**shield**盾;**armor**装甲;**cape**披肩;**sword**刀，剑;
...
- the machinery clunked into life. /机械铿锵作响着开动了。
- ovel after novel and not a clunker among them. /小说一本接着一本，其中没有一本是失败的作品。
- clunky
	...
	- [gawky](dic://gawky), [clumsy](dic://clumsy), [ungainly](dic://ungainly), [unwieldy](dic://unwieldy)
	- _adj._ [awkward](dic://awkward), [audible](dic://audible), [hearable](dic://hearable)
	- **cumbersome**笨重的;**clumsy**笨拙的;**unwieldy**笨拙的;**awkward**笨拙的;**bulky**庞大的;**antiquated**陈旧的;**disjointed**脱离开的,不连贯的;**jarring**刺耳的;**wonky**动摇的,虚弱的,摇晃的,靠不住的,出错的;**boxy**四四方方的;**chunky**矮胖的;
...
- _n._ [argument](dic://argument), [statement](dic://statement), [prisoner](dic://prisoner), [captive](dic://captive), [swindle](dic://swindle), [cheat](dic://cheat), [rig](dic://rig)
- _v._ [cheat](dic://cheat), [rip off](dic://rip off), [chisel](dic://chisel), [study](dic://study), [hit the books](dic://hit the books)
- _n._ [pro](dic://pro)
- _n._ [pro](dic://pro), [in favor of](dic://in favor of), [in favor](dic://in favor), [in favour of](dic://in favour of), [in favour](dic://in favour)
- _[con moto](dic://con%20moto)_  稍快的；活跃的
- _[mod cons](dic://mod%20cons)_  现代化生活设备
- _[con brio](dic://con%20brio)_  （意大利）精神饱满地；活泼有力地
- _[conning position](dic://conning%20position)_  指挥位置
- _[con artists](dic://con%20artists)_  骗子( con artist的复数 )
- _[con game](dic://con%20game)_  骗局，诈骗
...
- vt. 指挥操舵；指挥驾驶 n. 指挥操舵
- _v._ [steer](dic://steer), [maneuver](dic://maneuver), [manoeuver](dic://manoeuver), [manoeuvre](dic://manoeuvre), [direct](dic://direct), [point](dic://point), [head](dic://head)
...
- coquettish
	...
	- _[coquettish glances](dic://coquettish%20glances)_ 媚眼
	- _[Coquettish ball](dic://Coquettish%20ball)_ 妖媚舞会
	- _[be coquettish](dic://be%20coquettish)_ 搔头弄
...
cork
-  [phellem](dic://phellem)
- [bottle cork](dic://bottle cork)
-  [bob](dic://bob), [bobber](dic://bobber), [bobfloat](dic://bobfloat)
-  [cork up](dic://cork up)
- _n._ [bark](dic://bark), [plant material](dic://plant material), [city](dic://city), [metropolis](dic://metropolis), [urban center](dic://urban center), [port](dic://port), [plug](dic://plug)
- _v._ [plug](dic://plug), [stop up](dic://stop up), [secure](dic://secure), [stuff](dic://stuff)
- _n._ [uncork](dic://uncork)
- **wood**木材;**oak**橡树;**foam**泡沫;**bottle**瓶子;**wine**酒，葡萄酒;**rubber**橡胶;**plastic**可塑的;**glass**玻璃;**stopper**塞子;**bamboo**竹，竹子;**plywood**夹板，胶合板;
- _like a cork_ adv. 轻松地
- _cork oak_ （欧）栓皮栎
- _cork board_ 软木板
- _cork sheet_ 软木片；软木薄板
- 1. a corking party. /极好的聚会
- cork tiles. /软木砖。
- cork up one's feeling /抑制自己的感情
- draw a cork from a bottle /拔出瓶塞
- uncork
	- _v._ [unleash](dic://unleash), [open](dic://open), [open up](dic://open up)
	- _n._ [cork](dic://cork), [cork up](dic://cork up)
	- **unleash**解开…的皮带;**champagne**香槟酒;**bottle**瓶子;**wine**酒，葡萄酒;**savor**使有风味;**sip**抿;**bottles**瓶子;**wines**葡萄酒;**revel**狂欢;
- corky
	- adj. 像软木的；（酒）有软木塞味的；（非正式）活泼的
...
- corkwood
	...
	- **Eucalyptus**桉树;**willow**柳木制品;**pine**松树;**beech**山毛榉;**bark**咆哮;**cedar**雪松;**fern**蕨类植物;**birch**桦木;**wood**木材;**oak**橡树;**cork**软木;
- corkscrew
- corking
- corker
- corked
...
- cowhage
- cowhand
	- [cowboy](dic://cowboy), [cowpuncher](dic://cowpuncher), [puncher](dic://puncher), [cowman](dic://cowman), [cattleman](dic://cattleman), [cowpoke](dic://cowpoke), [cowherd](dic://cowherd)
	- _n._ [ranch hand](dic://ranch hand)
	- **cowboy**牧童;**rancher**大农场经营者;**cowboys**牛仔;**ranch**大牧场;**rodeo**竞技者;**cowgirl**女牛仔;**blacksmith**铁匠;**cattle**牛;**foreman**领班;**outlaw**歹徒, 亡命之徒;**outlaws**歹徒;
- cowhide
	- [cowskin](dic://cowskin)
	- _n._ [leather](dic://leather), [hide](dic://hide), [fell](dic://fell), [whip](dic://whip)
	- _v._ [flog](dic://flog), [welt](dic://welt), [whip](dic://whip), [lather](dic://lather), [lash](dic://lash), [slash](dic://slash), [strap](dic://strap)
	- **leather**皮革;**suede**绒面革;**tanned**被晒成棕褐色的;**buffalo**水牛;**wool**羊毛;**nylon**尼龙，聚酰胺纤维;**upholstery**家具装饰业;**burlap**粗麻布;**rugs**地毯;**upholstered**经过布置的;**quilted**中间絮有软物的
- cowhouse
	- _n._ [barn](dic://barn)
	- **barn**谷仓;**pasture**牧场;**farmhouse**农舍;**manor**庄园;**cottage**村舍;**hut**小屋;**meadow**草地;**farm**种田，务农;**hay**干草;**orchard**果园;**house**住宅;
- cowlick
	- 1. a tuft of hair that grows in a different direction from the rest of the hair and usually will not lie flat /n. 额前蓬乱的鬈发
	- _n._ [hair](dic://hair)
	...
	- I got a cowlick and I got a weird hair pattern and grow like that. /我长了个头巾， 我的头发图案很奇怪，然后就长成那样了。
- cowlike
- cowlight

cowl
-  [hood](dic://hood), [bonnet](dic://bonnet), [cowling](dic://cowling)
- _n._ [protective covering](dic://protective covering), [protective cover](dic://protective cover), [protection](dic://protection), [hood](dic://hood)
...
- _[fan cowl](dic://fan%20cowl)_  风扇罩
- _[engine cowl](dic://engine%20cowl)_  发动机整流罩
- _[cowl flap](dic://cowl%20flap)_  [航] 鱼鳞板
- _[cowl cover](dic://cowl%20cover)_  风斗罩
- _[cowl top](dic://cowl%20top)_  前围上盖板
...
cower
- [huddle](dic://huddle)
- [fawn](dic://fawn), [crawl](dic://crawl), [creep](dic://creep), [cringe](dic://cringe), [grovel](dic://grovel)
- _v._ [crouch](dic://crouch), [stoop](dic://stoop), [bend](dic://bend), [bow](dic://bow), [flex](dic://flex)
...
- [gripe](dic://gripe), [grouse](dic://grouse), [beef](dic://beef), [squawk](dic://squawk), [bellyache](dic://bellyache), [holler](dic://holler)
-  [crab louse](dic://crab louse), [pubic louse](dic://pubic louse), [Phthirius pubis](dic://Phthirius pubis)

cramp
- - 来自 PIE*ger,转，弯，围，词源同 crank,crook.比喻义肌肉打弯的，抽筋的。

crape
- n. 黑丧章；绉纱（等于 crepe） vt. 用绉纱覆盖；戴黑绉纱
- crapy
- craped
...
creme
- _n._ 乳酪,奶油,奶皮
- **ice-cream**乳白色的;**creme**乳酪;**custard**蛋奶糊,牛奶沙司;**ice**冰;**gelato**冰淇淋;**crème**奶油;**creamy**含乳脂的;**lotion**洗液;**butter**涂黄油于;**strawberry**草莓;**chocolate**巧克力;
-  [bat](dic://bat), [clobber](dic://clobber), [drub](dic://drub), [thrash](dic://thrash), [lick](dic://lick)
- creme de menthe and cream sometimes with creme de cacao. /带有奶味的薄荷酒和有时候带有奶味的可可酒。
...
- [line](dic://line), [topographic point](dic://topographic point), [place](dic://place), [spot](dic://spot), [top](dic://top), [top side](dic://top side), [upper side](dic://upper side)

croon (different from shirk/caterwauling)
- v. 低声歌唱, 低唱, 低吟  n. 低唱, 低吟, 轻哼
- _v._ [sing](dic://sing)
...
- [change integrity](dic://change integrity), [disintegrate](dic://disintegrate), [change](dic://change)

cry
- parrot-cry
- outcry
	-  [cry](dic://cry), [call](dic://call), [yell](dic://yell), [shout](dic://shout), [vociferation](dic://vociferation)
	-  [outshout](dic://outshout)
	- [exclaim](dic://exclaim), [cry](dic://cry), [cry out](dic://cry out), [call out](dic://call out), [shout](dic://shout)
	- _n._ [utterance](dic://utterance), [vocalization](dic://vocalization)
	- _v._ [surpass](dic://surpass), [outstrip](dic://outstrip), [outmatch](dic://outmatch), [outgo](dic://outgo), [exceed](dic://exceed), [outdo](dic://outdo), [surmount](dic://surmount)
...
- catchy
	-  [tricky](dic://tricky)
	-  [attention-getting](dic://attention-getting)
	- _adj._ [difficult](dic://difficult), [hard](dic://hard), [appealing](dic://appealing)
...
## D
dally
- [toy](dic://toy), [play](dic://play), [flirt](dic://flirt)
- [dawdle](dic://dawdle)
- [chat up](dic://chat up), [flirt](dic://flirt), [butterfly](dic://butterfly), [coquet](dic://coquet), [coquette](dic://coquette), [romance](dic://romance), [philander](dic://philander), [mash](dic://mash)
...
- [soften](dic://soften), [control](dic://control), [hold in](dic://hold in), [hold](dic://hold), [contain](dic://contain), [check](dic://check), [curb](dic://curb)
- [dampen](dic://dampen), [soften](dic://soften), [weaken](dic://weaken), [break](dic://break)
- [dampen](dic://dampen), [deaden](dic://deaden)
- [muffle](dic://muffle), [mute](dic://mute), [dull](dic://dull), [dampen](dic://dampen), [tone down](dic://tone down)

dear
- endear
	- _v._ [please](dic://please), [delight](dic://delight)
	- **alienate**使疏远，离间;**embarrass**使窘迫;**impress**给…以深刻印象, 使铭记;**annoy**骚扰;**amuse**使发笑;**amaze**使吃惊;**frustrate**使不成功, 挫败, 阻止;**irritate**激怒;**persuade**说服，劝说;**excite**刺激…，使…兴奋;**offend**冒犯;
	- He managed to endear himself to my entire family. /他能让我全家人都喜欢他。
...
- redressment
- redress
	-  [damages](dic://damages), [amends](dic://amends), [indemnity](dic://indemnity), [indemnification](dic://indemnification), [restitution](dic://restitution)
	- [remedy](dic://remedy), [remediation](dic://remediation)
	- [right](dic://right), [compensate](dic://compensate), [correct](dic://correct)
	- _n._ [compensation](dic://compensation), [correction](dic://correction), [rectification](dic://rectification)
	- _v._ [change](dic://change), [alter](dic://alter), [modify](dic://modify)
	- **remedy**药品, 治疗法;**recourse**依赖;**rectify**改正;**injustice**不公正;**grievance**委屈, 苦衷, 不满, 怨恨;**restitution**归还原主, 恢复原状;**reparations**赔款;**imbalance**不平衡;**adjudication**宣告;**equitable**公正的,合理的;**compensation**补偿物, 补偿金;
	- _seek redress_ 要求赔偿；寻求解决办法
	- redress leather before dyeing 染色前把皮革再加处理
	- there have been demands to redress such insufficiencies. 有人要求纠正这样的不足。
- overdress
- nightdress
	- _n._ [lingerie](dic://lingerie), [intimate apparel](dic://intimate apparel), [nightwear](dic://nightwear), [sleepwear](dic://sleepwear), [nightclothes](dic://nightclothes)
	- **blouse**宽松的上衣;**gown**长袍，长外衣;**panties**女式短裤;**robe**长袍，礼服;**tunic**束腰外衣;**lingerie**女用贴身内衣裤;**pajamas**睡衣;**lace**花边;**corset**束腹，紧身褡;**bra**胸罩;**dress**给…穿衣;
- headdress
- hairdressed
- full-dress
- dressy
...
- driftage
- adrift
	-  [afloat(p)](dic://afloat(p)), [aimless](dic://aimless), [directionless](dic://directionless), [planless](dic://planless), [rudderless](dic://rudderless), [undirected](dic://undirected)
	- _adj._ [purposeless](dic://purposeless)
	- _adv._ [aimless](dic://aimless), [directionless](dic://directionless), [planless](dic://planless), [rudderless](dic://rudderless), [undirected](dic://undirected)
	- _n._ [purposeful](dic://purposeful), [sunken](dic://sunken), [submerged](dic://submerged)
	- **drifting**漂流;**afloat**飘浮的;**hopelessly**绝望地;**stranded**搁浅的;**reeling**卷取;**mired**使…陷于泥泞，使…陷入困境;**trapped**陷入困境的;**doomed**注定的;**sank**沉陷;**drowned**淹没;**sinking**沉没;
	- _[cast adrift](dic://cast%20adrift)_ 随波逐流; 漂泊不定; 
	- _[run adrift](dic://run%20adrift)_ 随波逐流
	- _[Hearts Adrift](dic://Hearts%20Adrift)_ 真爱有约
	- _[adrift on](dic://adrift%20on)_ 漂在……上
	- _[adrift from](dic://adrift%20from)_ 漂离; 脱离;
	- _[go adrift](dic://go%20adrift)_  v. 随波逐流；脱节
	- _[come adrift](dic://come%20adrift)_  （船等）随波逐流; 脱节，离题; 
	- _[cut adrift](dic://cut%20adrift)_  漂泊无依
	- adrift from the subject /脱离主题
	- adrift in a strange city /在异乡飘泊无定
...
- don't talk such drivel /别说这样的蠢话！。
- He driveled on about his family. /他就自己的家世胡说个不停。
- The driveling song seemed to have kept in popularity. /看起来那支絮絮叨叨的歌倒时盛行不衰。
- driveller
...
- One of his drollest tricks was performed on the poor little monkey that was left /他最滑稽的一种把戏，是耍在剩下的那只可怜的小猴子身上。
...
dull
- dully
	- _adv._ [dull](dic://dull)
	- **faintly**微弱地;**curiously**好奇地;**stared**凝视，注视;**cheerfully**欢乐地,愉快地;**dull**钝的;**dutifully**忠实地;**duly**充分地;**silently**静静地;**gleaming**微弱的闪光，瞬息的一现;**brightly**明亮地;**strangely**奇妙地;
- dullness
- dullish
	- adj. 稍钝的；有些松懈的；昏暗的
	- _[Under the lamp of dullish](dic://Under%20the%20lamp%20of%20dullish)_ 在淡淡的灯光下
...
- dullbox
- dullard
	- [stupid](dic://stupid), [stupid person](dic://stupid person), [stupe](dic://stupe), [dolt](dic://dolt), [pudding head](dic://pudding head), [pudden-head](dic://pudden-head), [poor fish](dic://poor fish), [pillock](dic://pillock)
	- [bore](dic://bore)
	- _n._ [simpleton](dic://simpleton), [simple](dic://simple), [unpleasant person](dic://unpleasant person), [disagreeable person](dic://disagreeable person)
	...
	- But none at all, or too much, can make you a dullard /但绝不碰酒或纵酒过度的结果却与之相反。
- dull-witted
	- adj. 愚蠢的

dune
- _n._ [ridge](dic://ridge)
- **sand**沙;**sandy**含沙的;**sands**沙漠;**marsh**湿地;**desert**遗弃;**beach**海滩;**cliffs**悬崖，峭壁;**grassland**草原，牧场;**gravel**砂砾;**shoreline**海〔湖〕滨线;**vegetation**植物;
- [sand dune](dic://sand dune)
- sand dunes that were upbuilt by the wind /由风垒起来的沙丘

dump
- [shit](dic://shit)
- [garbage dump](dic://garbage dump), [trash dump](dic://trash dump), [rubbish dump](dic://rubbish dump), [wasteyard](dic://wasteyard), [waste-yard](dic://waste-yard), [dumpsite](dic://dumpsite)
- [ditch](dic://ditch)
- [underprice](dic://underprice)
- [plunge](dic://plunge)
- [deck](dic://deck), [coldcock](dic://coldcock), [knock down](dic://knock down), [floor](dic://floor)
- _n._ [defecation](dic://defecation), [laxation](dic://laxation), [shitting](dic://shitting), [site](dic://site), [land site](dic://land site), [copy](dic://copy), [written matter](dic://written matter)
- _v._ [discard](dic://discard), [fling](dic://fling), [toss](dic://toss), [toss out](dic://toss out), [toss away](dic://toss away), [chuck out](dic://chuck out), [cast aside](dic://cast aside)
- **garbage**垃圾;**trash**垃圾;**unload**卸;**heap**堆;**pile**堆;**waste**废物;**bury**埋葬;**ditch**在…上掘沟;**dispose**处理;**recycle**使再循环;**rubbish**垃圾，废物;
- dumpy
- dumpling
- dumpish
	- _[dumpish](dic://dumpish)_  adj. 忧郁的；迟钝的
- dumping
- dumper
- dumpcart
...
dwindle
- [decrease](dic://decrease) 指逐渐地、不断地减少。
- [diminish](dic://diminish) 侧重大小数量和重要性的不断减小，强调减小的部分。
- [lessen](dic://lessen) 普通用词，与decrease近义。指数目、程度、价值、实力等的减少。
- [reduce](dic://reduce) 普通用词，含义广。指数量、程度的降低或减少。
- [dwindle](dic://dwindle) 与decrease同义，指逐渐减小，但强调变得越来越少终至全无。
...
- [reflux](dic://reflux)
-  [ebb away](dic://ebb away), [ebb down](dic://ebb down), [ebb out](dic://ebb out), [ebb off](dic://ebb off)
- _n._ [decline](dic://decline), [diminution](dic://diminution), [flow](dic://flow), [flowing](dic://flowing)
- _v._ [recede](dic://recede), [fall back](dic://fall back), [retire](dic://retire), [besiege](dic://besiege), [beleaguer](dic://beleaguer), [surround](dic://surround), [hem in](dic://hem in)
- _n._ [tide](dic://tide), [surge](dic://surge)
- **tides**潮汐;**tide**潮汐;**flow**流动，涌流;**steady**稳定的;**flowing**平滑的;**fluctuating**上下浮动的;**trickle**滴;**turbulent**骚动的;**low**低的，浅的;**moods**情绪;**tidal**潮的，有关潮水的;
- _ebb and flow_ 兴衰，起伏；潮的涨落
- _ebb tide_ 退潮，落潮
- _at a low ebb_ 处于低潮；衰败
- _flood and ebb_ 潮汐
- _ebb away_ 渐渐衰退；消逝
- ebb-tide
...
- uneven
	...
	- unevenly
- eventide, evenfall
	- **nigh**近于;**dusk**黄昏，薄暮;**dawn**拂晓，破晓，黎明;**ere**在…以前;**abode**住处;**thee**你;**doth**从事;**countenance**面容，表情;
	- [twilight](dic://twilight), [dusk](dic://dusk), [gloaming](dic://gloaming), [gloam](dic://gloam), [nightfall](dic://nightfall), [fall](dic://fall), [crepuscule](dic://crepuscule), [crepuscle](dic://crepuscle)
- eventempered
	- _adj._ 性情平和的;沉着的;稳重的
	- _adj._ [good-natured](dic://good-natured) _n._ [ill-natured](dic://ill-natured)
	- **demeanor**行为;**empathetic**移情作用的;**temperament**性格, 性情, 气质;**calm**静的，平静的;**down-to-earth**务实的;**combative**好战的;**assertive**断定的;**respectful**表示尊敬的;**calmer**更平静的;**dignified**高贵的;**feisty**活跃的;
- evensong
	- **choral**合唱队的;**choir**合唱队;**liturgy**礼拜仪式;**choirs**合唱队;**cathedral**大教堂;**chapel**小教堂;**churchyard**墓地,境内;**carol**欢乐地歌唱;**vicar**教区牧师，教堂牧师;**hymn**赞美诗;**hymns**赞美诗;
- evenness
	- **smoothness**平滑;**uniformity**一致;**richness**丰富;**consistency**连贯;**lightness**光亮度;**fluidity**流质;**harmony**协调;**texture**质地;**sharpness**锐利;**softness**温柔;**cohesion**内聚力;
- evenly
	- **uniformly**一律地;**equally**相等地，平等地;**distributed**分布的;**split**劈开;**thinly**稀疏地;**cleanly**干净地;**distribute**分配, 分给;**divided**分开的;**horizontally**水平地;**spaced**以规定距离排列的;**spread**传播;
- evening
	- evenings
- evenhanded
...
- favorable, favorably
	...
	- favorableness
- disfavour, disfavor
	- **favour**偏爱;**scorn**轻蔑;**favoured**受优惠的;**displeasure**不快, 不悦, 生气;**disdain**蔑视;**favor**喜欢;**consequence**结果, 后果;**patronage**赞助;
	- [rejection](dic://rejection), [inclination](dic://inclination), [disposition](dic://disposition), [tendency](dic://tendency)
...
- _[homage and fealty](dic://homage%20and%20fealty)_ 致敬和效忠
- _[oath of fealty](dic://oath%20of%20fealty)_ 效忠宣誓
...
- [lame](dic://lame) 
-  [faint](dic://faint)
-  [decrepit](dic://decrepit), [debile](dic://debile), [infirm](dic://infirm), [rickety](dic://rickety), [sapless](dic://sapless), [weak](dic://weak), [weakly](dic://weakly)
-  [nerveless](dic://nerveless)
- _adj._ [weak](dic://weak), [frail](dic://frail), [powerless](dic://powerless)
- _n._ [strong](dic://strong), [robust](dic://robust), [powerful](dic://powerful)
	- [weak](dic://weak) 普通用词，指缺乏应有的力量，可用于身体、意志或精神。  
	- [feeble](dic://feeble) 指身体衰弱无力，精力几乎耗尽，含令人怜悯的意味。   
...
- unfelt
- homefelt
	- _[homefelt](dic://homefelt)_  adj. 舒适自在的；痛切感到的；亲密的；内心的
- heartfelt
	- **sincere**真诚的;**poignant**尖锐的;**heartwarming**暖人心房的;**impassioned**充满激情的, 热烈的;**thoughtful**沉思的, 思考的;**soulful**感情上的;**eloquent**雄辩的，有口才的;**uplifting**令人振奋的;**heartbreaking**令人心碎的;**emotive**感情的;**insightful**有深刻见解的;
- feeling
	- unfeeling
	- ill-feeling
	- feelings
...
- outfit
	...
	- [supply](dic://supply), [provide](dic://provide), [render](dic://render), [furnish](dic://furnish)
	- outfitting
	- outfitter
	- outfits
- misfit
	- **outcast**流浪的人;**eccentric**古怪的, 怪癖的;**nerdy**书呆子式的;**renegade**变节者;**clique**派系;**neurotic**神经过敏的;**lovable**可爱的，讨人喜欢的;**outsider**外人;**rebellious**叛逆的;**wayward**任性的;**wannabe**想达到目标的人;
	- **offbeat**离奇的;**quirky**诡诈的;**wacky**乖僻的，古怪的;**eccentric**古怪的, 怪癖的;**odd**奇数的;**bizarre**奇异的;**idiosyncratic**特殊物质的,特殊的,异质的;**goofy**傻瓜的，愚笨的;**weird**怪异的;**weirdness**古怪,命运;**unusual**与众不同的;
	- [anomaly](dic://anomaly), [unusual person](dic://unusual person)
- loose-fitting
	- _[Wear Loose-Fitting Clothing](dic://Wear%20Loose-Fitting%20Clothing)_  穿宽松的衣服
	- It would have been loose fitting and boxy to match the silhouette of the dress worn over it /它本来是宽松的，四四方方的，以匹配它上面穿的裙子的轮廓。
- close-fitting
- formfitting
	- _[formfitting sweater](dic://formfitting%20sweater)_ 紧身毛衫
	- _[formfitting apparel](dic://formfitting%20apparel)_ 也可用于贴形制品
- fitting
	- fittingly
- fitter
	- 1. someone who fits a garment to a particular person
	- improved in health or physical condition
		- [healthier](dic://healthier)
	- _n._ [tailor](dic://tailor), [seamster](dic://seamster), [sartor](dic://sartor)
	- _adj._ [better](dic://better)
	- _n._ [worse](dic://worse), [worsened](dic://worsened)
	- **slimmer**减肥者;**leaner**清洗液;**trainer**训练员;**electrician**电工;**fresher**新鲜人;**taller**更高的;**cleaner**清洁工;
	- the measures would ensure a leaner, fitter company /这些措施可确保建立一个更精简、更健康的公司。
	- After several sessions at the gym, I feel a lot fitter /我在健身房锻炼了好几次以后，觉得身体好多了。
	- shipfitter
		- _[shipfitter](dic://shipfitter)_ 船舶装配工; 轮船装配者; 船体装配工;
		- _[shipfitter apprentice](dic://shipfitter%20apprentice)_ 船体装配工学徒
	- pipefitter
- fitted
	- **equipped**装备;**furnished**装配好家具的，带家具的;**fittings**家具;**designed**有计划的，原意的;**paired**成对的;**custom-made**定做的,订制的;**complemented**有补助物的,有余格的;**mounted**安装好的;**bespoke**定做的;**specially**特别地;**proportioned**成比例的,相称的;
- fitness
	- **wellness**健康;**workout**试验;**gym**体育;**exercise**练习;**aerobics**有氧运动法;**health**健康;**aerobic**需氧的;**nutrition**营养;**treadmill**踏车;**Zumba**尊巴;**gyms**健身房;
	- [suitability](dic://suitability), [suitableness](dic://suitableness), [condition](dic://condition), [shape](dic://shape), [soundness](dic://soundness), [competence](dic://competence), [competency](dic://competency)
	- [physical fitness](dic://physical fitness), [good shape](dic://good shape), [good condition](dic://good condition)
	-  [seaworthiness](dic://seaworthiness)
- fitment
	- **aftermarket**零部件市场;**fender**防卫物;**axle**车轴;**sizing**涂上胶水;**fenders**防撞垫;**bushing**套管;**chassis**底盘，底架;**fittings**家具;**headlight**的前灯;**OEM**原始设备制造商;**fitting**试穿，试衣;
	- [furniture](dic://furniture), [piece of furniture](dic://piece of furniture), [article of furniture](dic://article of furniture)
	- _[built-in fitment](dic://built-in%20fitment)_  固定件
	- _[kitchen fitment](dic://kitchen%20fitment)_  厨房固定家具；厨房设备
	- _[sanitary fitments](dic://sanitary%20fitments)_  卫生设备
- fitly
	- _[fitly spoken](dic://fitly%20spoken)_ 说话表达的好; 谈吐合宜; 
	- _[Talking and Handling Affairs Fitly](dic://Talking%20and%20Handling%20Affairs%20Fitly)_ 把握好说话的尺度与办事的分寸
	- _[tidily fitly shipshape trimly](dic://tidily%20fitly%20shipshape%20trimly)_ 整齐地
- fitified
- fitful
	- **sleepless**无眠的;**restless**焦躁不安的;**erratic**不稳定的;**slumber**睡眠;**dogged**顽强的;**stormy**暴风雨的;**feeble**微弱的，无力的;**frantic**狂乱的，疯狂的;**incessant**不停的, 持续不断的;**labored**吃力的;**shaky**摇晃的;
	- [spasmodic](dic://spasmodic)
	- [interrupted](dic://interrupted), [off-and-on(a)](dic://off-and-on(a))
	- _[a fitful gleam](dic://a%20fitful%20gleam)_ 忽明忽暗的光
	- _[fitful gusts of wind](dic://fitful%20gusts%20of%20wind)_ 阵阵的狂风
- fit-up
	- _[fit up](dic://fit%20up)_  装配，装合；装备
	- _[fitting up](dic://fitting%20up)_  组对，装配；初组装
- fit-out
	- _v._ [supply](dic://supply), [provide](dic://provide), [render](dic://render), [furnish](dic://furnish), [change state](dic://change state), [turn](dic://turn)
	- **refurbishment**翻新，整修，再装修;**renovation**翻新;**furnishings**家具;**bespoke**定做的;**construction**建设;**fittings**家具;**interior**内部;**building**建筑;**redevelopment**恢复经济发展,重点恢复;**tenancy**租用;**furnishing**供给;
	- So, he rented a place, fitted it out and then took on some staff. /因此，他租了个地方，装修了一下，然后雇了些人。
...
- befit
	...
	- Such actions do not befit you /这种行为与你不相称。
	- formal attire that befits the occasion. /适于这个场合的正式装束
	- befitting
	- unbefitting
	- befittingly
- autofit
...
- filthy
	...
	- _adj._ [dirty](dic://dirty), [soiled](dic://soiled), [unclean](dic://unclean), [nasty](dic://nasty), [awful](dic://awful)
	- _n._ [clean](dic://clean), [nice](dic://nice), [unobjectionable](dic://unobjectionable)
	- **dirty**污秽的;**smelly**有臭味的，发臭的;**filth**猥亵;**disgusting**令人厌恶的;**stinking**发恶臭的;**vile**卑鄙的;**stinky**发恶臭的;**depraved**堕落的;**nasty**下流的;**wretched**可怜的;**sleazy**质地薄的;
	- _filthy lucre_ n. 不义之财
	- a filthy hospital with no sanitation 一所没有卫生设施的污秽不堪的医院。
	- he has become filthy rich /他已经富得流油。
	- had a filthy mouth; foul language; smutty jokes. / 有一张下流的嘴巴；淫秽的语言；淫秽的笑话。
- filthily
...
flack
- n. 广告；宣传；高射炮；宣传员
- [antiaircraft](dic://antiaircraft), [antiaircraft gun](dic://antiaircraft gun), [flak](dic://flak), [pom-pom](dic://pom-pom), [ack-ack](dic://ack-ack), [ack-ack gun](dic://ack-ack gun)
- [fire](dic://fire), [attack](dic://attack), [flak](dic://flak), [blast](dic://blast)
- [flak catcher](dic://flak catcher), [flak](dic://flak), [flack catcher](dic://flack catcher)
- _n._ [spokesperson](dic://spokesperson), [interpreter](dic://interpreter), [representative](dic://representative), [voice](dic://voice), [criticism](dic://criticism), [unfavorable judgment](dic://unfavorable judgment), [gun](dic://gun)
- **criticism**批评, 批判, 指责;**kudos**荣誉;**publicity**公众的注意;**backlash**反斜线;**snarky**恶声恶气的，咬人的;**disparaging**轻蔑的;**pissed**愤怒的;**ire**忿怒;**controversy**争论;**scrutiny**监视;**bashing**用废矸石充填采空区;
- flacking for a movie studio /为一电影制片厂作广告
- Well, you're a paid flack. Don't you have to say that /你是拿了钱替他做宣传 必须得这么说吧？
- They've gotten a lot of flack over for even wanting to do and so that's been a struggle for many years. /他们甚至因为想做这件事而受到了很多批评，所以这可以说是一场多年来的斗争。
...
flamenco
- _n._ [dance music](dic://dance music), [danceroom music](dic://danceroom music), [ballroom music](dic://ballroom music), [social dancing](dic://social dancing)
...
- _[dance a flamenco](dic://dance%20a%20flamenco)_ 跳一种吉卜赛舞蹈
...
- a flare-up between the two countries /两国突发的暴力冲突。
- There are no solar flares right now. Yes, there are /这会儿没有太阳风暴 不对 有的。
- flaring
- flarimeter
- flarestack
- flared
- flareback
	- flareback n. 激烈的反驳；后曳的火焰
- falre-up
	- n. 突然燃烧起来；骤燃（等于 flare-up）
	- _[flareup lamp](dic://flareup%20lamp)_ 闪光灯
	- _[flareup light](dic://flareup%20light)_ 火焰
	- But you know, when the records are coming out and there's no divots and there's no flareups of any kind, it's kind of cool, you know? /但是你知道，当唱片出来的时候，没有草皮，也没有任何形式的火焰，这很酷，你知道吗？
...
- vt. 侥幸成功；意外受挫 
- vi. 侥幸成功
- [good luck](dic://good luck), [good fortune](dic://good fortune)
- [flue](dic://flue)
-  [trematode](dic://trematode), [trematode worm](dic://trematode worm)
- _n._ [luck](dic://luck), [fortune](dic://fortune), [barb](dic://barb), [projection](dic://projection), [tail](dic://tail), [flatworm](dic://flatworm), [platyhelminth](dic://platyhelminth)
- **coincidence**巧合，同时发生;**blip**物体光点;**coincidental**巧合的;**anomaly**不规则;**unlucky**不幸的;**aberration**偏差;**miracle**奇迹，奇迹般的人或物;**hunch**预感;**improbable**不可信的;**miraculous**奇迹般的, 超自然的;
- _blood fluke_ 血吸虫
-  Ever wonder if that whiskery fellow walking his jowly Scottish terrier or that leggy, long-haired blonde jogging with her Afghan hound were just flukes? /你有否觉得，那个长着山羊胡子的家伙遛着他那只皱皮疙瘩的苏格兰梗，或者那个长腿的金色长发美女跟她的阿富汗猎犬一起慢跑的时候，他们简直就是一对？
- I mean it's almost a fluke every time we find a cave. /我的意思是，我们每次发现洞穴都是侥幸。
- That was just such a perfect fluke that happened.And I was so lucky /这是个侥幸的成功之作 我太走运了。
- Individually, each team's result could be a statistical fluke  /客观地说，每个研究团队所得出的结论可能只是统计意义上的偶然现象。
- They might ask if he's feeling whale, but he'll be able to say, hey, it's no fluke /人们还可能会问他是否对鲸鱼有所感觉，但他会说，嘿，这决不是侥幸。
...
- fondness
	...
	- [affectionateness](dic://affectionateness), [lovingness](dic://lovingness), [warmth](dic://warmth)
	- _n._ [liking](dic://liking), [feeling](dic://feeling), [emotionality](dic://emotionality), [emotionalism](dic://emotionalism)
	- **penchant**嗜好;**fascination**魅力;**disdain**蔑视;**admiration**钦佩;**affinity**吸引力;**affection**感情;**obsession**困扰;**aversion**厌恶;**nostalgia**对往事的怀恋, 怀旧; **knack**诀窍;**dislike**不喜欢，厌恶;
...
- [further](dic://further)
- [nurture](dic://nurture)
- [surrogate](dic://surrogate)
- _vt._ [cultivate](dic://cultivate), [rear](dic://rear), [raise](dic://raise), [plant](dic://plant), [adopt](dic://adopt)
- _adj._ [adoptive](dic://adoptive)
- _n._ [biological](dic://biological)
- **adoptive**有收养关系的;**nurture**养育;**adoption**采用;**parents**父母;**adopt**收养;**orphans**孤儿;**encourage**鼓励, 激励;**promote**促进;**orphanage**孤儿院;**child**儿童，孩子;**facilitate**使便利, 减轻…的困难;
- _oster care_ 看护；照顾
- _foster home_ 寄养家庭；抚养孤儿的家庭
- _foster father_ 养父
- _foster son_ n. 养子
- fosterling
- fosterer
...
- _n._ [crime](dic://crime), [law-breaking](dic://law-breaking), [deceiver](dic://deceiver), [cheat](dic://cheat), [cheater](dic://cheater), [trickster](dic://trickster), [beguiler](dic://beguiler)
	- [deceit](dic://deceit) 指歪曲实情，惯于说谎或蓄意欺骗。  
...
- fraudulent
	- a. 欺诈的, 不正的, 不诚实的
	- (specious, spurious, factitious, fictitious, mendacious, ostensible, inveracious, bogus, fabricated, artificial, fraudulent, beguiling, cunning, devious, contrived, factitious, planned, plotted, apocryphal, phony, illusory)
...
- defraud
	...
	- They deny conspiring to defraud the Inland Revenue /他们否认曾密谋诈骗国内税收。
	- defrauder
...
- **lunatic**精神错乱的;**right-wing**右翼的;**mainstream**主流;**left-wing**左派的;**hippie**嬉皮士;**marginal**边缘的;**ruffle**弄皱;**extremist**极端主义者;**subculture**亚文化群;
	...
	- [margin](dic://margin) 指物体的空白边，一般较宽。  
	- [rim](dic://rim) 指圆形或有曲线的物体的边缘。  
...
- 2. relating to or containing gas bubbles
- [foam](dic://foam)
- [foam](dic://foam), [fizz](dic://fizz), [effervesce](dic://effervesce), [sparkle](dic://sparkle)
- [spume](dic://spume), [suds](dic://suds)
- _n._ [bubble](dic://bubble)
- _v._ [bubble](dic://bubble), [make](dic://make), [create](dic://create)
- **frothy**多泡的;**foaming**发泡，泡沫形成;**bubbles**泡沫;**foam**泡沫;**bubble**气泡，泡沫，泡状物;**swirl**漩涡;**slurry**泥浆;**bubbling**冒泡，鼓泡;**lather**肥皂泡;**skim**撇去…的浮物;**spout**喷口;
...
- frothy
	...
	- [foamy](dic://foamy)
	- _adj._ [effervescent](dic://effervescent), [gaseous](dic://gaseous)
	- _n._ [noneffervescent](dic://noneffervescent), [solid](dic://solid), [liquid](dic://liquid)
	- **fluffy**蓬松的;**creamy**含乳脂的;**bubbly**起泡的;**milky**牛奶的;**off-white**白色;**foaming**发泡，泡沫形成;**bubbles**泡沫;**soapy**涂着肥皂的;**heady**易使人醉〔发晕〕的;**lumpy**粗笨的;**watery**水的;
	- frothily
- frothing
- froth-blower
	- _n._ 〈英谑〉爱喝啤酒的人
...
fuddle
- (patchwork, welter, hodgepodge,  clutter, jumble, muddle, fuddle, mare's nest, smother, ramshackle, assortment, mixture, miscellany, assemblage, sundry, ) 
- vt. 灌醉, 使烂醉, 使迷糊  vi. 狂饮  
- n. 烂醉
- vt. 灌醉；使混乱 
- n. 混乱；酗酒 
...
- befuddle
	...
	- [fuddle](dic://fuddle)
	- _v._ [be](dic://be), [intoxicate](dic://intoxicate), [soak](dic://soak), [inebriate](dic://inebriate)
	- **confuse**使混乱;**frustrate**使不成功, 挫败, 阻止;**amuse**使发笑;**deceive**欺骗;**enlighten**启发;**frighten**使惊吓;**dazzle**耀眼的光;**annoy**骚扰;**amaze**使吃惊;**impress**给…以深刻印象, 使铭记;**mislead**误导;
	- _[befuddled](dic://befuddled)_  adj. 昏沉的，糊里糊涂的; v. 使…迷惑；使…烂醉（befuddle的过去分词）;
	- _[The long discussion befuddled them](dic://The%20long%20discussion%20befuddled%20them)_ 长时间的讨论使得他们头昏脑胀
	- _[befuddled confused](dic://befuddled%20confused)_ 困惑
- befuddlement
	- _n._ [confusion](dic://confusion), [mental confusion](dic://mental confusion), [confusedness](dic://confusedness), [muddiness](dic://muddiness), [disarray](dic://disarray)
	- **amazement**惊奇, 惊愕;**astonishment**惊讶, 惊奇;**confusion**惶惑;**dismay**沮丧，灰心;**disbelief**不相信, 怀疑;**frustration**挫折;**disgust**厌恶，嫌恶;**perplexed**困惑的;**puzzled**困惑的;**disdain**蔑视;**cynicism**犬儒主义;
	- _[befuddlement](dic://befuddlement)_  n. 迷惑
...
- funhouse
	- n. 游乐宫；游乐园
- funfair
	-  [amusement park](dic://amusement park), [pleasure ground](dic://pleasure ground)
	- [carnival](dic://carnival), [fair](dic://fair)
	- _n._ [park](dic://park), [commons](dic://commons), [common](dic://common), [green](dic://green), [show](dic://show)
	- **carnival**狂欢节，嘉年华会;**amusement**娱乐, 乐趣;**circus**马戏团;**stalls**正厅前排座位;**festival**节日;**carousel**旋转木马;**seaside**海滨;**open-air**户外的,野外的;**Blackpool**黑潭;**park**公园;**playground**操场;
- dofunny
	- n. 小附件；那东西

furrow
-  [wrinkle](dic://wrinkle), [crease](dic://crease), [crinkle](dic://crinkle), [seam](dic://seam), [line](dic://line)
-  [rut](dic://rut), [groove](dic://groove)
-  [wrinkle](dic://wrinkle), [crease](dic://crease)
-  [chamfer](dic://chamfer), [chase](dic://chase)
- _n._ [trench](dic://trench), [depression](dic://depression), [impression](dic://impression), [imprint](dic://imprint)
- _v._ [dig](dic://dig), [delve](dic://delve), [cut into](dic://cut into), [turn over](dic://turn over), [fold](dic://fold), [fold up](dic://fold up), [turn up](dic://turn up)
- **brow**眉，眉毛;**plow**犁;**ridge**山脉;**plowing**翻耕，耕作;**ridges**带钢单向皱纹;**sloping**倾斜的;**forehead**前额，额头;**sowing**播种;**sod**草地;**eyebrow**眉毛;
- _furrow irrigation_ 沟灌，畦灌；畦沟灌溉
- John's face was furrowed with tears. /约翰的脸上印满了道道泪痕。
- a look of concern furrowed his brow. /担忧的表情使他的额头上出现皱纹。
- furrowy
- furrowless
...
- futurity
- futuristic
	- **dystopian**反面乌托邦的,反面假想国的;**sci-fi**科幻;**high-tech**高科技;**fantastical**空想的,捕风捉影的;**retro**制动火箭,减速火箭;**modern**现代的，近代的;**spaceship**宇宙飞船;**sleek**圆滑的;**apocalyptic**预示灾祸的;**utopian**空想的;**otherworldly**非现实世界的;
- futurist
	-  [fantast](dic://fantast)
	-  [futuristic](dic://futuristic)
	- _n._ [theologian](dic://theologian), [theologist](dic://theologist), [theologizer](dic://theologizer), [theologiser](dic://theologiser), [visionary](dic://visionary), [illusionist](dic://illusionist), [seer](dic://seer)
	- _adj._ [futurism](dic://futurism)
	- **visionary**幻想的;**futuristic**未来的;**modernist**现代主义的;**thinker**思想家;**postmodern**后现代主义的;**utopian**空想的;**sci-fi**科幻;**apocalyptic**预示灾祸的;**innovator**改革者;**theorist**理论家;**sociologist**社会学家;
- futurism
- futures
- futureless 
...
- _v._ [look](dic://look), [be](dic://be)
- a wide gape of the jaws /嘴上裂了一个大口子。
...
- [garrote](dic://garrote), [garotte](dic://garotte), [scrag](dic://scrag)
- _[garrotte hanging strangle](dic://garrotte%20hanging%20strangle)_ 绞杀
- _[gallows garrotte gibbet hanging noose](dic://gallows%20garrotte%20gibbet%20hanging%20noose)_ 绞刑
- He led them up to Mr Sinik's roof and showed them in person, demonstrating on a friend, how he had garrotted his victims. /他把他们带到辛尼克先生的屋顶，和一个朋友一块展示，他是如何绞死他的受害者的。
...
- **barometer**气压计, 晴雨表;**measure**措施;**measuring**测量用的;**calibrate**校准;**measurement**测量，测量法;**indicator**指示
- _pressure gauge_ 压力计，测压表
- _strain gauge_ 应变仪；[机]变形测量器
- _level gauge_ 水准仪；液面水位计
- _thickness gauge_ 厚薄规，测厚仪
- _gauge block_ 量块；块规
...
- _n._ [cotton](dic://cotton), [cotton cloth](dic://cotton cloth), [net](dic://net), [network](dic://network), [mesh](dic://mesh), [meshing](dic://meshing), [meshwork](dic://meshwork)
- **bandage**绷带;**cloth**布，织物;**muslin**平纹细布;**cotton**棉花;**silk**蚕丝;**tulle**薄纱;**handkerchief**手帕;**drapes**窗帘;**pleated**起褶的;**dressings**敷料剂;**drape**用布帘覆盖;
...
- an awkward stupid person
	- [lout](dic://lout), [clod](dic://clod), [stumblebum](dic://stumblebum), [goon](dic://goon), [oaf](dic://oaf), [lubber](dic://lubber), [lummox](dic://lummox), [lump](dic://lump)
- look with amazement; look stupidly
	- [goggle](dic://goggle), [gape](dic://gape), [gawp](dic://gawp)
- _n._ [clumsy person](dic://clumsy person)
- _v._ [look](dic://look)
- **stare**凝视，盯着看;**marvel**奇迹;**peruse**详细考察;**admiring**赞赏的，羡慕的;**drool**流口水;**flaunt**炫耀;**wander**徘徊;**staring**凝视的，目不转睛的;**look**看;**revel**狂欢;**peek**偷看;
- gawky
	- (fatuous, witless,  tactless, dense,  asinine, inane, mindless, vacuous, preposterous, untactful, inept/inapt. maladroit, obtuse, oafish, lunatic, unwieldy, clunky, clumsy, cumbersome, lumbering, inexpedient, inapplicable, gawky, clumsy, ungainly, awkward, )
	- [clumsy](dic://clumsy), [clunky](dic://clunky), [ungainly](dic://ungainly), [unwieldy](dic://unwieldy)
	- _adj._ [awkward](dic://awkward)
	- **clumsy**笨拙的;**awkward**笨拙的;**chubby**圆胖的，丰满的;**nerdy**书呆子式的;**self-conscious**自觉的;**good-looking**好看的;**goofy**傻瓜的，愚笨的;**diminutive**小的;**childlike**天真的;**timid**羞怯的;**brash**仓促的，性急的;
- gawkish
	- adj. 痴呆的；笨拙的；鲁钝的
	- _[dunny gawkish hammerhead moronic](dic://dunny%20gawkish%20hammerhead%20moronic)_ 鲁钝的
	- _[gawkish oafish](dic://gawkish%20oafish)_ 痴呆的
- gawker
	- _n._ [spectator](dic://spectator), [witness](dic://witness), [viewer](dic://viewer), [watcher](dic://watcher), [looker](dic://looker)
	- **celeb**名人;**commenter**批评家;**NYT**国立青年剧院;**celebrity**名人，明星;**stalker**高视阔步者;

gawp
- vi. 直瞪瞪地注视 n. 呆人；笨蛋
- [goggle](dic://goggle), [gape](dic://gape), [gawk](dic://gawk)
- _v._ [look](dic://look)
- **stare**凝视，盯着看;**marvel**奇迹;**peruse**详细考察;**wander**徘徊;**admiring**赞赏的，羡慕的;**revel**狂欢;**staring**凝视的，目不转睛的;**telly**电视;**stroll**闲逛;**marvellous**惊奇的;**reckon**猜想;
- Will didn't like going to the main area – too many people to gawp at him. /威尔不喜欢去主要区域——太多人无法直视他。
...
- gingery
	...
	- **ginger**姜;**spicy**辛辣的;**tangy**有刺激性的;**fruity**有果味的;**savoury**咸味的;**savory**可口的;**chewy**柔软而会黏着的;**malty**麦芽的;**spiced**调过味的;**pungent**刺激性的;**flavorful**充满…味道的,可口的;
	- It's basically chicken nuggets with this spicy gingery sauce, and cucumbers on the side. /它基本上是带有这种辛辣姜汁酱的鸡块，以及旁边的黄瓜。
	- But at the same time, there's this, like, a gingery, peppery kick behind it. /但与此同时， 它背后有一股辛辣的刺激感。
- gingersnap
	- _n._ [cookie](dic://cookie), [cooky](dic://cooky), [biscuit](dic://biscuit)
	- **cookie**小甜点;**pecan**美洲山核桃;**cinnamon**肉桂;**graham**全麦的;**peppermint**薄荷;**gingerbread**姜饼;**cheesecake**奶酪蛋糕;**ginger**姜;**cranberry**越橘;**cookies**饼干;**pumpkin**南瓜;
	- _[gingersnap](dic://gingersnap)_  n. 姜饼
- gingerroot
- gingerol
	- 【化】 姜醇 【医】 姜辣素
- gingerbread
...
- vainglory, vainglorious
	...
	- In fact, he was a vainglorious person and nobody dared to hurt his vainglory 际上他是一个极自负的人并且没有敢伤害他极度的虚荣心。
- inglorious
- glory-box
	- n. 嫁妆箱
- glorious
...
- [goading](dic://goading), [prod](dic://prod), [prodding](dic://prodding), [urging](dic://urging), [spur](dic://spur), [spurring](dic://spurring)

good
- goody (woody, foody, moody, )
	- **goodie**身份低微之老妇;**swag**赃物，掠夺品;**bag**袋;**freebie**免费的东西;**bags**包;**raffle**抽彩售物;**prizes**奖品;**candy**用糖煮;**snacks**快餐;**sweets**糖果;
	- [nutriment](dic://nutriment), [nourishment](dic://nourishment), [nutrition](dic://nutrition), [sustenance](dic://sustenance), [aliment](dic://aliment), [alimentation](dic://alimentation), [victuals](dic://victuals)
	- [dainty](dic://dainty), [delicacy](dic://delicacy), [kickshaw](dic://kickshaw), [treat](dic://treat)
- etc.. (todo)

gossamer
- n. 小蜘蛛网, 蛛丝, 薄纱  a. 薄弱的, 轻飘飘的
- gossamer - 按旧时英国习俗，风和日暖的11月上中旬乃食鹅时节，人们称之为gossamer（相当于goose summer），它是由gos（即goose，鹅）和somer（即summer，夏季）二词组合而成。英国有一个传统宗教节日St. Martin's Day（圣马丁节）恰在11月11日，故gossamer亦称St. Martin's summer。美国人把这一时节称作Indian summer，和中国人所说的“小阳春”差不多。这个时节虽然已近晚秋，但是天气却晴暖如春，在林子里，在草丛中，常常可以看到蜘蛛在吐丝结网，薄纱似的银丝飘浮在宁静的空气中。14世纪以后，gossamer先是转义指“蛛丝”、“游丝”，而后又引申为“薄纱”，原因恐怕即在于此。
- [cobweb](dic://cobweb)
- [ethereal](dic://ethereal)
- [diaphanous](dic://diaphanous), [filmy](dic://filmy), [gauzy](dic://gauzy), [gauze-like](dic://gauze-like), [see-through](dic://see-through), [sheer](dic://sheer), [transparent](dic://transparent), [vaporous](dic://vaporous), [vapourous](dic://vapourous), [cobwebby](dic://cobwebby)
- _n._ [gauze](dic://gauze), [netting](dic://netting), [veiling](dic://veiling), [fibril](dic://fibril), [filament](dic://filament), [strand](dic://strand)
- _adj._ [delicate](dic://delicate), [thin](dic://thin)
- _n._ [rugged](dic://rugged), [thick](dic://thick)
- **ethereal**天上的;**silvery**似银的，银色的;**lacy**花边的;**silk**蚕丝;**tulle**薄纱;**chiffon**薄绸;**cocoon**茧;**thin**薄的;**delicate**微妙的;**veil**面纱;**starry**布满星星的;
- _[gossamer pily](dic://gossamer%20pily)_ 轻飘飘的
- _[gossamer cobwebs](dic://gossamer%20cobwebs)_ 纤薄的蜘蛛网
- _[gossamer lace-curtain](dic://gossamer%20lace-curtain)_ 薄纱蕾丝窗帘
...
- grating
- graticule
	- _[graticule](dic://graticule)_  n. 格子线；显微镜的计数线；方格图
	- _[graticule mesh](dic://graticule%20mesh)_  格网
	- stereograticule
- grater
- grateless
	- - adj．无格栅的：没有格栅或栅栏的。
...
- greasy
	...
	- _n._ [nonfat](dic://nonfat), [fat-free](dic://fat-free), [fatless](dic://fatless), [clean](dic://clean)
	- **oily**油的;**smelly**有臭味的，发臭的;**slimy**黏滑的;**soggy**浸水的;**grease**动物油脂;**gooey**感伤的;**sweaty**出汗的;**slick**光滑的;**stinky**发恶臭的;**sticky**粘的;**icky**讨厌的;
	- _greasy spoon_ 低级小饭馆；经济小吃店
	- _greasy wool_ 含脂原毛，汗羊毛
	- Greasy food tastes very oily and usually leaves oil behind. /油腻的食物味道很油，通常会留下油。
	- greasiness
	- greasily
- greasing
- greasewood
...
- [cartilage](dic://cartilage)
- **meat**肉，肉类;**meaty**多肉的;**bones**骨骼;**bone**骨;**flesh**肉体;**steak**牛排;**cartilage**软骨;**beef**牛肉;**chew**咀嚼;**chunks**大块，矮胖的人或物;**carcass**尸体;
- _[Taro chicken gristle](dic://Taro%20chicken%20gristle)_ 香芋鸡脆骨
- _[Chicken gristle skewer](dic://Chicken%20gristle%20skewer)_ 蒜茸烧元贝
- _[Sheep gristle meat](dic://Sheep%20gristle%20meat)_ 羊脆骨肉
- _[Dishes Mushroom Chicken gristle](dic://Dishes%20Mushroom%20Chicken%20gristle)_ 小炒香菇鸡脆骨

grizzle, grizzly, grizzled, 
-  [brood](dic://brood), [stew](dic://stew)
- [whine](dic://whine), [yammer](dic://yammer), [yawp](dic://yawp)
- _n._ [wig](dic://wig)
- _v._ [sulk](dic://sulk), [pout](dic://pout), [brood](dic://brood), [complain](dic://complain), [kick](dic://kick), [plain](dic://plain), [sound off](dic://sound off)
- grizzled hair /灰白的头发。
- Not so very old, although his hair was grizzled—what there was of it. /不是很老，虽然他的头发已经花白了——那也不过如此。

groan
-  [moan](dic://moan)
-  [moan](dic://moan), [sough](dic://sough)
- _n._ [utterance](dic://utterance), [vocalization](dic://vocalization)
- _v._ [utter](dic://utter), [emit](dic://emit), [let out](dic://let out), [let loose](dic://let loose)
...
- **booze**酒;**rum**古怪的;**liquor**酒，含酒精饮料;**whiskey**威士忌酒;**drink**喝，饮;**brandy**白兰地酒;**gin**杜松子酒;**whisky**威士忌酒;**pint**品脱;**ale**麦芽酒;**cask**木桶，桶;
- I invited Wemmick to come upstairs, and refresh himself with a glass of grogbefore walking to Walworth. /我请温米克上楼，喝杯烈酒提神，然后步行前往沃尔沃思。

groin (crotch, )
- [inguen](dic://inguen)
- **thigh**大腿，股;**hamstring**使无能为力;**knee**膝盖，膝;**ankle**踝关节，踝;**elbow**弯头;**abdomen**腹部;**forearm**前臂;**soreness**悲伤;**crotch**胯部，分叉处;**buttocks**臀部;**chest**胸，胸部;
- _n._ [area](dic://area), [region](dic://region), [barrier](dic://barrier)
- _v._ [construct](dic://construct), [build](dic://build), [make](dic://make)
- [breakwater](dic://breakwater), [groyne](dic://groyne), [mole](dic://mole), [bulwark](dic://bulwark), [seawall](dic://seawall), [jetty](dic://jetty)
- he has a slight groin strain /他腹股沟轻微损伤。

grommet
-  [cringle](dic://cringle), [eyelet](dic://eyelet), [loop](dic://loop), [grummet](dic://grummet)
...
- _[grommets](dic://grommets)_  n. 垫圈；索环（grommet的复数）
- _[grommet hole](dic://grommet%20hole)_  眼圈洞
- _[rubber grommet](dic://rubber%20grommet)_  橡皮环；橡胶索环；橡胶孔环
- _[grommet type seals](dic://grommet%20type%20seals)_  环形密封圈
...
-  [channel](dic://channel)
- [rut](dic://rut)
-  [vallecula](dic://vallecula)
-  [furrow](dic://furrow), [rut](dic://rut)
- _n._ [depression](dic://depression), [impression](dic://impression), [imprint](dic://imprint), [routine](dic://routine), [modus operandi](dic://modus operandi), [body part](dic://body part)
- _v._ [incise](dic://incise), [dig](dic://dig), [delve](dic://delve), [cut into](dic://cut into), [turn over](dic://turn over)
- **rhythm**节奏;**funk**恐惧;**vibe**感应;**melodic**有旋律的;**jazzy**爵士乐的;**riff**反复乐节;**flange**凸缘;**tongue**语言;**groovy**吸引人的, 绝妙的;**notches**刻痕;**concave**凹的，凹面的;
- got into the groove of a nine-to-five job. /陷入了八小工作的常规
- the groove laid down by the drummer and bassist is tough and funky /由鼓手和低音吉他手奠定的节奏激烈而且时髦。
- his thoughts were slipping into a familiar groove /他的思想正滑向习惯的模式。
- minigroove
- microgroove
- groover
	- n. 挖槽机；挖槽者
	- _n._ [device](dic://device)
...
gross
- 1. twelve dozen (144)
- [revenue](dic://revenue), [receipts](dic://receipts)
-  [megascopic](dic://megascopic)
-  [porcine](dic://porcine)
-  [crying(a)](dic://crying(a)), [egregious](dic://egregious), [flagrant](dic://flagrant), [glaring](dic://glaring), [rank](dic://rank)
-  [arrant(a)](dic://arrant(a)), [complete(a)](dic://complete(a)), [consummate(a)](dic://consummate(a)), [double-dyed(a)](dic://double-dyed(a)), [everlasting(a)](dic://everlasting(a)), [perfect(a)](dic://perfect(a)), [pure(a)](dic://pure(a)), [sodding(a)](dic://sodding(a)), [stark(a)](dic://stark(a)), [staring(a)](dic://staring(a)), [thoroughgoing(a)](dic://thoroughgoing(a)), [utter(a)](dic://utter(a)), [unadulterated](dic://unadulterated)
-  [coarse](dic://coarse), [crude](dic://crude), [earthy](dic://earthy), [vulgar](dic://vulgar)
- _n._ [large integer](dic://large integer), [income](dic://income)
- _v._ [gain](dic://gain), [take in](dic://take in), [clear](dic://clear), [make](dic://make), [earn](dic://earn), [realize](dic://realize), [realise](dic://realise)
- _adj._ [overall](dic://overall), [total](dic://total), [whole](dic://whole), [macroscopic](dic://macroscopic), [macroscopical](dic://macroscopical), [general](dic://general), [fat](dic://fat)
- _n._ [net](dic://net), [nett](dic://nett), [microscopic](dic://microscopic), [microscopical](dic://microscopical), [specific](dic://specific), [thin](dic://thin), [lean](dic://lean)
	- [entire](dic://entire) 除了有whole的意思外，还强调既不能加一个也不减少一个的含义。  
	- [whole](dic://whole) 比entire更普通，强调每个组成部分都包括在内，无一漏掉或舍去。  
	- [complete](dic://complete) 强调事物在内容、程度、或数量方面已完整，已达标准。  
	- [full](dic://full) 侧重指内容，含有能包括所有的充足内容的意味。  
	- [total](dic://total) 与complete用法相近，但强调总量。  
	- [gross](dic://gross) 侧重指未打折扣，未除去成本或皮重等与净重、净数相对。  
	- [all](dic://all) 有时可与whole,entire和total换用。 
- **disgusting**令人厌恶的;**icky**讨厌的;**grotesque**奇形怪状的;**total**全部的;**crass**粗鲁的;**domestic**国内的;
- grosbeak
- grogram
...
- unground, ungrounded
	...
	- So I've decided to unground them for the homecoming dance /所以我打算同意他们去返校舞会。
- underground
- stone-ground
- playground
- pasture-ground
...
- disgruntle
	...
	- - v. 使……不高兴，使愠怒
	- _v._ [dissatisfy](dic://dissatisfy)
	- **angry**生气的;**alienate**使疏远，离间;**unhappy**不幸福的;**annoy**骚扰;**resentful**感到愤恨的, 表示愤恨的, 憎恨的;**frustrate**使不成功, 挫败, 阻止;**grumpy**脾气暴躁的;**jaded**厌倦的;**hapless**运气不好的，倒霉的;**appease**使平息;**annoyed**恼怒的;
	- Seamus was not the only person disgruntled by the choice of Katie's substitute /西莫不是唯一对凯蒂替代者的选择不满的人。
	- And when Ove got disgruntled she always had to challenge the importance of having a time plan when driving somewhere. /每次欧维生气的时候，她总会问，可以自驾，时间表为什么还那么重要。
	- There are a lot of disgruntled commuters out there. /那里有很多心怀不满的通勤者。
	- 
- disgruntled
...
- guarding
- guardian
	-  [defender](dic://defender), [protector](dic://protector), [shielder](dic://shielder)
	-  [custodial](dic://custodial), [tutelary](dic://tutelary), [tutelar](dic://tutelar)
	- _n._ [preserver](dic://preserver)
	- _adj._ [protective](dic://protective)
	- _n._ [unprotective](dic://unprotective)
	- **guardianship**保护,守护,监护人的职责;**custodian**管理人;**angel**天使;**caretaker**看门人;**parent**父母亲;**angelic**天使的;**protector**保护人;**elder**年长者;**executor**执行者;**regent**摄政者;**angels**天使投资人;
	- guardianship
- guardhouse
- guarder
- guarded
...
- No one's giving you any guff about being a stripper, are they? /没人对你当作舞女的事，说什么废话吧？
-  To hear more guff about a mother's love? - Mr Bryant, that's not fair./还要听什么关于母爱的废话吗？- 布莱恩先生，这不公平。
- " No, " she sighed, " just some guff about the bass player in the Weird Sisters getting married." /“没有，”她叹了口气，“都是关于古怪姐妹演唱组的低音乐器手结婚的无聊废话。”
- I don't need any guff from the fellas that work for me. /不需要手下人之言。
- To some this may sound like marketing guff but it is precisely the sort of thing investors and prospective staff still want to hear. /对一些人来说，这听起来像是营销废话，但这恰恰是投资者和潜在员工仍然希望听到的事情。
- We suspect that there will be all sorts of self-justifying **guff** from them. /我们怀疑他们会带来各种各样的自我辩解。
- guffaw
	- n. 哄笑；狂笑
	- vi. 哄笑
	- vt. 大笑着说
	...
	- both men guffawed at the remark /两人对此言都报以狂笑。
	- a mingled guffaw from Heathcliff and Hareton /希刺克厉夫与哈里顿一起放声大笑
	- They will put your name in the pot.They will let you off the hook.Fat people will gab, giggle, guffaw, galumph, gyrate, and gossip /他们直接切入问题的要害，而胖人则让事情处于模糊和朦胧的状态———事情本来就是这样。
	- Neil surprised us with his deep guffaw. /尼尔的狂笑声惊到我们了。
	- Moaning Myrtle sped them on their way with a hearty guffaw /哭泣的桃金娘兴高采烈地粗声大笑，使得他们更加快了脚步。
	- " He's got Crabbe and Goyle transforming into girls? " guffawed Ron. /“他把克拉布和高尔变成了女生？”罗恩说着大笑起来。
	- To show amusement, teased, chortled, guffawed. /表现出愉悦、嘲笑、欢笑、狂笑。

guggle
- - v. 发汩汩声；汩汩地流；（婴儿）咯咯作声（同 gurgle） 
- n. （人高兴发出的）咯咯声；（水流的）汩汩声（同 gurgle）
- 
...
- **antics**滑稽动作;**fiasco**惨败;**silliness**愚蠢;**debacle**崩溃;**pranks**恶作剧;**prank**恶作剧，开玩笑;**craziness**发狂,热中,狂热;**mischief**伤害;**farce**笑剧,闹剧,滑稽戏;**nefarious**极坏的;**idiocy**白痴;
- [shrewdness](dic://shrewdness), [astuteness](dic://astuteness), [perspicacity](dic://perspicacity), [perspicaciousness](dic://perspicaciousness), [disingenuousness](dic://disingenuousness), [deception](dic://deception), [deceit](dic://deceit)
- [trickery](dic://trickery), [chicanery](dic://chicanery), [chicane](dic://chicane), [wile](dic://wile), [shenanigan](dic://shenanigan)
- [craftiness](dic://craftiness), [deceitfulness](dic://deceitfulness)
- [craft](dic://craft), [craftiness](dic://craftiness), [cunning](dic://cunning), [foxiness](dic://foxiness), [slyness](dic://slyness), [wiliness](dic://wiliness)
- [deception](dic://deception), [deceit](dic://deceit), [dissembling](dic://dissembling), [dissimulation](dic://dissimulation)
- guileless
- guileful
- beguile
	- beguiling
...
- _gush over_ 滔滔不绝地说
- a gush of tears /泪如泉涌
- water gushing from a hydrant. /水从消防龙头中喷涌而出
- blood gushing from a wound /伤口涌出的血
- a sudden spurt of blood gushed into her eyes /一股血喷进她的眼里。
- the blood gushed out in scarlet streams. /鲜红的血一股股涌出。
- her mother's sudden gush of fury and vitriol. /她母亲突然间的大发雷霆和尖刻指责。
- Clear water gushed into the irrigational channel. /清澈的水涌进了灌溉渠道。
- The wound re-opened in a gush of blood. /伤口又裂开了，血流如注。
- Footage has shown a torrent of water gushing through the Dhauliganga River. /视频显示，湍急的水流涌过了道里甘加河。
- But some positively gush about how Slack has simplified office communication. /但有人对Slack赞不绝口，称其简化了办公通讯。
- The sea gushed forward and backward; it was a mournful sound /海浪反复拍击着岩石，发出悲怆的声响。
- gusher
	- n. 喷油井；说话滔滔不绝的人
	- It was not till 1859 that the first " oil gusher" of western Pennsylvania opened up an entirely new source of wealth. /直到 1859 年， 宾夕法尼亚州西部的第一个“油井” 才开辟了一个全新的财富来源。
	- And a bizarre sight in the Philadelphia skyline Sunday morning - a gusher of water streaming from the side of a 61-story skyscraper. /周日早上，费城天际线上突现一道奇异景观——61层摩天大楼侧面喷出水流。
	- Some ranchers with an instinct for water, like that of the miner for metal, sank wells into the dry sand and were rewarded with gushers that " soused the thirsty desert and turned its good-for-nothing sand into good-for-anything loam." /一些对水有本能的牧场主， 就像金属矿工对水的本能一样，在干涸的沙地上打井， 并得到井喷作为奖励， 这些井“浸湿了干涸的沙漠， 把一无是处的沙子变成了万能的肥土。
...
haggard
- **ragged**衣衫褴褛的;**weary**疲倦的;**wrinkled**具皱的，有皱纹的;**frail**虚弱的;**tired**疲倦的;**sickly**有病的，苍白的;**pale**苍白的;**fatigued**疲乏的;**grumpy**脾气暴躁的;**cranky**暴躁的;**bearded**有芒的;
- [bony](dic://bony), [cadaverous](dic://cadaverous), [emaciated](dic://emaciated), [gaunt](dic://gaunt), [pinched](dic://pinched), [skeletal](dic://skeletal), [wasted](dic://wasted)
- [careworn](dic://careworn), [drawn](dic://drawn), [raddled](dic://raddled), [worn](dic://worn)
- _[Unbearably haggard from suffering](dic://Unbearably%20haggard%20from%20suffering)_ 痿损不堪
- _[He looked distraught and haggard](dic://He%20looked%20distraught%20and%20haggard)_ 他显得面容憔悴
...
hail
- loudhailer
	- [bullhorn](dic://bullhorn), [loud-hailer](dic://loud-hailer)
	- [loudspeaker](dic://loudspeaker), [speaker](dic://speaker), [speaker unit](dic://speaker unit), [loudspeaker system](dic://loudspeaker system), [speaker system](dic://speaker system)
- haily
- hailstorm
	- **hail**冰雹;**thunderstorm**雷电交加的暴风雨;**storm**暴风雨;**storms**暴风雨;**rain**雨;**snowstorm**暴风雪,雪崩;**tornado**旋风;**rains**雨季;**deluge**洪水;**blizzard**暴风雪，大风雪;**torrential**似急流的;
- hailstone
	- **hail**冰雹;**meteor**流星;**meteorite**陨星;**thunderstorm**雷电交加的暴风雨;**rain**雨;**tornado**旋风;**storm**暴风雨;**fireball**火球;**snowfall**降雪;**storms**暴风雨;**rains**雨季;
- hailer
- hail-fellow
...
hallow
- (mallow, hallow, sallow, shallow, hollow, wallow, callow)
- unhallowed
- unhallow
- hallowed
- [consecrate](dic://consecrate), [bless](dic://bless), [sanctify](dic://sanctify) 
- **hollow**空的;**solemn**庄严的，严肃的;

ham
- **bacon**熏猪肉;**turkey**火鸡;**sausage**香肠;**pork**猪肉;**sandwich**三明治;**sausages**香肠， 腊肠;**chicken**小鸡;**cheese**奶酪;**meat**肉，肉类;**meats**肉类;**tuna**金枪鱼，鲔鱼;
- [overact](dic://overact), [ham it up](dic://ham it up), [overplay](dic://overplay)
...
- hammy
	...
	- there is some hammy acting /有一些夸张的表演。
	- I think of you and how one trip where I practically tore my hammy. /我都会想到你 以及那一场让我撕裂腿筋的旅途。
- ham-handed
- ham-fisted
...
- _v._ [run](dic://run)
	- [hare](dic://hare) 指生在森林或田野等处的野兔。  
	- [rabbit](dic://rabbit) 通常指家中饲养的家兔
- **tortoise**迟缓的人;**fox**欺骗;**rabbit**兔子，野兔;**squirrel**松鼠;**rabbits**兔子;**hound**追猎;**bunny**兔子;**snail**蜗牛;**lion**狮子;**coyote**一种产于北美大草原的小狼;**foxes**狐狸;
- _run after two hares_ 做徒劳无益之事；面面俱到，诸事未了
- _hare krishna_ 印度教克利须那派教徒；印度教克利须那派；礼赞印度教克利须那神的颂歌
- _march hare_ 发情期的野兔
- _start a hare_ ◎【狩猎】赶出兔子再捕捉;◎提出(枝节)问题，转移别人的注意力;

harrow (mallow, hallow, sallow, shallow, hollow, harrow, wallow, callow)
...
haste
-  [hastiness](dic://hastiness), [hurry](dic://hurry), [hurriedness](dic://hurriedness), [precipitation](dic://precipitation)
-  [hurry](dic://hurry), [rush](dic://rush), [rushing](dic://rushing)
- [speed](dic://speed), [swiftness](dic://swiftness), [fastness](dic://fastness), [motion](dic://motion), [movement](dic://movement), [move](dic://move), [urgency](dic://urgency)
	- [haste](dic://haste) 中性词，用作褒义指动作迅速，事情做得又快又好；作贬义用时，指做事急躁，行为鲁莽，得不到预期的结果。  
	- [speed](dic://speed) 多用于褒义，指行动敏捷快速，效果好。  
	- [hurry](dic://hurry) 指急速从事某项活动或匆忙对付一件事情，含明显慌乱的意味。  
	- [dispatch](dic://dispatch) 指迅速、敏捷地结束某事，强调敏捷和及时。
- **hasty**匆忙的;**hurried**匆忙的;**hurry**匆忙，急忙;**hastily**匆忙地;**impatience**急躁;**lest**唯恐，以免;**rush**匆促;**eagerness**渴望;**fury**狂怒;**hasten**催促;
- posthaste
...
haul
-  [draw](dic://draw), [haulage](dic://haulage)
-  [catch](dic://catch)
- [hale](dic://hale), [cart](dic://cart), [drag](dic://drag)
- _n._ [pull](dic://pull), [pulling](dic://pulling), [indefinite quantity](dic://indefinite quantity)
- _v._ [pull](dic://pull), [draw](dic://draw), [force](dic://force), [transport](dic://transport), [carry](dic://carry)
	- [drag](dic://drag) 指沿斜坡而上或水平方向缓慢地拖或拉十分沉重的人或物。作借喻时可指把人硬拉扯过来。  
	- [draw](dic://draw) 指将人或物朝出力者的方向拖，不涉及力的大小，含平稳意味，常作借喻用。  
	- [pull](dic://pull) 最普通用词，包含本组其它各词的一些意思，可指朝各个方向拉，侧重一时或突然拉动的动作。  
	- [haul](dic://haul) 指用力拖或拉，不涉及方向，多作航海用词。  
	- [tug](dic://tug) 多指一阵阵地用力拖或拉，但不一定使被拉的人或物移动。  
...
- _v._ [overcast](dic://overcast), [cloud](dic://cloud), [harass](dic://harass), [hassle](dic://hassle), [harry](dic://harry), [chivy](dic://chivy), [chivvy](dic://chivvy)
- **hazy**朦胧的;**fog**雾;**foggy**有雾的;**misty**模糊的;**mist**薄雾;**smog**烟雾;**smoke**烟;**clouded**有暗影的，阴的;**clouds**云彩，白云;**cloudy**多云的;**blur**涂污;
- hazy
	- haziness
	- hazily
- hazemeter
...
heart
- wholehearted
	- _adj._ [sincere](dic://sincere)
	- _n._ [insincere](dic://insincere)
	- **sincere**真诚的;**heartfelt**衷心的;**unwavering**不动摇的,坚定的;**unequivocal**只有一种含意的;**fervent**强烈的;**enthusiastic**满腔热情的, 热心的;**unconditional**无条件的;**commitment**承诺;**enthusiastically**热心地;**steadfast**坚定的;**devotion**热爱;
	- whole-heartedly
- warmhearted
- truehearted
- tenderhearted
...
- heavyhearted
- hearty
	- adj. 健壮的；精神饱满的；衷心的；丰盛的
	- n. 朋友们；伙伴们
	- [cordial](dic://cordial)
	- [satisfying](dic://satisfying), [solid](dic://solid), [square](dic://square), [substantial](dic://substantial)
	- [full-blooded](dic://full-blooded), [lusty](dic://lusty), [red-blooded](dic://red-blooded)
	- _adj._ [warm](dic://warm), [wholesome](dic://wholesome), [healthy](dic://healthy), [complete](dic://complete)
	- _n._ [cool](dic://cool), [unwholesome](dic://unwholesome), [unhealthy](dic://unhealthy), [incomplete](dic://incomplete), [uncomplete](dic://uncomplete)
	- **tasty**美味的;**delicious**美味的;**flavorful**充满…味道的,可口的;**scrumptious**可口的,美味的;**wholesome**有益健康的;**rousing**活泼的;**warm**温暖的;**meaty**多肉的;**delectable**令人愉快的;**savory**可口的;**heartfelt**衷心的;
	- _hale and hearty_ 精神充沛的，矍铄的；老当益壮的，健壮的
	- hearty support /全力支持
	- a hearty chowder. /营养丰富的杂烩
	- a hearty meal /一顿丰盛晚餐
	- hearty congratulations. /衷心祝贺。
	- a hearty glow of health /容光焕发
	- a person with a hearty appetite. /好胃口的人
	- a rough but hearty welcome /虽不周到但热情诚心的欢迎
	- a hearty and boisterous character. /欢快喧闹的性格。
	- He ate a hearty breakfast. /他享用了一顿丰盛的早餐。
	- a big, bluff, hearty man. /身材高大、言行坦率的热心人。
	- a formidably hearty spinster of fifty-five. /一个出奇强健的55岁单身女人。
	- they deserve a hearty slap on the back for their efforts. /他们的努力值得衷心赞扬。
	- sent hearty greetings; /表示热烈的祝贺；
	- received hearty thanks /接受诚恳的感谢。
	- Fawcett gave me a hearty handshake /福西特和我亲切地握了握手。
	- Percy Weasley let out a hearty laugh /珀西韦斯莱放声大笑起来。
	- Moaning Myrtle sped them on their way with a hearty guffaw. /哭泣的桃金娘兴高采烈地粗声大笑，使得他们更加快了脚步。
	- I overhear that the hearty man heartily yearns for my harness in the barn./我无意中听说那个热忱的人十分向往我的牲口棚中的马具。
	- He gave Harry a hearty wink and strode off. /他亲切地朝哈利眨了眨眼，迈着方步走开了。
- heartworm
- haertwood
- heartwater
- heartthrob
...
heave
- _vt._ 举；拉；扔，抛 _vt. & vi._ 喘息；发出 呕吐
4. _vi._ 凸起；起伏
5. _n._ 举，提，拖，拉，扔，起伏，升起
- [heaving](dic://heaving)
- [retch](dic://retch)
...
==high==
- high-minded
	- **idealistic**理想主义的;**lofty**崇高的;**cynical**愤世嫉俗的;**pragmatic**务实的;**principled**原则性的;**pretentious**自命不凡的;**pious**虔诚的;**admirable**令人钦佩的;**crass**粗鲁的;**pompous**浮夸的;**noble**贵族的;
- waist-high
- etc..
...
-  [frost](dic://frost), [hoarfrost](dic://hoarfrost), [rime](dic://rime)
- [grey](dic://grey), [gray](dic://gray), [grey-haired](dic://grey-haired), [gray-haired](dic://gray-haired), [grey-headed](dic://grey-headed), [gray-headed](dic://gray-headed), [grizzly](dic://grizzly), [hoary](dic://hoary), [white-haired](dic://white-haired)
- _n._ [ice](dic://ice), [water ice](dic://water ice)
- _adj._ [old](dic://old)
- _n._ [young](dic://young), [immature](dic://immature)
- **frost**结霜于;**snow**雪，积雪;**dew**露水;**ere**在…以前;
...
- hoary
	...
	- [canescent](dic://canescent)
		- _adj._ [achromatic](dic://achromatic), [hairy](dic://hairy), [haired](dic://haired), [hirsute](dic://hirsute)
		- _n._ [chromatic](dic://chromatic), [hairless](dic://hairless)
	- [rusty](dic://rusty)
	- [grey](dic://grey), [gray](dic://gray), [grey-haired](dic://grey-haired), [gray-haired](dic://gray-haired), [grey-headed](dic://grey-headed), [gray-headed](dic://gray-headed), [grizzly](dic://grizzly), [hoar](dic://hoar), [white-haired](dic://white-haired)
	- hoary-headed
		- _adj._ 白头发的
	- hoariness
- hoarstone
- hoarfrost
	- _n._ [ice](dic://ice), [water ice](dic://water ice)
	- **snow**雪，积雪;**frost**结霜于;**snowfall**降雪;**snowy**下雪的，多雪的;**dew**露水;**frosty**结霜的，严寒的;**icy**冰冷的;**snowstorm**暴风雪,雪崩;**mist**薄雾;**snowing**下雪;**moonlight**月光;

hoard
- [cache](dic://cache), [stash](dic://stash)
- [stash](dic://stash), [cache](dic://cache), [lay away](dic://lay away), [hive up](dic://hive up), [squirrel away](dic://squirrel away)
- [roll up](dic://roll up), [collect](dic://collect), [accumulate](dic://accumulate), [pile up](dic://pile up), [amass](dic://amass), [compile](dic://compile)
- _n._ [store](dic://store), [stock](dic://stock), [fund](dic://fund)
...
- hogget
- hoggery
	- _hoggery_  n. 养猪场；猪一样的贪娈行为
- hogfish
- hogback
- hog-wild
- hedgehog
	- [porcupine](dic://porcupine)
	- _n._ [rodent](dic://rodent), [gnawer](dic://gnawer), [gnawing animal](dic://gnawing animal), [insectivore](dic://insectivore)
	- **rabbit**兔子，野兔;**hamster**仓鼠;**fox**欺骗;**squirrel**松鼠;**raccoon**浣熊毛皮;**bunny**兔子;**owl**猫头鹰;**badger**獾;**hare**野兔;**foxes**狐狸;**critter**动物;
	- _[sonic hedgehog](dic://sonic%20hedgehog)_  音猬因子（重要的信号传导分子）
	- _[sea hedgehog](dic://sea%20hedgehog)_  n. 海胆
- groundhog
...
- uphold
	...
	- _[Companies To Uphold The](dic://Companies%20To%20Uphold%20The)_ 公司秉承以
	- _[But Has Been Upheld](dic://But%20Has%20Been%20Upheld)_ 但一直在坚持
...
- stranglehold
	- _n._ [power](dic://power), [powerfulness](dic://powerfulness), [wrestling hold](dic://wrestling hold)
	- **monopoly**垄断;**dominance**支配;**hegemony**霸权;**domination**支配;**foothold**立足处;**entrenched**根深蒂固的;**dominating**有领导作风的;**supremacy**至高, 无上;**dominate**支配;**stronghold**要塞;**shackles**手铐，脚镣;
...
- holdover
	...
	- _[holdover voltage](dic://holdover%20voltage)_ 过保持电压
	- _[holdover performance](dic://holdover%20performance)_ 保持性能
	- _[holdover fire](dic://holdover%20fire)_ 长时期隐燃的火; 残余火; 
	- _[holdover time](dic://holdover%20time)_ 保持时间; 延续时间; 除冰有效期;
	- General Electric, was a holdover from America’s conglomerate and industrial era /通用电气是美国企业集团和工业时代的产物
- holdout
...
- holding
- holdfast
	-  [fastener](dic://fastener), [fastening](dic://fastening), [fixing](dic://fixing)
	- _n._ [restraint](dic://restraint), [constraint](dic://constraint)
...
-  [sharpen](dic://sharpen), [better](dic://better), [improve](dic://improve), [amend](dic://amend), [ameliorate](dic://ameliorate), [meliorate](dic://meliorate)

honey
- **bee**蜜蜂，蜂;**nectar**花蜜;**syrup**糖浆，果汁;**milk**牛奶;**marmalade**果子酱;**cinnamon**肉桂;**sugar**糖;**hives**假膜性喉头炎;**yoghurt**酸乳酪;**vinegar**醋;**butter**涂黄油于;
- honeysweet
- honeysuckle
	- **lilac**淡紫色;**jasmine**茉莉;**lavender**淡紫色;**rosemary**迷迭香;**scent**气味;**ivy**常春藤联盟的;**shrub**灌木;**apricot**杏树;**citrus**柑橘属果树;**musk**麝香;**fragrant**芳香的;
- honeystone
- honeypot
- honeymouthed
- honeymoon
	- **wedding**结婚;**vacation**假期;**trip**旅行;**getaway**逃走;**marriage**结婚;**fiancé**未婚夫;**bride**新娘;**fiance**未婚夫;**wed**结婚;**fiancee**未婚妻;**romantic**浪漫的;
- honeylipped
- honeyed
- honeydew
	- _honeydew melon_ 蜜瓜；甜瓜
	- **melon**瓜;**nectar**花蜜;**peach**桃子;**watermelon**西瓜;**melons**瓜类植物;**mango**芒果;**peaches**桃子;**grapefruit**葡萄柚;**papaya**木瓜;**citrus**柑橘属果树;**pineapple**菠萝;
- honeycomb, honeycombed
	- **honeycomb**蜂窝,蜂巢;**encased**包装的;**hexagonal**六角形的;**hollow**空的;**impenetrable**不能穿过的;**limestone**石灰岩;**domed**半球形的;**subterranean**地表下面的;**porous**能渗透的;**ribbed**有棱纹的;
- That was meant to be a joke 'cause honeydew's a melon /那本来是个玩笑， 因为蜜露是一种甜瓜。
- honeybunch, honeybun
- honeybee
- honey-tongued
- honey-cooler
...
- hoopla
- hooper
	- n. 箍；铁环；呼呼声 vt. 加箍于；包围

horn
- underhorn
- tinhorn
	- _Gascon mouther tinhorn_ 吹牛的人
- staghorn 石松；雄鹿角；一种大珊瑚
- solid-horned
- shorthorn, althorn, alpenhorn
	- **cattle**牛;**cow**奶牛，母牛;**bovine**牛的;**calves**小牛;**herd**兽群，畜群;**bull**公牛;**calf**小牛;**sheep**羊，绵羊;**bred**繁殖;**stallion**种马;**goat**山羊;
	- _[shorthorn](dic://shorthorn)_  n. 短角牛（等于Durham）；新来的人
- saxhorn
	- **trombone**长号，伸缩喇叭;**clarinet**单簧管;**trumpet**喇叭;**oboe**双簧管;**alto**女低音;**tenor**男高音;**saxophone**萨克斯管;**trumpets**干脐菇;**soprano**女高音;**flute**长笛;**baritone**男中音
- pronghorn
	- **elk**麋鹿;**bison**北美野牛;**deer**鹿，梅花鹿;**coyote**一种产于北美大草原的小狼;**coyotes**土狼;**moose**驼鹿;**herds**畜群;**mammal**哺乳动物;**quail**感到恐惧;**cougar**美洲狮，美洲豹;**buffalo**水牛;
- longhorn
	- **bison**北美野牛;**cattle**牛;**cow**奶牛，母牛;**buffalo**水牛;**cowboy**牧童;**cowboys**牛仔
- inkhorn
	- n. 墨水瓶 
	- adj. 学究气的；卖弄学问的
- shoehorn
	...
	- shoehorn another 1,500 students /再容纳1500个学生
	- people were shoehorned into cramped corners /人们被硬挤进狭窄的角落里
- horny
	- **sexy**性感的;**kinky**奇形怪状的，怪癖的;**fucked**受骗的;**slut**懒妇;**busty**大胸脯的，胸部丰满的;**naughty**顽皮的，淘气的;**fuck**与性交;**pussy**猫咪;**hottie**热水瓶;**cock**公鸡;**fucking**用以增强表示愤怒,烦恼等的语气;
	-  [aroused](dic://aroused), [randy](dic://randy), [ruttish](dic://ruttish), [steamy](dic://steamy), [turned on(p)](dic://turned on(p))
	-  [corneous](dic://corneous), [hornlike](dic://hornlike)
- hornwort - n. 金鱼藻；角苔
	- **algae**藻类;**ferns**蕨类;**fern**蕨类植物;**moss**苔藓;**plants**植物;**seaweed**海藻，海草;**aquarium**水族馆;**grasses**稻科植物类;**corals**珊瑚;**freshwater**淡水的;**weeds**丧服;
	- [aquatic plant](dic://aquatic plant), [water plant](dic://water plant), [hydrophyte](dic://hydrophyte), [hydrophytic plant](dic://hydrophytic plant), [liverwort](dic://liverwort), [hepatic](dic://hepatic)
- hornwork
- horntail
- hornswoggle
	- v. （非正式）占便宜，哄骗
...
- hornpox _n._ 疣状天花
- hornpipe
	- **waltz**跳华尔兹舞;**jig**跳吉格舞;**fiddle**小提琴;**flute**长笛;**banjo**班卓琴;**dance**舞蹈;**dancing**舞蹈;**harp**竖琴;**clarinet**单簧管;**melody**旋律;**sailor**水手，海员;
- hornet
	- **wasp**黄蜂;**wasps**黄蜂;**ant**蚂蚁;**bee**蜜蜂，蜂;**nest**巢，窝;**insect**昆虫;**beetle**甲虫;**spider**蜘蛛;**nests**巢;**stung**刺;**venom**毒液;
	- _[Hornets](dic://Hornets)_ 黄蜂; 黄蜂队; 大黄蜂; 雀蜂;
- horner
- horned
	- **winged**有翼的;**bearded**有芒的;**lizard**蜥蜴;**goat**山羊;**toad**蟾蜍;**serpent**蛇;**owl**猫头鹰;**snake**蛇;**demon**魔鬼;**dragon**龙;**cow**奶牛，母牛;
	- [antlered](dic://antlered), [antler-like](dic://antler-like), [bicorn](dic://bicorn), [bicorned](dic://bicorned), [bicornate](dic://bicornate), [bicornuate](dic://bicornuate), [bicornuous](dic://bicornuous)
	- 
- hornbook
- hornblende
- hornbill
...
- hartshorn, buckhorn
- greenhorn
	- **newbie**网络新手;**inexperienced**经验不足的,不熟练的;**novice**初学者，新手;**newcomer**新来者;**seasoned**经验丰富的;**rookie**新手;**newbies**初学者;**wannabe**想达到目标的人;**clueless**无线索的;**aspiring**有抱负的;**novices**新手，初学者;
	- [novice](dic://novice), [beginner](dic://beginner), [tyro](dic://tyro), [tiro](dic://tiro), [initiate](dic://initiate)
- foghorn
	- **lighthouse**灯塔;**whistle**口哨;**siren**汽笛, 警报器;**whistling**吹笛;**sirens**汽笛，警报器;**whistles**汽笛;**muffled**听不清的;**horn**角;**chimes**编钟;**bells**铃;**beep**嘟嘟响;
- dishorn
- bullhorn
	- **microphone**扩音器, 麦克风;**shout**呼喊;**shouting**喊叫,呼叫;**yell**大叫，叫喊;**loudspeaker**扩音器, 扬声器, 喇叭;**shouts**叫喊，突发的大笑;**pulpit**讲道坛;**screaming**尖叫的;**chanting**念咒;**protester**抗议者;**loudly**大声地，响亮地;
- bighorn
...
- humdinger
	- [ideal](dic://ideal), [paragon](dic://paragon), [nonpareil](dic://nonpareil), [saint](dic://saint), [apotheosis](dic://apotheosis), [nonesuch](dic://nonesuch), [nonsuch](dic://nonsuch)
...
- humbug
	...
	- [deceive](dic://deceive), [lead on](dic://lead on), [delude](dic://delude), [cozen](dic://cozen)
	- **nonsense**谬论;**jolly**愉快的;**superstition**迷信;**farce**笑剧,闹剧,滑稽戏;**delusion**错觉;**hoo**呼！;**falsehood**谎言;**pernicious**很有害的;**ho**呵;**pompous**浮夸的;
	- humbuggery
- hummock
	- **dune**沙丘;**dunes**沙丘;**grassy**长满草的;**vegetation**植物;**grassland**草原，牧场;**tundra**苔原;**ridge**山脉;**meadow**草地;**bog**沼泽;**marsh**湿地;**mound**堆;
...
imp
- n. 顽童  vt. 加强, 给...装上翅膀
- **demon**魔鬼;**mage**博学者;**mischievous**淘气的, 顽皮的;**elf**小精灵;**wizard**男巫;**potion**一剂;
- [fairy](dic://fairy), [faery](dic://faery), [faerie](dic://faerie), [fay](dic://fay), [sprite](dic://sprite), [child](dic://child), [kid](dic://kid)
...
- impish
	...
	- _n._ [unplayful](dic://unplayful), [serious](dic://serious), [sober](dic://sober)
	- he had an impish look about him /他脸上有种顽皮的表情。
	- his face lit up with impish glee /他的脸上闪露着顽皮的喜色。
	- Then he smiled a surprisingly impish grin /然后，他咧着嘴，露出了一个顽皮得惊人的笑容。

inane
- [asinine](dic://asinine), [fatuous](dic://fatuous), [mindless](dic://mindless), [vacuous](dic://vacuous)
- **idiotic**白痴的;**nonsensical**无意义的;**drivel**淌口水,说傻话;**pointless**无意义的;**banal**陈腐的;**silly**愚蠢的;**ridiculous**可笑的, 荒谬的;**ludicrous**荒唐可笑的,滑稽可笑的;**absurd**荒谬的;**nonsense**谬论;**stupid**愚蠢的;
- _[barren empty frothy inane thin](dic://barren%20empty%20frothy%20inane%20thin)_ 空洞的
- an inane comment. /空洞的评论
- don't constantly badger people with inane questions /别老是用无聊的问题骚扰人。
- Such comments are inane because they don’t help us solve our problem /这种评论纯属空洞之词, 不能帮助我们解决问题。
- inanity
	- **idiocy**白痴;**absurdity**荒谬;**stupidity**愚笨;**silliness**愚蠢;**inane**愚蠢的;**drivel**淌口水,说傻话;**foolishness**愚蠢;**nonsense**谬论;**idiotic**白痴的;**hyperbole**夸张的语句;**ignorance**无知
	-  [senselessness](dic://senselessness), [mindlessness](dic://mindlessness), [vacuity](dic://vacuity), [pointlessness](dic://pointlessness)
...
- [anger](dic://anger), [choler](dic://choler)
- [wrath](dic://wrath), [anger](dic://anger), [ira](dic://ira)
- [emotion](dic://emotion), [mortal sin](dic://mortal sin), [deadly sin](dic://deadly sin)
- ireful
	- **indignation**愤怒, 愤慨, 气愤;**countenance**面容，表情;**ere**在…以前;**vengeful**复仇的，报复的;**stern**严厉的，苛刻的;**ire**忿怒;**enraged**暴怒的;**fury**狂怒;**pious**虔诚的;**agitated**激动的;**zealous**热心的，热情的，积极的;
- irate
	- **enraged**暴怒的;**angry**生气的;**disgruntled**不满的, 不高兴的;**annoyed**恼怒的;**furious**狂怒的;**outraged**义愤填膺的;**frustrated**挫败的;**agitated**激动的;**irritated**恼怒的;**distraught**心烦意乱;**upset**使心烦;
...
- irascible
	...
	- **feisty**活跃的;**grumpy**脾气暴躁的;**cranky**暴躁的;**eccentric**古怪的, 怪癖的;**irritable**易怒的, 急躁的;**brash**仓促的，性急的;**neurotic**神经过敏的;**opinionated**固执己见的,武断的;**lovable**可爱的，讨人喜欢的;**outspoken**直言的;**combative**好战的;
...
- irenic
	- irenic（和平的）：和平女神厄瑞涅  
	- 厄瑞涅（Eirene）是时序三女神之一的和平女神，对应于罗马神话中的帕克斯（Pax）。在赫西俄德的《神谱》中，作者将她称为“鲜花怒放的厄瑞涅（Blooming Eirene）”。  
	- 厄瑞涅是小财神普图鲁斯（Ploutos）的哺育者，也有的神话说是她是财神的母亲。对厄瑞涅的崇拜在雅典特别流行。在罗马的奥古斯都时代的马尔斯广场上专门为她建有祭坛，每年都会在这个地方为她举行盛大的祭祀活动。她的形象还经常出现在钱币上，表现为一位少女，左手执象征丰饶的丰裕之角，右手持有象征和平的橄榄枝、赫耳墨斯的神杖或禾穗，有时也怀抱着小财神普图鲁斯。人类发现的第14颗小行星——司宁星就是以厄瑞涅的名字命名的。  
	...
	- irenic：[aɪ'renɪk; -'riː-] adj.和平（主义）的，促使和解的，等于eirenic
		...
		- irenic without being namby-pamby; an irenic attitude toward former antagonists /毫不做作的和平主义；对前对手的和平的态度。
		- 
...
- irksome
	...
	- After five minutes of irksome and constrained conversation, they heard the sound of slippered feet approaching rapidly /经过五分钟阴郁的虚伪的谈话之后可以听见飞快走来的步履声。
...
- [crush](dic://crush), [press](dic://press)
- [jamming](dic://jamming), [electronic jamming](dic://electronic jamming)
- [throng](dic://throng), [mob](dic://mob), [pack](dic://pack), [pile](dic://pile)
- [crush](dic://crush)
- [block](dic://block)
- [jampack](dic://jampack), [ram](dic://ram), [chock up](dic://chock up), [cram](dic://cram), [wad](dic://wad)
- [obstruct](dic://obstruct), [obturate](dic://obturate), [impede](dic://impede), [occlude](dic://occlude), [block](dic://block), [close up](dic://close up)
- _n._ [conserve](dic://conserve), [preserve](dic://preserve), [conserves](dic://conserves), [preserves](dic://preserves), [difficulty](dic://difficulty), [crowd](dic://crowd), [electronic countermeasures](dic://electronic countermeasures)
- _v._ [crowd](dic://crowd), [crowd together](dic://crowd together), [push](dic://push), [force](dic://force), [bruise](dic://bruise), [contuse](dic://contuse), [interrupt](dic://interrupt)
- **marmalade**果子酱;**chutney**酸辣酱;**jelly**果冻;**scones**司康饼;**funk**恐惧;**strawberry**草莓;**pickles**腌渍物;**peaches**桃子;**apricot**杏树;**jar**广口瓶;**butter**涂黄油于;
- _traffic jam_ 交通阻塞，塞车
- _in a jam_ 事情搞得一团糟，陷入困境
- _jam in_ 用力把…塞进去
- _jam on_ v. 踩压
	- 紧急刹车：突然而有力地使用道路车辆的刹车。 
		- The driver had to jam on the brakes to avoid hitting the pedestrian. /为了避免撞到行人，司机不得不紧急刹车。
- _strawberry jam_ 草莓酱，草莓果酱
- _ice jam_ 冰塞，冰障
...
- jammy
	- adj. 粘上果酱的；（英）适意的
	- And once my onions and peppers are all jammy and soft, I chuck in the egg mixture /等洋葱和辣椒都变软了，我就把蛋液倒进去。
- jamming
- jammer
- jam-pack
- icrjam
...
jar
- n. 广口瓶；震动；刺耳声；罐 vi. 冲突；不一致；震惊；发刺耳声
- 来自阿拉伯语 jarrah,陶罐。  
- 拟声词。
-  [jarful](dic://jarful)
-  [jolt](dic://jolt), [jounce](dic://jounce)
- [clash](dic://clash), [collide](dic://collide)
-  [jolt](dic://jolt)
-  [shake up](dic://shake up), [bump around](dic://bump around)
- _n._ [vessel](dic://vessel), [containerful](dic://containerful), [blow](dic://blow), [bump](dic://bump)
- _v._ [conflict](dic://conflict), [move](dic://move), [displace](dic://displace), [affect](dic://affect), [impress](dic://impress), [strike](dic://strike), [put](dic://put)
- **container**容器;**jug**水壶;**bottle**瓶子;**lid**盖子;**vase**花瓶;**mason**泥瓦匠;**vial**小瓶;**spoonful**一匙;**containers**器皿;**canister**小罐;**flask**烧瓶;
- That jars with the surroundings. /那与环境不协调。
- a jar with floral designs on the exterior. /表面印有花卉图案的罐子。
- jarring
...
jerk
- 词源不详，可能来自拟声词，模仿猛拉，颠簸，嘎吱作响的声音。词义混蛋，二流子可能缩写自俚语 jerk off,手淫，手淫坯子。比较 wank,wanker.
-  [dork](dic://dork)
-  [jerking](dic://jerking), [jolt](dic://jolt), [saccade](dic://saccade)
-  [jerky](dic://jerky), [jerked meat](dic://jerked meat)
-  [tug](dic://tug)
-  [yank](dic://yank)
-  [yank](dic://yank)
-  [twitch](dic://twitch)
-  [buck](dic://buck), [hitch](dic://hitch)
- [flick](dic://flick)
- _n._ [misfit](dic://misfit), [motion](dic://motion), [movement](dic://movement), [move](dic://move), [motility](dic://motility), [rate](dic://rate), [meat](dic://meat)
- _v._ [pull](dic://pull), [draw](dic://draw), [force](dic://force), [move](dic://move), [move involuntarily](dic://move involuntarily), [move reflexively](dic://move reflexively), [push](dic://push)
	- [drag](dic://drag) 指沿斜坡而上或水平方向缓慢地拖或拉十分沉重的人或物。作借喻时可指把人硬拉扯过来。
	- [draw](dic://draw) 指将人或物朝出力者的方向拖，不涉及力的大小，含平稳意味，常作借喻用。
	- [pull](dic://pull) 最普通用词，包含本组其它各词的一些意思，可指朝各个方向拉，侧重一时或突然拉动的动作。
	- [haul](dic://haul) 指用力拖或拉，不涉及方向，多作航海用词。
	...
	- [tow](dic://tow) 特指用绳子或链条等拖或拉本身无动力或无法使用自身动力的东西。
	- [jerk](dic://jerk) 指快而突然地拉。
- **asshole**屁眼儿,肛门;**bitch**母狗，母狼;**douche**灌注法;**moron**痴愚者;**idiot**白痴;**slap**掌击;**dick**阴茎;**ass**驴子;**hypocrite**伪君子;**pissed**愤怒的;**guy**男人，家伙;
- _beef jerky_ n. 牛肉干
- _clean and jerk_ 挺举
- _knee jerk_ [医]膝反射
- The train jerked ahead /火车向前疾驶
- jerked the rope and broke it /猛地拉断绳子
- tearjerker
- jerky
	- meat (especially beef) cut in strips and dried in the sun
		- [jerked meat](dic://jerked meat), [jerk](dic://jerk)
	- not having a steady rhythm
		- [arrhythmic](dic://arrhythmic), [jerking](dic://jerking)
	- marked by abrupt transitions
		- [choppy](dic://choppy)
	- having or revealing stupidity
		- [anserine](dic://anserine), [dopy](dic://dopy), [dopey](dic://dopey), [foolish](dic://foolish), [goosey](dic://goosey), [goosy](dic://goosy), [gooselike](dic://gooselike)
	- _n._ [meat](dic://meat)
	- _adj._ [unsteady](dic://unsteady), [sudden](dic://sudden), [stupid](dic://stupid)
	- _n._ [steady](dic://steady), [gradual](dic://gradual), [smart](dic://smart)
	- **beef**牛肉;**meat**肉，肉类;**boneless**无骨的;**meats**肉类;**erratic**不稳定的;**sausage**香肠;**slow**慢的;**stuttering**口吃;**chewy**柔软而会黏着的;**hamburger**汉堡包;**disjointed**脱离开的,不连贯的;
	- _beef jerky_ n. 牛肉干
	- a hard and jerky breath /急促的呼吸
	- the coach drew to a jerky halt. /马车忽地停了下来。
	- jerky ideas about saving money /关于储蓄的愚蠢的想法
	- jerkiness
	- jerkily
- jerkwater

jibe
- 来自 gibe 拼写变体，可能来自中古法语 gaber,嘲笑，嘲讽，拟声词，词源同 gab,jape.  
- 词源不详，可能来自jib,转帆，引申词义一致，相符。
- an aggressive remark directed at a person like a missile and intended to have a telling effect
	- [shot](dic://shot), [shaft](dic://shaft), [slam](dic://slam), [dig](dic://dig), [barb](dic://barb), [gibe](dic://gibe)
- be compatible, similar or consistent; coincide in their characteristics
	- [match](dic://match), [fit](dic://fit), [correspond](dic://correspond), [check](dic://check), [gibe](dic://gibe), [tally](dic://tally), [agree](dic://agree)
- shift from one side of the ship to the other
	- [gybe](dic://gybe), [jib](dic://jib), [change course](dic://change course)
- _n._ [remark](dic://remark), [comment](dic://comment)
- _v._ [equal](dic://equal), [be](dic://be), [sail](dic://sail)
- **remark**评论;**dismissive**轻视的, 轻蔑的, 鄙视的;**disparaging**轻蔑的;**contradict**矛盾;**tongue-in-cheek**不认真的,不当真的,半开玩笑的;**jest**玩笑;**remarks**摘要;**jab**戳;**condescending**降低身份的,屈尊的;**slur**诽谤;**tack**大头钉;
- _jibe with_ 与…一致；符合…
- a jibe at his old rivals /对他老对手的讥讽。
- Your figures jibe with mine. /你的外貌和我相似

jiff
- _[jiff](dic://jiff)_  n. 瞬间，一刹那
- _[wait a jiff](dic://wait%20a%20jiff)_  稍等一下
- _[in a jiff](dic://in%20a%20jiff)_  马上
- jiffy
	...
	- I'll get it. I won't be a jiffy /我去拿，马上就好。

jitter
- _n._ [noise](dic://noise), [interference](dic://interference), [disturbance](dic://disturbance), [movement](dic://movement), [motion](dic://motion)
- **latency**潜伏;**distortion**变形;**amplitude**广阔;**oscillation**振动;**waveform**波形;**encoder**译码器;**noise**响声;**wobble**摇晃;**frequency**频繁;**bandwidth**带宽;**synchronization**同一时刻;
- I get the jitters before exams. /考试前我很紧张。
- jittery, jitteriness
...
- the juggernaut of public expenditure /公共财政支出的强大力量。
...
khan
- n. 可汗, 商队宿店
- 来自土耳其语 kan,王子，主人，缩写自 khaqan,统治者，词源同汉语可汗，成吉思汗。
- [caravansary](dic://caravansary), [caravanserai](dic://caravanserai), [caravan inn](dic://caravan inn)
- _n._ [ruler](dic://ruler), [swayer](dic://swayer), [hostel](dic://hostel), [hostelry](dic://hostelry), [inn](dic://inn), [lodge](dic://lodge), [auberge](dic://auberge)
- **sultan**苏丹;**Akbar**阿克巴;**Imran**伊姆兰;**Rashid**拉希德;**Iqbal**伊克巴尔;**Mohammad**穆罕默德;**Shahid**舍希德;**Turkic**突厥语;**Mustafa**穆斯塔法;**Ali**阿里;**Kamal**卡马尔;
- _genghis khan_ n. 成吉思汗
- _kublai khan_ 忽必烈（中国元朝皇帝）
...
-  a painful muscle spasm especially in the neck or back ('rick' and 'wrick' are British)
	- [crick](dic://crick), [rick](dic://rick), [wrick](dic://wrick)
- a sharp bend in a line produced when a line having a loop is pulled tight
	-  [twist](dic://twist), [twirl](dic://twirl)
- a person with unusual sexual tastes1. an eccentric idea
- a difficulty or flaw in a plan or operation
- curl tightly
	- [crimp](dic://crimp), [crape](dic://crape), [frizzle](dic://frizzle), [frizz](dic://frizz), [kink up](dic://kink up)
- form a curl, curve, or kink
	-  [curl](dic://curl), [curve](dic://curve)
...
- [curl](dic://curl), [wave](dic://wave), [change surface](dic://change surface)
- He had a kink about it. /他对这件事有一种奇怪的想法。
- though the system is making some headway, there are still some kinks to iron out. /虽然该系统正取得一定的进展，但仍有许多困难需要解决。
...
knock
- [knocking](dic://knocking)
- [roast](dic://roast)
- [bash](dic://bash), [bang](dic://bang), [smash](dic://smash), [belt](dic://belt)
- [belt](dic://belt), [rap](dic://rap), [whack](dic://whack), [whang](dic://whang)
- [strike hard](dic://strike hard)
- [bump](dic://bump)
- [tap](dic://tap), [rap](dic://rap), [pink](dic://pink)
- [pink](dic://pink), [ping](dic://ping)
- [criticize](dic://criticize), [criticise](dic://criticise), [pick apart](dic://pick apart)
- _n._ [sound](dic://sound), [criticism](dic://criticism), [critique](dic://critique), [blow](dic://blow), [bump](dic://bump), [misfortune](dic://misfortune), [bad luck](dic://bad luck)
- _v._ [strike](dic://strike), [rap](dic://rap), [knap](dic://knap), [hit](dic://hit), [impinge on](dic://impinge on), [run into](dic://run into), [collide with](dic://collide with)
	- [knock](dic://knock) 指用拳头或其它器械猛敲或猛打；也指用手轻敲某物。  
	- [tap](dic://tap) 多指慢慢地连续地轻击或轻拍。  
	- [rap](dic://rap) 指用手指或木棒等快速地轻敲或急拍。  
	- [pat](dic://pat) 指用手轻拍以示同情、赞同或爱抚。
- **blow**吹;**stomp**跺;**slam**砰地关上;**whack**重打;**kick**踢;**pull**拉;**throw**抛;**smash**打碎;**door**门;**shove**推, 猛推, 乱推;**slap**掌击;
- _knock on_ 撞击撞出；敲击（门、窗）
- _knock at_ 敲（门、窗等）
- _knock off_ 击倒；停工；中断
- _knock down_ 击倒；拆卸
- _knock at the door_ 敲门；把……撞倒；撞墙
- _knock out_ 敲空；击倒；打破；使筋疲力竭
- _knock it off_ 停止做；住口，别再讲下去了
- _knock on the door_ 敲门
- _knock over_ 打翻；撞倒
- _knock in_ （把钉子）钉入
- _knock on wood_ 敲木头，企求好运；吉人天相
- _knock up_ 敲门唤醒；[英口]筋疲力尽；往上敲
- _knock back_ （摇把）反击，（活塞）逆行，（曲轴）反转；反座；回击，击退；使...大吃一惊
- _knock against_ 撞击，与…冲突；偶然遇见
- _knock sensor_ 爆振传感器；进气流量传感器
- _knock into_ 撞上；与…相撞
- _knock off work_ 敲落工作；歇工
- no-knock
- knock-out
- knocker
- knockdown
- knockabout
	- _n._ [sloop](dic://sloop)
	- _adj._ [spirited](dic://spirited), [rugged](dic://rugged)
	- _n._ [spiritless](dic://spiritless), [delicate](dic://delicate)
	- **light-hearted**轻松的;**comedy**喜剧;**farce**笑剧,闹剧,滑稽戏;**humour**诙谐;**banter**戏谑;**melodrama**情节剧;**silliness**愚蠢;**comedic**喜剧的;**raucous**沙哑的;**boisterous**热闹的;**romp**嬉闹玩笑;
- knock-on
- knock-knee
- antiknock
...
- [mound](dic://mound), [hillock](dic://hillock), [hummock](dic://hummock), [hammock](dic://hammock)

knob
- **lever**杠杆;**shifter**移动装置;**dial**钟面;**crank**曲柄;**levers**杠杆;**actuator**执行机构;**joystick**操纵杆，控制杆;**screwdriver**螺丝起子;**selector**挑选者;**screw**旋，拧;**pedal**踩踏板;
- [projection](dic://projection), [handle](dic://handle), [grip](dic://grip), [handgrip](dic://handgrip), [hold](dic://hold), [convex shape](dic://convex shape), [convexity](dic://convexity)
...
- _[knead dough](dic://knead%20dough)_  揉面
- _[kneading action](dic://kneading%20action)_  揉搓作用
- _[to knead](dic://to%20knead)_  按摩
- **dough**生面团;**floured**磨碎的,粉质的,粉状的,撒上粉的;**flour**面粉;**loaves**大块烤过的食物;**bake**烤, 烘焙;**loaf**块;**whisk**拂;**mixer**搅拌器;**rub**擦;
- kneading dough /揉面
- knead and shape children /培养塑造儿童
- The masseur kneaded my back /那个按摩师给我推拿了背。

Kurultai
- 库尔勒台：源于蒙古和突厥等游牧民族的政治和军事会议，通常在重要事件发生时召开，如选举领导人、制定战争策略等。
...
- _lacquer painting_ 漆画
- _raw lacquer_ 生漆
- _lacquer film_ 喷漆薄膜
- _wood lacquer_ 木器漆
- The red lacquer work on the upper wall was badly chipped. /墙面上的红漆已经脱落了不少。
- He has planned to lacquer the old table. /他计划给旧桌子上一层漆
- Whoa, whoa! Get your feet down. This is fresh lacquer /喂！ 把脚放下来 这可是刚上的漆。
...
- lambaste, lambast
	...
	- [cane](dic://cane), [flog](dic://flog), [lambast](dic://lambast)
	- **criticize**评论, 批评;**denounce**谴责;**criticise**批评;**accuse**控告，指控;**condemn**判刑，定罪;**bashing**用废矸石充填采空区;**accusing**指责的;**mocking**嘲弄的;**loathe**讨厌，厌恶;**despise**轻视，鄙视;**ridicule**嘲笑;
	- they lambasted the report as a gross distortion of the truth. /他们激烈批评该报告是严重歪曲事实。
	-  The announcement was lambasted in France, where the government has dispensed a huge rescue package/这一声明在法国遭到抨击，法国政府已经推出了一项巨额救助计划。
...
- largish
	...
	- Just over forty percent of the respondents were in favour, but a largish minority were strongly against it, claiming that it is elitist and a waste of funds. /超过40%的人同意，但是稍大的少部分人强烈反对，他们认为这是高级建筑且浪费资金。
- largesse, largess
	- [largess](dic://largess)
	...
	- the distribution of largesse to the local population /对当地人的慷慨馈赠。
	- For decades the Sackler name would primarily be associated with that largesse./ 几十年来，萨克勒的名字基本与赠款绑定了。
	- America's fiscal largesse during the pandemic has fuelled not just economic growth but also a lively hip-hop niche. /美国在疫情期间的慷慨财政不仅推动了经济增长，也推动了活跃的嘻哈小众市场。
- largescale
- largeness
- largely
- largehearted
...
- leading edge
	...
	- The textile industry is the leading edge of the Industrial revolution. /纺织业走在了工业革命的前沿。
	- The numbers might sound small, but they are the leading edge of a dangerous trend /这些数字听起来可能很小，但它们是一个危险趋势的开端。
...
- _n._ [alliaceous plant](dic://alliaceous plant), [vegetable](dic://vegetable), [veggie](dic://veggie)
...
lick
- [salt lick](dic://salt lick)
- [lap](dic://lap)
- [punch](dic://punch), [clout](dic://clout), [poke](dic://poke), [biff](dic://biff)
- [cream](dic://cream), [bat](dic://bat), [clobber](dic://clobber), [drub](dic://drub), [thrash](dic://thrash)
- [lap](dic://lap)
- [solve](dic://solve), [work out](dic://work out), [figure out](dic://figure out), [puzzle out](dic://puzzle out), [work](dic://work)
- _n._ [sediment](dic://sediment), [deposit](dic://deposit), [touch](dic://touch), [touching](dic://touching), [blow](dic://blow)
- v._ [beat](dic://beat), [beat out](dic://beat out), [crush](dic://crush), [shell](dic://shell), [trounce](dic://trounce), [vanquish](dic://vanquish), [stroke](dic://stroke)
- **rub**擦;**pussy**猫咪;**suck**吸吮;**squirt**喷出;**spit**吐口水;**bite**咬;**nibble**细咬;**cum**和;**kiss**吻;**piss**小便;**drool**流口水;
...
- unlisted, listless, listing, listed
	...
	- _[unlisted securities](dic://unlisted%20securities)_  未上市证券
	- _[unlisted security](dic://unlisted%20security)_  未上市证券
- lister
- enlist (enroll)
	- [engage](dic://engage)
	- [draft](dic://draft), [muster in](dic://muster in)
	- _v._ [sign up](dic://sign up), [procure](dic://procure), [secure](dic://secure), [enroll](dic://enroll), [inscribe](dic://inscribe), [enter](dic://enter), [enrol](dic://enrol)
	- _n._ [discharge](dic://discharge), [muster out](dic://muster out)
	- **recruit**招聘;**persuade**说服，劝说;**help**帮助;**convince**使确信，使信服;**recruits**幼鱼;**mobilize**动员，调动;**seek**寻找;**army**陆军，军队;**procure**获得，取得;**join**参加;**solicit**恳求, 请求, 乞求;
	- _enlist in_ v. 应募，参军
	- _[enlisted man](dic://P%20enlisted%20man)_  现役军人
...
- _adj._ [graceful](dic://graceful)
- _n._ [awkward](dic://awkward)
- **slender**微薄的;**graceful**优美的;**muscular**肌肉发达的;**supple**柔软的;**nimble**敏捷的;**taut**拉紧的;**curvy**弯曲的;**sleek**圆滑的;**petite**娇小的，小个子的;**agile**敏捷的;**seductive**诱惑的;
- a lithe ballet dancer / 一个自然优雅的芭蕾舞演员
...
- n. 剪下的树枝 adj. 垂下的
- _lop off_ 砍掉
- a dark pig with lop-ears /一头耷拉着耳朵的黑猪。
- it lops an hour off journey times. /它把旅行时间减少了一小时。
- Also the neo-Assyrians loved to find would-be rebels and lop off their appendages. /此外，新亚述人喜欢寻找可能的叛乱分子然后砍掉他们的肢体。
- Until that moment arrives, half the long tail is lopped off /直到那一刻到来，一半的长尾巴被砍掉。
- It's a shame we're gonna have to lop their heads off. /我们将要去掉这些太令人惋惜了。
- lopsided
	...
	- _[lopsided development](dic://lopsided%20development)_ 畸形发展; 片面发展; 
	- _[lopsided tree](dic://lopsided%20tree)_ 偏冠树
	- a lopsided grin. /歪着嘴笑。
	- A grim smile twisted his lopsided mouth. /一丝阴森的笑容使他歪斜的嘴变得扭曲了。
- loppy
...
- loudly
- loudish
	- _[loudish](dic://loudish)_  adj. 声音稍高的
- loudhailer
- louderness
- aloud
...
- _[louts](dic://louts)_  n. 笨拙的人（lout的复数形式）; vt. 轻视；嘲弄（lout的三单形式）; 
- _[lager lout](dic://lager%20lout)_  醉后闹事的年轻人
- is both a lout and a bully; /又粗鄙又恃强凌弱的人；
- " It was a mistake, " Bill said. " Baseball is a game for louts." /“搞错了，”比尔说。“棒球是大老粗玩的。”
- loutish
	...
	- Not as " German" culture, with its loutish manners! /不像“德国” 文化那样粗俗！
- litter-lout
	- _n._ 在街道或公共场所乱丢垃圾的人
...
lubber (blubber)
- an awkward stupid person
	- [lout](dic://lout), [clod](dic://clod), [stumblebum](dic://stumblebum), [goon](dic://goon), [oaf](dic://oaf), [lummox](dic://lummox), [lump](dic://lump), [gawk](dic://gawk)
- an inexperienced sailor; a sailor on the first voyage
	- _synonymous：_ [landlubber](dic://landlubber), [landsman](dic://landsman)
- _n._ [clumsy person](dic://clumsy person), [novice](dic://novice), [beginner](dic://beginner), [tyro](dic://tyro), [tiro](dic://tiro), [initiate](dic://initiate)
- **sailor**水手，海员;**compass**指南针，罗盘;**ye**Yemen 也门;
- lubberly
- lubberland
- landlubber
	- _n._ [inhabitant](dic://inhabitant), [habitant](dic://habitant), [dweller](dic://dweller), [denizen](dic://denizen), [indweller](dic://indweller), [novice](dic://novice), [beginner](dic://beginner)
	- **sailor**水手，海员;**pirate**海盗;**sailing**航行，航海;**pirates**海盗，盗印者;**fisherman**渔夫, 渔民;**nautical**航海的，海上的;**sailboat**帆船;**seas**海域;**sea**海洋;**adventurer**探险家, 冒险家;**maritime**海的;

lucre
- 来自拉丁语 lucrum,财富，收益，常用于贬义指不义之财。可能来自 PIE*rei,撕，抢，词源同rob,rip.比较 loot.
- informal terms for money
	- [boodle](dic://boodle), [bread](dic://bread), [cabbage](dic://cabbage), [clams](dic://clams), [dinero](dic://dinero), [dough](dic://dough), [gelt](dic://gelt), [kale](dic://kale), [lettuce](dic://lettuce), [lolly](dic://lolly), [loot](dic://loot), [moolah](dic://moolah), [pelf](dic://pelf), [scratch](dic://scratch), [shekels](dic://shekels), [simoleons](dic://simoleons), [sugar](dic://sugar), [wampum](dic://wampum)
- the excess of revenues over outlays in a given period of time (including depreciation and other non-cash expenses)
	-  [net income](dic://net income), [net](dic://net), [net profit](dic://net profit), [profit](dic://profit), [profits](dic://profits), [earnings](dic://earnings)
- _n._ [money](dic://money), [income](dic://income)
- **riches**财富;**filthy**污秽的;**greed**贪婪，贪心;**profit**利润;**profits**收益，红利;**coffers**花格镶板;**greedy**贪婪的;**money**钱;**lust**性欲;**sordid**肮脏的;**cash**现款，现金;
- _filthy lucre_ n. 不义之财
- officials getting their hands grubby with filthy lucre /双手肮脏，大敛不义之财的官员们。
- lucrative
...
- [hunk](dic://hunk)
- [ball](dic://ball), [clod](dic://clod), [glob](dic://glob), [clump](dic://clump), [chunk](dic://chunk)
- [swelling](dic://swelling), [puffiness](dic://puffiness)
- [lout](dic://lout), [clod](dic://clod), [stumblebum](dic://stumblebum), [goon](dic://goon), [oaf](dic://oaf), [lubber](dic://lubber), [lummox](dic://lummox), [gawk](dic://gawk)
- [chunk](dic://chunk)
- [collocate](dic://collocate), [chunk](dic://chunk)
- _n._ [part](dic://part), [piece](dic://piece), [agglomeration](dic://agglomeration), [enlargement](dic://enlargement), [symptom](dic://symptom), [clumsy person](dic://clumsy person)
- _v._ [roll up](dic://roll up), [collect](dic://collect), [accumulate](dic://accumulate), [pile up](dic://pile up), [amass](dic://amass), [compile](dic://compile), [hoard](dic://hoard)
- **lumpy**粗笨的;**clump**丛;**chunk**大块;**sum**总数;**blob**一滴;**nodules**小瘤;**cyst**胞,包囊,膀胱;**chunks**大块，矮胖的人或物;**swollen**肿胀的，浮肿的;**cancerous**癌的;**pile**堆;
...
- _lump ore_ 块矿
- _in a lump_ 一次全部地
- _lump sum payment_ 整笔付款；一次总算，一次总付
- _lump sum price_ 混合价格；总括价格；整笔计价格
- lump sugar /块糖
- like it or lump it. /不喜欢也得忍受它
- There are some lumps in the sauce /酱汁中有一些块块。
- a tax-free lump sum. /一次性免税额。
...
- images of the macabre and the grotesque. /恐怖和怪诞的形象。
...
- madhouse
	- pejorative terms for an insane asylum
		- [Bedlam](dic://Bedlam), [booby hatch](dic://booby hatch), [crazy house](dic://crazy house), [cuckoo's nest](dic://cuckoo's nest), [funny farm](dic://funny farm), [funny house](dic://funny house), [loony bin](dic://loony bin), [nut house](dic://nut house), [nuthouse](dic://nuthouse), [sanatorium](dic://sanatorium), [snake pit](dic://snake pit)
	- _n._ [mental hospital](dic://mental hospital), [psychiatric hospital](dic://psychiatric hospital), [mental institution](dic://mental institution), [institution](dic://institution), [mental home](dic://mental home), [insane asylum](dic://insane asylum), [asylum](dic://asylum)
	- **madness**疯狂;**insane**精神病的;**insanity**疯狂;**lunatic**精神错乱的;**chaotic**混乱的，无秩序的;**chaos**混沌，混乱;**mayhem**大混乱, 大破坏;**craziness**发狂,热中,狂热;**crowded**拥挤的;**crazed**癫狂的;**mad**疯狂的;
	- Lunch comes right after Phys Ed, and the cafeteria was a complete madhouse that's we practiced our moves /体育课一下课就到了午饭时分，饭堂里乱成一团，活像疯人院一样，我们在那练习动作。
- madding
- madden
	- maddening
- madcap
	...
	- a surreal, madcap novel /一部超现实的怪诞有趣小说。
- mad-doctor
- mad-brained
- horn-mad
...
mangonel
- n. 投石机（古代打仗用的）；军用射石机
- [catapult](dic://catapult), [arbalest](dic://arbalest), [arbalist](dic://arbalist), [ballista](dic://ballista), [bricole](dic://bricole), [onager](dic://onager), [trebuchet](dic://trebuchet), [trebucket](dic://trebucket)
- _n._ [artillery](dic://artillery), [heavy weapon](dic://heavy weapon), [gun](dic://gun), [ordnance](dic://ordnance)
...
- mangle
	...
	- [mutilate](dic://mutilate), [murder](dic://murder)
	-  [mutilate](dic://mutilate), [cut up](dic://cut up)
...
- maul
	...
	-  来自古法语 mail,来自拉丁语 malleus,铁锤，词源同 mallet.引申词义重锤敲打，伤害，打伤，以及动物袭击，撕咬等。
	- n. （Maul）（美、德）毛尔（人名）
	- **axe**斧;**scrum**扭打，混乱;**claw**爪;**claws**爪子;**hammer**敲打;**melee**混战，格斗;**chop**砍;**hammers**锤子;**jaws**狭口;**chuck**丢弃，抛掷;**stomp**跺;
	- [sledge](dic://sledge), [sledgehammer](dic://sledgehammer)
	- [cleave](dic://cleave), [split](dic://split), [rive](dic://rive), [deface](dic://deface), [disfigure](dic://disfigure), [blemish](dic://blemish)
	- The hunter was mauled by a lion /这名猎人被一头狮子撕裂了皮肉。
	- The package was mauled by the careless messenger. /包裹被粗心的信使弄得很破旧 
	- The novel was mauled by the New York critics. /这本小说受到纽约评论家的抨击。
	- the team were mauled 4-0 by Manchester City / 该队被曼城队以4比0打得惨败。
	- Meanwhile, mom was gently mauling her babies /与此同时，熊妈妈正在轻轻地抚弄她的孩子。
	- She can't have people over because a chimp mauled a clown at her birthday party. /她不能找人来陪她，因为一头猩猩在她的生日派对上伤了一个小丑。
	- But unbelievably, he was actually able to kill the bear but was left badly mauled and unconscious /难以置信的是，他居然杀死了这头母熊，但自己也受伤严重且不省人事。
	- mauley
		- _[mauley](dic://mauley)_  n. 手；拳头; n. (Mauley)人名；(英)毛利;
- mawkish
	- adj. 令人作呕的，令人厌恶的；自作多情的；淡而无味的
	- 来自中古英语mauk , 蛆，蛆虫，缩写自mathek。字面意思即长蛆的，来自古代观念认为人发狂或异想天开是因为脑子里长虫了。因此，引申词义无病呻吟的，易伤感的。-k , 小词后缀，同-kin , -ish , 形容词后缀。
	- _adj._ [emotional](dic://emotional)
	- _n._ [unemotional](dic://unemotional)
	- [bathetic](dic://bathetic), [drippy](dic://drippy), [hokey](dic://hokey), [maudlin](dic://maudlin), [mushy](dic://mushy), [schmaltzy](dic://schmaltzy), [schmalzy](dic://schmalzy), [sentimental](dic://sentimental), [soppy](dic://soppy), [soupy](dic://soupy), [slushy](dic://slushy)
	- **sentimental**伤感的, 多愁善感的;**crass**粗鲁的;**melodrama**情节剧;**banal**陈腐的;**corny**谷类的;**melancholy**忧郁, 悲哀;**cheesy**干酪质的;**pretentious**自命不凡的;**cynical**愤世嫉俗的;**contrived**不自然的;**overdone**把…煮得过久;
	- _[mawkish verses](dic://mawkish%20verses)_ 无病呻吟而成的诗句
	- _[mawkish unsentimental](dic://mawkish%20unsentimental)_ 自作多情的
	- _[mawkish wine](dic://mawkish%20wine)_ 无味的酒
	- _[mawkish response](dic://mawkish%20response)_ 情感反应
	- the mawkish smell of warm beer /热啤酒的怪味。
- maim
	- 来自古法语 mahaignier,伤害，使受伤，使残疾，来自 PIE*mai,砍，切，词源同 mangle,mayhem.进一步来自 PIE*smi,砍，切，词源同 smith.
	- vt. 使残废, 使不能工作, 使伤残
	- _v._ [injure](dic://injure), [wound](dic://wound)
	- **injure**伤害，损害;**kill**杀死;**inflict**把…强加给, 使承受, 遭受;**cripple**使跛, 受伤致残;**humiliate**蒙羞;**destroy**毁坏;**harass**使烦恼;**kidnap**绑架;**threaten**威胁;**intimidate**恐吓, 威胁;**killing**杀害的;
	- a wrist maimed in an accident; /在事故中受伤的手腕；
	- they are prepared to kill or maim innocents in pursuit of a cause. /他们为了某种目的准备不惜杀戮、残害无辜者。
	- He was seriously maimed in the war. /他在战争中受了重伤。
	...
	- By returning, you may ensure that fewer souls are maimed, fewer families are torn apart. /话又说回来，你可能会使更多的灵魂免于受到伤害，使更多的家庭免于妻离子散。
	- Harry glanced over his shoulder to where the small, maimed creature trembled under the chair. .哈利扭头看了看那边椅子下面发抖的受伤的小生命。
	- maiming
	- mainmer
	- maimed
- meson
...
- Mesonic
	- **occult**神秘的;**lodges**小屋;**Satanic**邪恶的;**mason**泥瓦匠;**lodge**门房;**fraternal**兄弟的;**fraternity**兄弟般的感情;**symbolism** 象征主义, 象征手法;**brotherhood**手足情谊;**cabal**阴谋;**fascist**法西斯主义者;
	- [mason](dic://mason), [stonemason](dic://stonemason), [masonry](dic://masonry), [Freemason](dic://Freemason), [Mason](dic://Mason), [Freemasonry](dic://Freemasonry), [Masonry](dic://Masonry)
- mutilate
	- **kill**杀死;**injure**伤害，损害;**humiliate**蒙羞;**destroy**毁坏;**kidnap**绑架;**rip**撕;**torturing**充满痛苦的;**flatten**使……平坦;**stab**刺;**distort**扭曲;**deprive**使丧失，剥夺;
	...
	- _[mutilated note](dic://mutilated%20note)_  残缺不全的纸币
	- _[mutilated ladies](dic://mutilated%20ladies)_  残钞鉴别组
	- _[mutilated body](dic://mutilated%20body)_  肢解尸体
...
mantle
- 覆盖物；[地]地幔；斗篷；（煤气灯的）白炽罩  _v._ 覆盖；遮盖
- anything that covers
	- [blanket](dic://blanket)
- (zoology) a protective layer of epidermis in mollusks or brachiopods that secretes a substance forming the shell
	- [pallium](dic://pallium)
- shelf that projects from wall above fireplace
	- [mantel](dic://mantel), [mantelpiece](dic://mantelpiece), [mantlepiece](dic://mantlepiece), [chimneypiece](dic://chimneypiece)
- hanging cloth used as a blind (especially for a window)
	- [curtain](dic://curtain), [drape](dic://drape), [drapery](dic://drapery), [pall](dic://pall)
...
- [diffuse](dic://diffuse), [spread](dic://spread), [spread out](dic://spread out), [fan out](dic://fan out), [cover](dic://cover), [spread over](dic://spread over)
- [curtain](dic://curtain), [drape](dic://drape), [drapery](dic://drapery), [pall](dic://pall)
- The earth bore a thick green mantle of vegetation /大地覆盖着一层厚厚的绿色植物。
- a face that was mantled in joy. /脸快乐得通红
- Clouds mantled the moon /云把月亮遮住。
- I want men to take up this mantle /我希望男性负起这个责任。
- It forms a protective mantle against the cold, under which life can go on. /它形成御寒的保护罩，冰下的生命可以延续。
- The mantle of spinsterhood was definitely on her shoulders now. /英迪亚已完全是一副老处女的样子了。
- Like a king, like a god, full frontal, mantled in lustrous gold. /像个国王，或是个神灵，天庭饱满，浑身金光闪闪。
- mantlet
	- **turret**角楼;**armour**装甲;**armament**武器;**armor**装甲;**fuselage**机身;**cannon**大炮;**anti-aircraft**防空用的;**gunner**炮手，枪手;**hull**船体;**armoured**装甲的;**fortifications**防御工事;
- mantlerock
- mantled
	-  [cloaked](dic://cloaked), [clothed](dic://clothed), [draped](dic://draped), [wrapped](dic://wrapped)
- dismantle
	- **demolish**毁坏;**destroy**毁坏;**disassemble**解开,分解;**subvert**推翻;**undermine**在某物下挖洞或挖通道;**rebuild**重建;**assemble**集合，聚集;**abolish**废除，废止;**remove**移开;**eradicate**摧毁,完全根除;**topple**倾倒;
...
- marsh gas
- a miasma of stale alcohol hung around him like marsh gas /他周身是一股沼气似的走味酒气。
- saltmarsh
- marshy
...
- _[maudlin jovial](dic://maudlin%20jovial)_ 伤感的
- a maudlin ballad. /伤感的歌谣。
- maudlin expressions of sympathy; /伤感的慰问；


maverick
- _[mavericks](dic://mavericks)_  n. 未打烙印的无畜主动物；尤指离开母牛的小牛；独来独往的人；标新立异的人，不合常规的人; adj. 未打烙印的;
- - n. 没打烙印的动物；持不同意见的人 
- vt. 用不正当手段获取 
- vi. 迷途；背离 
- adj. 未打烙印的；行为不合常规的；特立独行的
- maverick（独行侠）：特立独行的牧场主马华力  
...
- Katalin Kariko, scientific maverick who paved way for mRNA vaccines /卡塔琳·卡里科，为 mRNA 疫苗铺平道路的科学特立独行者。
- Throughout all of it, Senator McCain defined himself as a maverick. /经历了这些之后，麦凯恩参议员把自己称为一名自行其是的人。
- " Top Gun: Maverick" (six nominations) has the outline and kit of a war film /《壮志凌云2: 独行侠》(获六项提名)具备战争电影的框架和全套要素。

mavin
- 1. someone who is dazzlingly skilled in any field
	- [ace](dic://ace), [adept](dic://adept), [champion](dic://champion), [sensation](dic://sensation), [maven](dic://maven), [virtuoso](dic://virtuoso), [genius](dic://genius), [hotshot](dic://hotshot), [star](dic://star), [superstar](dic://superstar), [whiz](dic://whiz), [whizz](dic://whizz), [wizard](dic://wizard), [wiz](dic://wiz)
- n. 专家；行家
...
- Mr. Meeseeks, open Jerry's stupid mayonnaise jar. /使命必达先生 打开Jerry那愚蠢的美乃滋罐子。
- Maggie! Can I have some mayonnaise, please. /玛吉！请给我一些蛋黄酱。
- One person's making a mayonnaise, one person's putting butter in a pan. /一个人在做蛋黄酱，一个人在平底锅里放黄油。
...
- _[melding](dic://melding)_  v. （使）融合，结合，合并（meld 的现在分词）
- a meld of many contributions. /众多来稿的拼合。
- a meld of diverse ethnic stocks /各种人种的混合
- a professional position that seemed to meld all his training /需要结合运用其所学之职位

mettle
- n. 气质, 耐力, 勇气
- 来自 metal 的拼写变体。后产生词义上的差别。
-  [heart](dic://heart), [nerve](dic://nerve), [spunk](dic://spunk)
- _n._ [courage](dic://courage), [courageousness](dic://courageousness), [bravery](dic://bravery), [braveness](dic://braveness)
- **fortitude**坚韧, 刚毅;**prowess**超凡技术;**prove**证明;**courage**勇气;**tenacity**固执;**test**检验;**toughness**有粘性;**proving**证明;**aptitude**天资;**stamina**耐力，持久力，毅力;**formidable**可怕的;
- _[on my mettle](dic://on%20my%20mettle)_ 奋发起来
- _[lofty quality mettle spirit](dic://lofty%20quality%20mettle%20spirit)_ 气概
- _[set someone on his mettle](dic://set%20someone%20on%20his%20mettle)_ 考验某人的毅力和勇气
- He’ll have to be on his mettle if he wants to win the next race /他如果想赢得下次比赛，就得全力以赴。
- mettlesome
- mettled
...
- _v._ [change](dic://change)
- **pests**害虫;**infestation**群袭,出没,横行;**mold**模具;**fungus**真菌，霉菌;**rust**锈;**odor**气味;**rot**腐烂;**fungal**真菌的;**discoloration**变色,污点;**mites**螨虫类;**odour**气味;
- _powdery mildew_ 白粉病；白粉菌
- _downy mildew_ 霜霉病；霜霉菌；大豆霜霉病；露菌病
...
- mocker
- mock-up
	- _n._ [model](dic://model), [simulation](dic://simulation)
	- _v._ [represent](dic://represent), [interpret](dic://interpret)
	- **prototype**原型, 雏形, 蓝本;**full-scale**与原物大小一样的,全面的,未经删节的;**replica**复制品，复制物;**mock**嘲弄;**design**设计;**dummy**傀儡;**prototyping**原型机制造;**sketches**草图;**cardboard**硬纸板;**sketch**素描;**layout**布局;
	- Someone even mocked up actual bacon into the shape of a mask. /有人甚至把培根做成了口罩的形状。
	-  We already had mocked up the future Adolf Hitler Square with a dome inspired by San Peters in Rome, but seventeen times bigger. /“我们已做好希特勒广场模型。广场圆顶的灵感来自罗马彼得大教堂，但比它大17倍。
- mock-serious
- bemock
...
monsoon
- 来自阿拉伯语 mawsim,一年的某时间，某季节，来自 ma-,指示前缀，wasama,标记，记号。
- _n._ [wind](dic://wind), [air current](dic://air current), [current of air](dic://current of air), [rainy season](dic://rainy season), [rain](dic://rain), [rainfall](dic://rainfall)
- **rains**雨季;**rainfall**降雨;**rainy**多雨的;**rain**雨;**cyclone**气旋;**typhoon**台风;**tropics**热带地区;**tropical**热带的;**floods**洪水;**humid**潮湿的;**thunderstorm**雷电交加的暴风雨;
- _monsoon climate_ 季风气候
- _monsoon season_ 季风季节
- _subtropical monsoon climate_ 亚热带季风性气候
- _monsoon rainfall_ 季风降雨；季风降水；季风雨量
- _monsoon rain_ 季风雨
...
mote
- _[mote](dic://mote)_  n. 尘埃；微粒；小错; n. (Mote)人名；(英、法、塞)莫特;
- the tiniest mote of dust. /最微小的尘埃。
- The moted sunlight comes into the room through the window /充满尘埃的阳光从窗外射进房来。
- mottle
	- mottling
	- mottled
- motley
...
- muddle
	...
	- muddle with one's work /敷衍了事
	- a muddle of books and mending/ 书和需补之物乱糟糟的一团。
	- the finances were in a muddle/ 财务管理杂乱无章。
	- muddler
...
- necklet
	- _n._ [decoration](dic://decoration), [ornament](dic://ornament), [ornamentation](dic://ornamentation)
	- **necklace**项链;**brooch**胸针，领针;**pendant**下垂物，垂饰;**earring**耳环，耳饰;**bracelet**手镯;**earrings**耳环;**jewellery**珠宝;**beaded**珠状的;**medallion**大奖章;**clasp**扣子;**neckline**领口，领圈;
- necklace
- necking
- necked
- neckcloth
	- _n._ [cravat](dic://cravat)
	- **handkerchief**手帕;**robe**长袍，礼服;**collar**衣领;**trousers**裤子，长裤;**cloak**斗蓬;**buttoned**扣紧的;**tuxedo**男士无尾半正式晚礼服;**beard**胡须;**collars**辊环;**garb**装束;**tunic**束腰外衣;
- neckbush
- neckband
- low-necked
- low-neck
...
- leatherneck
- gooseneck
	- _n._ [curve](dic://curve), [curved shape](dic://curved shape)
	- **swivel**转环;**tripod**三脚架;**axle**车轴;**adjustable**可调整的;**lamp**灯;**winch**卷扬机,绞车,辘轳;**detachable**可分开的，可拆开的;**trailer**预告片;**coupler**耦合器;**retractable**可收回的，可撤消的，可缩回的，可缩进的;**hitch**钩;
- ewe-necked
- crookneck
- bullnecked
- breakneck
	- _adj._ [dangerous](dic://dangerous), [unsafe](dic://unsafe)
	- _n._ [safe](dic://safe)
	- **frenetic**狂热的;**dizzying**使人眩晕的，使人头昏眼花的;**pace**步速;**frenzied**狂乱的;**speed**加速，迅速前行;**relentless**残酷的, 不留情的, 无怜悯心的;**frantic**狂乱的，疯狂的;**sped**加速;**accelerating**加速的;**slow**慢的;**rapid**迅速的，急促的;
	- _[breakneck dangersome](dic://breakneck%20dangersome)_ 非常危险的
	- _[breakneck economic development](dic://breakneck%20economic%20development)_ 惊险的经济发展; 惊险的经济成长; 
	- _[breakneck construction boom](dic://breakneck%20construction%20boom)_ 惊人的建设激增
	- 
- bottleneck
...
- _n._ [retreat](dic://retreat), [area](dic://area)
- **bookcase**书柜，书架;**bookshelves**书架;**bookshelf**书架;**corner**角落，拐角处;**kindle**点燃;**playroom**娱乐室;**cozy**舒适的，惬意的;**kitchen**炊具;**room**房间;**entryway**入口通道;**nightstand**<美>床头几;
- [corner](dic://corner)
- _[breakfast nook](dic://breakfast%20nook)_  早餐座
- _[every nook and cranny](dic://every%20nook%20and%20cranny)_  每个角落
- inglenook
...
- well-off
- offset
	- [beginning](dic://beginning), [commencement](dic://commencement), [first](dic://first), [outset](dic://outset), [get-go](dic://get-go), [start](dic://start), [kickoff](dic://kickoff), [starting time](dic://starting time), [showtime](dic://showtime)
	- [counterbalance](dic://counterbalance)
	- [stolon](dic://stolon), [runner](dic://runner)
	- [outgrowth](dic://outgrowth), [branch](dic://branch), [offshoot](dic://offshoot)
	- [offset printing](dic://offset printing)
	- [set-back](dic://set-back), [setoff](dic://setoff)
	- [countervail](dic://countervail)
	- [cancel](dic://cancel), [set off](dic://set off)
	- _n._ [point](dic://point), [point in time](dic://point in time), [compensation](dic://compensation), [plant organ](dic://plant organ), [consequence](dic://consequence), [effect](dic://effect), [outcome](dic://outcome)
	- _v._ [balance](dic://balance), [equilibrate](dic://equilibrate), [equilibrize](dic://equilibrize), [equilibrise](dic://equilibrise), [transfer](dic://transfer), [make](dic://make), [create](dic://create)
	- **compensate**补偿;**counteract**对抗;**decrease**减少，减小;**reduce**减少;**mitigate**使缓和，使减轻;**corresponding**相当的, 对应的;**increase**增加，增长;**attributable**的;**lessen**使…变小;**reduction**减少;**minimize**使减到最少;
- offish
	- _adj._ 不亲热的; 疏远的
	- [standoffish](dic://standoffish)
	- _adj._ [unapproachable](dic://unapproachable)
	- _n._ [approachable](dic://approachable)
	- **aloof**冷淡的;**shy**害羞的;**pushy**有进取心的;**timid**羞怯的;**rude**粗鲁的;**unfriendly**不友好的;**stand**位于;**cocky**自大的;
- etc..
...
on
- onset
	-  [oncoming](dic://oncoming)
	- [attack](dic://attack), [onslaught](dic://onslaught), [onrush](dic://onrush)
	- _n._ [start](dic://start), [operation](dic://operation), [military operation](dic://military operation)
	- **symptoms**病徵;**emergence**出现;**prolonged**持续很久的,长时间的;**outbreak**发作;**beginning**开始;**impending**即将发生的;**acute**严重的;**initiation**开始,创始;**severity**严格;**duration**持续;**cessation**停止,休止,中断;
- etc..
...
- one-pair
- one-off
	- [happening](dic://happening), [occurrence](dic://occurrence), [occurrent](dic://occurrent), [natural event](dic://natural event)
...
- _[indestructible ordeal](dic://indestructible%20ordeal)_ 不可毁灭的痛苦经历
- _[traumatic ordeal](dic://traumatic%20ordeal)_ 让人精神受创的经历
...
orgy
- orgy（狂欢）：古代罗马人崇拜酒神的秘密仪式  
- orgy - 在希腊神话中，酒神和生育之神Dionysus（狄俄尼索斯）是重要神祇之一，罗马神话中称Bacchus（巴克斯），为他举行祭祀的节日称bacchanalia，即“酒神节”。这一节日起初是秘密进行，只有妇女参加，后来逐渐允许男子参加之后，就变成一种以歌舞、纵酒、纵欲等为特点的秘密祭祀仪式，希腊语叫做órgia，拉丁语作orgia。16世纪时英语通过法语吸收了该词，变成orgy，用以指“纵酒宴乐”。公元前186年，罗马元老院曾发布命令在全意大利取缔bacchanalia这一节日。由于bacchanalia常与酗酒、狂欢和纵欲等无节制的行为联系在一起，所以其派生词bacchanalian便被赋予“狂欢作乐的”之义，仅作书面语用。
- 英语单词orgy表示“狂欢、放荡”，尤其是“性狂欢、群体淫乱”。它来源于古希腊人、罗马人对酒神的一种崇拜仪式。该词来源于希腊语orgia，意为“秘密仪式”，原本指的是任何一种崇拜神灵的仪式，后来专指崇拜酒神的仪式，其核心内容包括狂欢放荡的舞蹈、歌唱和豪饮，以及在亢奋中胡乱砍杀献祭的牲畜。由于酒神崇拜仪式的这种狂欢放荡特点，orgy一词逐渐发展出贬义含义，用来表示那种集体狂欢或淫乱活动。  
	- orgy： ['ɔːdʒɪ] n.狂欢，放荡  
...
- _[pampered](dic://pampered)_  adj. 饮食过量的；饮食奢侈的; v. 饮食过多；纵容（pamper的过去分词形式）; 
...
- _pare off_ 修掉
- pare expenses. /缩减开支
- Pare the rind from the lemons. /把柠檬皮剥掉。
...
2. vt. 修补；掩饰；解决
3. vi. 打补丁
- 来自古法语 pieche,来自 piece 方言变体，引申词义小块，斑点，补丁等。插入字母 t,比较bake,batch.
- [spot](dic://spot), [speckle](dic://speckle), [dapple](dic://dapple), [fleck](dic://fleck), [maculation](dic://maculation)
-  [plot](dic://plot), [plot of ground](dic://plot of ground)
- [while](dic://while), [piece](dic://piece), [spell](dic://spell)
- [temporary hookup](dic://temporary hookup)
- [mend](dic://mend), [darn](dic://darn)
- [eyepatch](dic://eyepatch)
- [bandage](dic://bandage)
- [piece](dic://piece)
-  [patch up](dic://patch up)
- [piece](dic://piece)
- _n._ [marking](dic://marking), [tract](dic://tract), [piece of land](dic://piece of land), [piece of ground](dic://piece of ground), [parcel of land](dic://parcel of land), [parcel](dic://parcel), [piece of cloth](dic://piece of cloth)
- _v._ [join](dic://join), [conjoin](dic://conjoin), [supply](dic://supply), [provide](dic://provide), [render](dic://render), [furnish](dic://furnish), [repair](dic://repair)
	- [mend](dic://mend) 通常指较简单的修复过程，一般不需要专门技术或特殊工具。  
	- [repair](dic://repair) 可与mend换用，但一般指需要较高的职业技能和使用较复杂的工具进行修理。 
	- [patch](dic://patch) 通常指用类似材料修补破洞、裂缝或磨损的地方。  
	- [fix](dic://fix) 多用于美语，仅用于指带有安装固定性质的修理。
- **bug**臭虫，小虫;**bandage**绷带;**update**更新;**kernel**核心，要点;**firmware**固件;**fix**安装;**bugs**发疯的，疯狂的;
- _patch up_ 修补；平息；拼凑
- _in patches_ 在有些部分；在有些时候
- _patch test_ n. [医]斑片试验；皮肤过敏试验
- _not a patch on_ 与…不能比，比不上；远不如…，远不及，比…差得远
	- My new phone isn't a patch on the old one /我的新手机比旧的差太多了。
	- My holiday at home wasn't a patch on a trip abroad. /我在国内出游比不上出国旅行。
	- I know some people disagree, but for me the Olympics isn't a patch on the World Cup /我知道有些人不同意，但对我来说，奥运会比不上世界杯。
	- There were others, of course, but **not** **a** **patch** **on** my Robin /当然， 那时还有其他人，但他们连罗宾的一丝一毫都比不上！
- a superciliary patch of color /眼上部的一块色斑
- a rooty patch of soil. /土壤中多根的一小块地
- a patch of waste ground /一块闲置的空地。
- a patch was used to mend the garment. /用补丁块缝补这衣服。
- It's not proper to patch the roof with nailsick boards /用多次钉过钉而不结实的木板修补屋顶是不适当的。
- It's just a rough patch, that’s all. /弥补一下，道个歉, 就这么简单。
- Instead relations have been patched up. /如今巴美关系反而有所缓解。
- We have got wet patches on the wall. /墙上有湿斑。
- They are very isolated in these small forest patches. /它们在这片小森林里非常孤立。
-  Who, uh, who did this to your pumpkin patch? /谁把你的南瓜摆设搞成那样了？
-  /It watched one patch of sky for years and found thousands of planets多年来，它观测着一片天空，发现了数千颗行星。
- We can **patch** up those holes /我们能补上那些漏洞。
- phonepatch
- patchy
- patchwork
	- _n._ [theory](dic://theory), [quilt](dic://quilt), [comforter](dic://comforter), [puff](dic://puff), [sewing](dic://sewing), [stitchery](dic://stitchery)
	- **quilt**棉被;**quilted**中间絮有软物的;**fabric**织物;**applique**贴花;**quilts**被褥;**tapestry**挂毯;**quilting**被上缝花纹的缝法;**scrappy**爱打架的;**fabrics**纤维织物;**stitching**用U字钉钉箱,缝纫;**embroidery**刺绣品;
	- _patchwork quilt_ 拼布床单；用小块布缝缀的被罩
- patchword
- patchplug
- patching
- patchery
...
- [annoy](dic://annoy), [rag](dic://rag), [get to](dic://get to), [bother](dic://bother), [get at](dic://get at), [irritate](dic://irritate), [rile](dic://rile)
- _[peeves](dic://peeves)_  v. 使怨恨；使气恼（peeve的三单形式）; n. 气恼；讨厌的对象（peeve的复数）; 
- _[pet peeve](dic://pet%20peeve)_  不能忍受的事；经常抱怨的问题
...
- peevish
	...
	- _[Peevish Libratian](dic://Peevish%20Libratian)_ 易怒的图书管理员
	- _[peevish good-natured](dic://peevish%20good-natured)_ 好脾气的
	- a peevish, whining voice. /一个抱怨、哀诉的声音。
	- If he were less peevish and morose, all would be well. /如果他不那么暴躁和忧郁， 一切都会好起来的。
- peeved
...
- a pert hat. /时髦的帽子
- no need to be pert, miss. /不必无礼，小姐。
- It was a pert, trim, smart little hat /这是一顶活泼、整洁、漂亮的小帽子。
- pertness
...
-  [pin](dic://pin)
-  [swivel](dic://swivel)
- _n._ [marcher](dic://marcher), [parader](dic://parader), [axis](dic://axis), [axis of rotation](dic://axis of rotation), [rotation](dic://rotation), [rotary motion](dic://rotary motion)
- _v._ [turn](dic://turn)
- **hinge**铰链;**axis**轴;**lever**杠杆;**swivel**转环;**rotate**旋转;**tilt**倾斜;**levers**杠杆;**rotating**旋转的;**linkage**连接;**swing**摇摆;**peg**钉;
- the pivot of community life was the chapel. /社区生活的中心是教堂。
...
- pivotal
	- [polar](dic://polar)
	- _adj._ [crucial](dic://crucial), [important](dic://important)
	- **crucial**决定性的;**decisive**决定性的;**momentous**重大的, 严重的;**vital**生死攸关的;**role**角色;**important**重要的, 重大的;**key**钥匙;**defining**最典型的;**vitally**紧要地;**juncture**连接;**significant**重要的;
...
- [dive](dic://dive), [plunge](dic://plunge)
- [pluck](dic://pluck), [pick](dic://pick)
- [plop](dic://plop)
- _n._ [sound](dic://sound), [hit](dic://hit), [hitting](dic://hitting), [striking](dic://striking)
- _v._ [sound](dic://sound), [go](dic://go), [set down](dic://set down), [put down](dic://put down), [place down](dic://place down), [descend](dic://descend), [fall](dic://fall)
- **sit**坐;**pennies**便士;**hard-earned**辛苦得到的;**shove**推, 猛推, 乱推;**pay**支付，付;**buy**购买;**toss**投掷;**grab**攫取;**scrape**用工具刮;**throw**抛;**hefty**重的;
...
- _[plush toy](dic://plush%20toy)_  毛绒玩具
- _[plush trousers](dic://plush%20trousers)_  丝绒裤
- _[plush loom](dic://plush%20loom)_  长毛绒织机
- _[plush carpet](dic://plush%20carpet)_  丝绒地毯
- _[plush fabric](dic://plush%20fabric)_  [纺] 长毛绒织物
- a plush Mayfair flat. 一套梅费尔区的豪华公寓。
- And there is a very plush foyer 门厅也很豪华。
- My fist in your plush, cuddly, super-soft face 送拳头在你毛茸茸，惹人爱，超级软的脸上！
- Big and furry. Soft and squishy. Kind of plush and cuddly.肥硕，毛茸茸。软软的，憨憨的，有些长毛的惹人爱。
- plushy
- plushly
...
- [sack](dic://sack), [paper bag](dic://paper bag), [carrier bag](dic://carrier bag)
- [jab](dic://jab), [jabbing](dic://jabbing), [poking](dic://poking), [thrust](dic://thrust), [thrusting](dic://thrusting)
- [punch](dic://punch), [clout](dic://clout), [lick](dic://lick), [biff](dic://biff)
- [jab](dic://jab), [prod](dic://prod), [stab](dic://stab), [dig](dic://dig)
- [intrude](dic://intrude), [horn in](dic://horn in), [pry](dic://pry), [nose](dic://nose)
- [thump](dic://thump), [pound](dic://pound)
- _n._ [pokeweed](dic://pokeweed), [idler](dic://idler), [loafer](dic://loafer), [do-nothing](dic://do-nothing), [layabout](dic://layabout), [bum](dic://bum), [bag](dic://bag)
- _v._ [thrust](dic://thrust), [search](dic://search), [look](dic://look), [agitate](dic://agitate), [vex](dic://vex), [disturb](dic://disturb), [commove](dic://commove)
- **stab**刺;**dig**挖，掘;**tickle**使发痒;**jab**戳;**skewer**烤肉叉子;**smack**掌击声;**prick**刺，戳;**shove**推, 猛推, 乱推;**stick**手杖;**nudge**用肘轻推;**laugh**笑;
- _poke fun at_ 取笑，嘲弄
- _poke into_ 探听；干涉
- poke fun at: 嘲弄；侮辱；取笑；嘲笑
- poke welding: 手压点焊；手点焊；钳点焊；手动焊钳点焊
- eye poke: 戳眼睛；戳秋水
- Poke Fish: 手指跳跳鱼
- poke and pry: 管闲事；好管闲事
- poke line: 破坏线
- poke about: 寻求；摸索；探听
- she poked her tongue out 她伸出舌头。
- It’s a programme that likes to poke fun at the royal family. 这个节目总爱拿王室开玩笑。
...
- poky
	...
	- _n._ [correctional institution](dic://correctional institution)
	- _adj._ [slow](dic://slow), [provincial](dic://provincial)
	- _n._ [fast](dic://fast), [cosmopolitan](dic://cosmopolitan)
	- **cramped**难懂的;**tiny**微小的;**wobbly**摆动的;**shabby**破旧的;**teeny**极小的;**posh**漂亮的;**lumpy**粗笨的;**clunky**沉重的;**wonky**动摇的,虚弱的,摇晃的,靠不住的,出错的;**dull**钝的;**homely**平凡的;
	- **lumpy**粗笨的;**shabby**破旧的;**wobbly**摆动的;**pointy**尖的;**clunky**沉重的;**wonky**动摇的,虚弱的,摇晃的,靠不住的,出错的;**teeny**极小的;**dodgy**狡猾的，逃避的;**tiny**微小的;**wee**极小的;**cramped**难懂的;
	- _[poky mutant](dic://poky%20mutant)_ 迟钝突变型
	- _[poky room](dic://poky%20room)_ 在生活的挤压下都出现了
	- _[poky muttion](dic://poky%20muttion)_ 生长缓慢突变株在脉孢菌中生长缓慢的线粒体突变
	- _[a poky little room](dic://a%20poky%20little%20room)_ 狭小的房间
	- a lazy, poky person. 一个懒惰、动作迟缓的人
	- his speech was poky, like he was a little simple 他说话慢吞吞的，仿佛是有点迟钝似的。
	- Both were wary of the kind of residential development — often poky student flats — that they said dominates the city centre. 两人都对住宅开发持谨慎态度——他们说，这种住宅开发往往是廉价的学生公寓，在城市中心占主导地位。
- pokeweed
- poker
	- fire iron consisting of a metal rod with a handle; used to stir a fire
		-  [stove poker](dic://stove poker), [fire hook](dic://fire hook), [salamander](dic://salamander)
	- any of various card games in which players bet that they hold the highest-ranking hand
	- _poker face_ 一本正经的面容；面无表情的人
	- _poker room_ 扑克室（网络扑克游戏网站）
	- _n._ [fire iron](dic://fire iron), [card game](dic://card game), [cards](dic://cards)
	- **blackjack**以棒打,胁迫;**casino**娱乐场;**gambling**赌博;**casinos**乡间住宅;**gamblers**赌徒;**bingo**宾戈游戏;**gambler**赌徒;**roulette**轮盘赌;**betting**打赌;**wagering**赌注;**gaming**赌胜负;
	- playing poker with deuces wild /玩扑克牌游戏，二点纸牌为百搭的
	- _poker face_ 一本正经的面容；面无表情的人
	- _poker room_ 扑克室（网络扑克游戏网站）
	- gaspoker
- pokeberry
- poke-out
- pokesy
	- _adj._ 行动缓慢的；安闲的，从容不迫的

pomp
- heap or pretentious or vain display
	- _synonymous：_ [gaudery](dic://gaudery)
- ceremonial elegance and splendor
	- _synonymous：_ [eclat](dic://eclat)
- _n._ [display](dic://display), [show](dic://show), [elegance](dic://elegance)
- **trappings**服饰;**fanfare**吹牛，炫耀;**grandeur**庄严;**splendor**光彩;**regal**帝王的;**majesty**威严;**extravagant**奢侈的, 铺张的;**lavish**浪费的;**solemn**庄严的，严肃的;**spectacle**壮观的场面或景象;**ceremonial**礼仪的;
- the pomp and circumstance of a coronation /加冕仪式的盛况和排场
- all the pomp and heraldry provided a splendid pageant /所有这些富丽堂皇的仪式构成了一个壮观的庆典。
- The official was accompanied by all the pomp of his high position /那位官员所到之处威风十足。
- She forewent the pomp of the alluring pompadour.She wore no chains, bracelets or lockets. /她不愿采用华丽诱人的庞巴杜式发型，不戴项链、手镯或鸡心。
- pompous
	- [grandiloquent](dic://grandiloquent), [overblown](dic://overblown), [pontifical](dic://pontifical), [portentous](dic://portentous)
	- [ceremonious](dic://ceremonious)
	- _adj._ [pretentious](dic://pretentious), [pomp](dic://pomp), [eclat](dic://eclat)
	- _n._ [unpretentious](dic://unpretentious)
	- **arrogant**自大的，傲慢的;**pretentious**自命不凡的;**condescending**降低身份的,屈尊的;**obnoxious**可憎的;**smug**自满的, 沾沾自喜的;**cocky**自大的;**elitist**优秀人材;**crass**粗鲁的;**brash**仓促的，性急的;**grandiose**宏伟的;**whiny**烦躁的;
- pomposity
	...
	- _[idiom mocking scholastic pomposity](dic://idiom%20mocking%20scholastic%20pomposity)_ 博士买驴
	- The show that is the sworn enemy of lying, pomposity, smugness, and groupthink. /这部剧是说谎、浮夸、自以为是和群体思维的死敌。

pond
- _n._ [lake](dic://lake)
- **lake**湖;**creek**小溪;**river**河，江;**marsh**湿地;**wetland**湿地;**lagoon**泻湖;**brook**小河;**lakes**色淀;**meadow**草地;**carp**吹毛求疵;**waterfall**瀑布;
- _lotus pond_ 荷花池，荷塘；莲花池
- _oxidation pond_ 氧化塘；氧化池
- _fish pond_ 鱼塘，鱼池
...
- _n._ [writing style](dic://writing style), [literary genre](dic://literary genre), [genre](dic://genre), [expressive style](dic://expressive style), [style](dic://style)
	...
	- [article](dic://article) 多指在报刊、杂志上发表的非文艺性的文章，包括新闻报导、学术论文等。  
	- [essay](dic://essay) 指任何一种非小说性的，篇幅不长、结构简练的文章，如论说文、报道、评论、讽刺性杂文等。  
	- [paper](dic://paper) 正式用词，多指在学术刊物上发表或在学术会议上宣读的专题论文，也指高等学校的学期论文，或学校里的作文练习。  
	- [prose](dic://prose) 专指散文。 
	- [thesis](dic://thesis) 既可指毕业论文、学位论文，又可指一般的为阐述学术观点而写的论文。  
	- [theme](dic://theme) 一般指大学或高中生作为作业所写的篇幅有限、较完整论述某个观点的文章。也可指作品或谈话的主要论题。  
	- [dissertation](dic://dissertation) 书面语用词，指独立研究后所写的较为详细的专题文章；也可指学位论文
- **poetry**诗;**poetic**诗的，诗歌的;**poems**诗歌，诗集;**lyrical**抒情诗调的;**poem**诗;**writing**笔迹;**narrative**记叙文;**literary**文学的;**readable**易读的;**fiction**小说;**nonfiction**非小说类文学作品;
- a breezy prose style /风趣的散文文风
- he florid prose of the nineteenth century /19世纪词藻华丽的散文。
- prosy
	- [pedestrian](dic://pedestrian), [prosaic](dic://prosaic), [earthbound](dic://earthbound)
	- _adj._ [uninteresting](dic://uninteresting)
	- _n._ [interesting](dic://interesting)
	- **prose**散文;**poetic**诗的，诗歌的;**monotonous**无变化的, 单调乏味的;**flowery**多花的;**pompous**浮夸的;**banal**陈腐的;**tiresome**烦人的，无聊的;**pretentious**自命不凡的;**dull**钝的;**tedious**冗长乏味的;**dreary**沉闷的，枯燥的;
	- We can now be married in a prosy public way /我们现在可以以一种散漫的公开方式结婚了
	- You open a book and try to read, but you find Shakespeare trite and commonplace, Dickens is dull and prosy, Thackeray a bore, and Carlyle too sentimental. /你打开一本书试图阅读， 但你发现莎士比亚陈腐而平庸， 狄更斯乏味而乏味， 萨克雷令人厌烦， 卡莱尔过于多愁善感。
- prosify
- proser
	- n. 散文家；唠叨的人；写平凡琐事的人
- prosaist
...
- prosaic
	...
	- _adj._ [unrhetorical](dic://unrhetorical), [uninteresting](dic://uninteresting), [unexciting](dic://unexciting)
	- _n._ [rhetorical](dic://rhetorical), [interesting](dic://interesting), [exciting](dic://exciting)
	- **mundane**世俗的，平凡的;**banal**陈腐的;**fanciful**想像的;**poetic**诗的，诗歌的;**fantastical**空想的,捕风捉影的;**innocuous**无害的;**commonplace**平凡的;**esoteric**秘传的;**dull**钝的;**incomprehensible**费解的;**uninteresting**无趣的,令人厌倦的;
...
-  [prise](dic://prise), [prize](dic://prize), [lever](dic://lever), [jimmy](dic://jimmy)
-  [intrude](dic://intrude), [horn in](dic://horn in), [nose](dic://nose), [poke](dic://poke)
-  [prise](dic://prise)
- _n._ [lever](dic://lever)
- _v._ [open](dic://open), [open up](dic://open up), [ask](dic://ask), [inquire](dic://inquire), [enquire](dic://enquire), [search](dic://search), [look](dic://look)
- **pull**拉;**screwdriver**螺丝起子;**loosen**放松;**grab**攫取;**pliers**钳子;**scrape**用工具刮;**shove**推, 猛推, 乱推;**squeeze**挤;**hold**持有;**rip**撕;**dig**挖，掘;
- _pry into_ 窥探；打听
- _pry bar_ 撬杆；杠杆
...
- prying
	...
	- _n._ [curiousness](dic://curiousness), [inquisitiveness](dic://inquisitiveness)
...
- _v._ [hit](dic://hit)
- **stomp**跺;**mercilessly**无情地;**beat**打;**taunt**嘲弄;**pounded**捣碎的;**slamming**砰击;**pounding**重击;**slap**掌击;**intimidate**恐吓, 威胁;**humiliate**蒙羞;**fists**拳套;
- pummeled the bully soundly /把恃强凌弱者饱揍一顿；
- Both of them pummeled it. The car vanished. Then it flickered back again /他们一起猛敲那个按钮。汽车消失了，但很快又闪闪烁烁地现了形。
- Freezing temperatures and power outages are pummeling areas from Texas through the Plains states. /从得克萨斯州到平原州，这些地区正在经历严寒和停电。

pump
-  [heart](dic://heart), [ticker](dic://ticker)
- _n._ [mechanical device](dic://mechanical device), [internal organ](dic://internal organ), [viscus](dic://viscus), [shoe](dic://shoe)
- _v._ [wield](dic://wield), [handle](dic://handle), [shoot](dic://shoot), [draw](dic://draw), [take out](dic://take out), [supply](dic://supply), [provide](dic://provide)
- **sump**污水坑;**valve**阀;**injector**注射器;**compressor**压缩机;**hose**连裤袜, 长筒袜, 短统袜;**solenoid**螺线管;**reservoir**水库;**syringe**注射器;**gas**气体;**tank**坦克;**hydraulic**液力的,液压的,水力学的;
- _heat pump_ 热泵，蒸汽泵
- _water pump_ 抽水机，水泵
- _centrifugal pump_ 离心抽机，离心泵
- _pump in_ 用泵吸入
- _oil pump_ 油泵；机油泵；送油泵
- _vacuum pump_ [机]真空泵
- _hydraulic pump_ 液压泵，水力泵
- _gear pump_ 齿轮泵
- _submersible pump_ 潜水泵；水下泵
- _jet pump_ 喷射泵，射流泵
- _fuel pump_ 燃油泵
- a small pump for blowing up balloons /给气球充气的小气筒。
- a bicyclist pumping the pedals /骑自行车的人上下蹬踏板
- turbopump
- sun-pump
- servopump
- sandpump
...
pun
- n. 双关语, 俏皮话  
- vi. 说双关语, 说俏皮话  vt. 用双关语说服, 捣实
- pun [pʌn] vi.说双关语，n.双关语；俏皮话。这个单词与punctilious [pʌŋ(k)'tɪlɪəs] adj. 一丝不苟的；拘泥形式的有关。词根punct表示刺，与point点同根。pun就是语言表达上的一个“fine point”。美国演员George Carlin的pun"Atheism is a non-prophet institution"中，prophet双关了profit。
- 词源不详，可能缩写自拉丁语 punctum,点，刺点，词源同 point,punch.
- punster
	- _n._ [humorist](dic://humorist), [humourist](dic://humourist)
	- **comedian**喜剧演员;**extraordinaire**异常的;**poet**诗人;**storyteller**讲故事者;**writer**作家;**genius**天才，天赋;**pun**说双关语;**cartoonist**漫画家;**connoisseur**鉴识家;**thinker**思想家;**essayist**随笔作家，散文家;
- punny
- punningly
	- _n._ [fun](dic://fun), [play](dic://play), [sport](dic://sport)
	- **allusion**暗示;**tongue-in-cheek**不认真的,不当真的,半开玩笑的;**rhyming**押韵;**colloquial**口语的, 会话的;**idiom**成语，习语;**satirical**含讽刺意味的, 嘲讽的;**phrase**成语;**satire**讽刺;**metaphorical**隐喻般的;**clever**聪明的;**parody**拙劣的模仿;
...
quaff
- 可能来自拟声词，模仿喝酒的声音。
- [gulp](dic://gulp), [swig](dic://swig)
- _n._ [draft](dic://draft), [draught](dic://draught), [potation](dic://potation), [tipple](dic://tipple)
- _v._ [drink](dic://drink), [imbibe](dic://imbibe)
- **drink**喝，饮;**sip**抿;**brew**酿造;**drank**喝;**beer**啤酒;**pint**品脱;**drinkable**可饮用的;**ale**麦芽酒;**gulp**狼吞虎咽地吃;**pints**品脱;**booze**酒;
- _[quaff n](dic://quaff%20n)_ 痛饮
- _[guzzle quaff swill](dic://guzzle%20quaff%20swill)_ 各种狂喝
- quaffed the ale with gusto. /兴致勃勃地狂饮麦芽酒
- Let me quaff this kind Nepenthe and forget this lost Lenore!" /喝吧，喝吧，忘掉你对失去的丽诺尔的思念
- At Wilderness, middle-aged bacchanals quaff champagne or real ale and eat lobsters. /在旷野节，中年的狂欢者痛饮着香槟和鲜啤酒，享受着美味龙虾。

qualm
- 来自古英语 cwealm,死亡，谋杀，折磨，词源同 kill,quell.引申词义有死亡危险的，恐惧的，后词义弱化为顾虑，不安。
- [scruple](dic://scruple), [misgiving](dic://misgiving)
- [queasiness](dic://queasiness), [squeamishness](dic://squeamishness)
- _n._ [anxiety](dic://anxiety), [nausea](dic://nausea), [sickness](dic://sickness)
- **gripe**抱怨;**quibble**谬论;**drawback**缺点，不利条件;**caveat**警告;**concern**涉及，关系到;**hesitation**犹豫;**objection**反对, 异议;**doubt**怀疑;**disappointment**失望;**flaw**瑕疵，缺点;**reason**理由;
- _[qualms](dic://qualms)_  n. 良心之谴责；不安
- qualms of seasickness /晕船
- qualms of homesickness /思乡症
- He has no qualms about lying /他撒谎毫不内疚。
- Lin enjoyed studying abroad, but he had qualms about Westerners’ preoccupation with logic and scientific method.
	- 林语堂很喜欢在国外学习，但西方过分重视逻辑和科学方法，他觉得这样不太妥当。
- qualms
- qualmish
	- adj. 不安的，受良心责备的；引起恶心的

qualify
- 来自 quality,质量，品质，-fy,使。即使符合质量要求，引申词义使符合资格。
- [measure up](dic://measure up)
- [restrict](dic://restrict)
- [dispose](dic://dispose)
- [stipulate](dic://stipulate), [condition](dic://condition), [specify](dic://specify)
- [characterize](dic://characterize), [characterise](dic://characterise)
- [modify](dic://modify)
- _v._ [suffice](dic://suffice), [do](dic://do), [answer](dic://answer), [serve](dic://serve), [pronounce](dic://pronounce), [label](dic://label), [judge](dic://judge)
- _n._ [disqualify](dic://disqualify), [unfit](dic://unfit), [indispose](dic://indispose)
...
- qualification
	...
	- disqualification
- qualificate
	- vt. 认为；判断（意大利语单词 qualificare 的第二人称复数动词形式）
- disqualify
...
- _v._ [oppress](dic://oppress), [suppress](dic://suppress), [crush](dic://crush), [cancel](dic://cancel), [strike down](dic://strike down)
- quash a rebellion
- **suppress**抑制;**dismiss**离开;**stifle**使窒息;**quell**镇压;**thwart**反对;**overturn**推翻;**oust**剥夺;**curtail**截断, 缩短;**undermine**在某物下挖洞或挖通道;**compel**强迫，迫使;**discredit**败坏…的名声;
...
- [suppress](dic://suppress), [stamp down](dic://stamp down), [inhibit](dic://inhibit), [subdue](dic://subdue), [conquer](dic://conquer), [curb](dic://curb), [meet](dic://meet)
...
- n. 淬火
- satisfy (thirst)
	- [slake](dic://slake), [allay](dic://allay), [assuage](dic://assuage)
- put out, as of fires, flames, or lights
	- [snuff out](dic://snuff out), [blow out](dic://blow out), [extinguish](dic://extinguish)
- electronics: suppress (sparking) when the current is cut off in an inductive circuit, or suppress (an oscillation or discharge) in a component or device
- suppress or crush completely
	- [squelch](dic://squelch), [quell](dic://quell)
...
- _quench oil_ 淬火油
- _water quench_ 水淬（热处理）
- _quench hardening_ [冶金]淬火硬化
- drink poison to quench one's thrist /饮鸠止渴
...
- quixotic (whimsical, quixotic, idealistic, quirky, kinky, offbeat, wacky, funky, eccentric, idiosyncratic, crotchet)
	...
	- a vast and perhaps quixotic project. .庞大而或许不切实际的项目。
	- These may seem quixotic or paradoxical choices, but bear with me. /这些似乎是不切实际或自相矛盾的选择，但请先容我讲完。
	- It is rather Quixotic of you. /你真是太不切实际了。
	- These may seem quixotic or paradoxical choices, but please bear with me. /这些可能看起来不切实际或自相矛盾的选择， 但请多多包涵。
	- In his first year as head of the special operatives unit Skorzeny was plagued by the over-ambition and Quixotic ideas of his superiors. /在担任特种部队队长的第一年，斯科尔兹尼就被上级的野心勃勃和不切实际的想法所困扰。
	- Now, this all probably sounds pretty quixotic, kind of like recycling your cans, just a tiny drop in the ocean of a gigantic problem, but that's actually a misconception. /现在，这一切可能听起来很不切实际， 有点像回收你的罐头，只是一个巨大问题的沧海一粟， 但这实际上是一种误解。
...
racket (raucous, racket, ruckus, commotion, din, ruction, rumpus, tumult, rowdy, mayhem, brawl, outcry)
...
- [celebrate](dic://celebrate), [fete](dic://fete), [make noise](dic://make noise), [resound](dic://resound), [noise](dic://noise), [hit](dic://hit)
- [revel](dic://revel), [make whoopie](dic://make whoopie), [make merry](dic://make merry), [make happy](dic://make happy), [whoop it up](dic://whoop it up), [jollify](dic://jollify), [wassail](dic://wassail)
- [fraudulent scheme](dic://fraudulent scheme), [illegitimate enterprise](dic://illegitimate enterprise)
- [noise](dic://noise), [dissonance](dic://dissonance)
- _tennis racket_ 网球拍；网坛骗局
- _badminton racket_ 羽毛球拍
- Such a racket made me headache. /这样的吵闹使我头痛。
- trains racketed by. /火车呼啸而过。
- He hates the racket of modern life /他讨厌现代生活的繁忙社交活动。
- He was known for running a brutal extortion racket./ 他因干过一起残忍的敲诈勒索而出名
- rackety
	- (erratic, errant, wayward, precarious, labile, capricious, volatile, flighty, fickle, versatile, wobble, duplicitous, rackety) 
	- - adj. 喧扰的，喧闹的；不牢固的，摇晃的
	- [rip-roaring](dic://rip-roaring), [uproarious](dic://uproarious)
	- **dilapidated**破旧的;**raucous**沙哑的;**noisy**嘈杂的;**dusty**落满灰尘的;**boisterous**热闹的;**wobbly**摆动的;**ghastly**可怕的;**seedy**多种子的;**eccentric**古怪的, 怪癖的;**dodgy**狡猾的，逃避的;**ragged**衣衫褴褛的;
	- adj. 喧扰的，喧闹的；不牢固的，摇晃的
- racketeer
	- n. 骗子；敲诈者 
	- vt. 对……进行勒索 
	- vi. 敲诈
	- [criminal](dic://criminal), [felon](dic://felon), [crook](dic://crook), [outlaw](dic://outlaw), [malefactor](dic://malefactor)
	- [conduct](dic://conduct), [carry on](dic://carry on), [deal](dic://deal)
	- **gangster**歹徒，流氓;**thug**暴徒;**gambler**赌徒;**pimp**皮条客;**underworld**黑社会;**Capone**卡波尼;**crook**钩;**Mafia**秘密政党;**syndicate**企业联合;**tycoon**巨富;**businessman**商人;
	- _[Lady racketeer](dic://Lady%20racketeer)_ 美人计
	- _[commercial racketeer](dic://commercial%20racketeer)_ 奸商
	- Yeah, they're probably drug lords, smugglers, and racketeers /克拉克：是的，他们可能是毒枭、走私犯和敲诈勒索者。
	...
	- Like some seedy racketeer, the delinquents in Pyongyang had extorted a generous payment in exchange for talks about giving up their pursuit of nuclear weapons. /为争取朝鲜参与放弃核武器对话，朝鲜趁此在平壤拖欠行为同于乞丐的敲诈，以此勒索了大笔钱财。
- racketeering
	...
	- n. 敲诈勒索；诈骗
	- He was convicted last year of racketeering and sex trafficking /去年，他被判犯有敲诈勒索和性交易罪。
	- He's also been charged with collusion, racketeering, and peddling influence. /他还被指控串通、敲诈勒索和兜售影响力
	- Brazil's top anti-corruption prosecutor has charged President Michel Temer with obstruction of justice and racketeering. /巴西高级反腐检察官控诉其总统特梅尔(Michel Temer)阻碍公正，并涉嫌敲诈勒索。
...
- his rants against organized religion /他反对有组织的宗教活动的激烈长篇演说。
...
- [composer](dic://composer), [damage](dic://damage), [harm](dic://harm), [impairment](dic://impairment)
- [disentangle](dic://disentangle), [unsnarl](dic://unsnarl), [straighten out](dic://straighten out), [intertwine](dic://intertwine), [twine](dic://twine), [entwine](dic://entwine), [enlace](dic://enlace)
- [unravel](dic://unravel), [ravel out](dic://ravel out), [unknot](dic://unknot), [unscramble](dic://unscramble), [untangle](dic://untangle), [unpick](dic://unpick)
- **sew**缝合，缝上;
- _ravel out_ 解决；解除；解开
- unravel
	- **uncover**揭露;**unfold**打开;**entangled**卷入的;**tangle**混乱状态;**tangled**纠缠的;**mystery**神秘，秘密;**decipher**译解;**weave**编织;**uncovering**剥离;**enigma**谜，不可思议的东西;**mysteries**古代的秘密宗教仪式;
...
reach
- [range](dic://range)
- [scope](dic://scope), [range](dic://range), [orbit](dic://orbit), [compass](dic://compass), [ambit](dic://ambit)
- [reaching](dic://reaching), [stretch](dic://stretch)
- [compass](dic://compass), [range](dic://range), [grasp](dic://grasp)
- [make](dic://make), [attain](dic://attain), [hit](dic://hit), [arrive at](dic://arrive at), [gain](dic://gain)
- [hit](dic://hit), [attain](dic://attain)
- [reach out](dic://reach out)
- [get through](dic://get through), [get hold of](dic://get hold of), [contact](dic://contact)
- [achieve](dic://achieve), [accomplish](dic://accomplish), [attain](dic://attain)
- [extend to](dic://extend to), [touch](dic://touch)
- [make](dic://make), [get to](dic://get to), [progress to](dic://progress to)
- [pass](dic://pass), [hand](dic://hand), [pass on](dic://pass on), [turn over](dic://turn over), [give](dic://give)
- [strive](dic://strive), [strain](dic://strain)
- _n._ [limit](dic://limit), [extent](dic://extent), [motion](dic://motion), [movement](dic://movement), [move](dic://move), [motility](dic://motility), [capability](dic://capability)
- _v._ [arrive](dic://arrive), [get](dic://get), [come](dic://come), [move](dic://move), [communicate](dic://communicate), [intercommunicate](dic://intercommunicate), [succeed](dic://succeed)
	- [attain](dic://attain) 侧重指在抱负或雄心的激励下，以最大的努力去达到一般所不及或不敢追求的目的。  
	- [reach](dic://reach) 常用词，指到达某一空间、时间、目标或发展过程中的某一点。  
	- [achieve](dic://achieve) 侧重为达到目的所需的技巧、忍耐和努力。   
...
- readable
	...
	- machine-readable
- well-read
	- _adj._ [informed](dic://informed), [educated](dic://educated)
	- _n._ [uninformed](dic://uninformed), [uneducated](dic://uneducated)
	- **literate**受过教育的;**well-informed**消息灵通的;**astute**机敏的;**intelligent**聪明的;**perceptive**敏感的;**witty**诙谐的;**educated**有教养的;**knowledgeable**博学的;**opinionated**固执己见的,武断的;**savvy**悟性;**observant**善于观察的;
- unread
- speedread
- speed-reading
- speechreading
...
recuse
- vt. 要求撤换
- _v._ [disqualify](dic://disqualify), [reject](dic://reject)
- **resign**辞职;**disqualify**丧失资格;**reconsider**重新考虑;**judge**判断;**abstain**放弃;**appoint**任命;**arbitrator**仲裁人;**intervene**干涉;**defer**延期;**disclose**揭露;
- he was recused when he referred to the corporation as ‘a bunch of villains’ /因为他把该公司说成是“一帮恶棍”，人们要求取消他的执法资格。
- The American Borrow Bar Association's Committee on Justicial Judicial Independence is working on guidelines for when judges should recuse themselves /美国律师协会的司法独立委员会正在起草法官在什么情况下应该回避审判的指南。
- There's nothing to recuse himself. He was 100 percent straight with the committee. /他没必要回避。他对委员会100%坦诚。
- So what reasons did he give about why he decided to recuse himself from investigations concerning Russia? /他决定回避与俄罗斯有关的调查，关于这个决定他给出了什么理由？
- recusal
	- n. 取消资格; 宣布不合格
	- _n._ [disqualification](dic://disqualification)
	- **subpoena**传唤，传审;**impeachment**弹劾;**reconsideration**再考虑,再审议,新审议;**dismissal**解雇, 免职, 开除;**judicial**法庭的;**disqualification**不合格;**prosecutor**检举人;**resignation**辞职;**DOJ**司法部;**counsel**忠告;**mediation**调停, 调解, 斡旋;
	- We both know your recusal is for show /我们都清楚你回避只是演给别人看的。
	- And Trump has been mad about this recusal ever since. /从那以后，特朗普对他的回避一直感到非常生气。
	- If this isn't a clear conflict of interest, I don't know what is! - It was one harmless conversation. I know his father. - Which is grounds for a recusal. /如果这都不算明显的利益冲突，什么才是？- 这只是一场普通的交谈，我认识他父亲。- 这正是申请撤换的理由。

regard
- [respect](dic://respect)
- [attentiveness](dic://attentiveness), [heed](dic://heed), [paying attention](dic://paying attention)
- [wish](dic://wish), [compliments](dic://compliments)
- [gaze](dic://gaze)
- [esteem](dic://esteem), [respect](dic://respect)
- [respect](dic://respect)
- [respect](dic://respect), [esteem](dic://esteem)
- [see](dic://see), [consider](dic://consider), [reckon](dic://reckon), [view](dic://view)
- [consider](dic://consider)
- [involve](dic://involve), [affect](dic://affect)
- _n._ [detail](dic://detail), [item](dic://item), [point](dic://point), [attention](dic://attention), [attending](dic://attending), [greeting](dic://greeting), [salutation](dic://salutation)
- _v._ [think](dic://think), [believe](dic://believe), [consider](dic://consider), [conceive](dic://conceive), [look](dic://look), [refer](dic://refer), [pertain](dic://pertain)
	- [consider](dic://consider) 指经过考虑和观察后得出的结论。  
	- [think](dic://think) 普通用词，指按照自己的意见提出看法。  
	- [believe](dic://believe) 通常指根据一定的证据，经思考后而认为属实。 
	- [count](dic://count) 指作出判断后而得出的看法等。  
	- [deem](dic://deem) 正式用词，常用于法律、文学，强调作判断而不是思考。  
	- [reckon](dic://reckon) 指对人或事作全面“权衡”，把各方面意见考虑进去后得出结论。  
	- [regard](dic://regard) 侧重凭外表或表面现象作判断。多强调观点。
- **respect**尊敬，尊重;**concerning**关于，涉及，就…而言;**relation**关系;**pertaining**与…有关系的,附属…的,为…固有的;**particular**特定的;**respecting**关于;**relating**关联的;**consideration**考虑;**concern**涉及，关系到;**deference**顺从;
- regard sb. highly /尊重某人
- regard sb. sternly /严厉地注视某人
- This item regards their liability /这一项涉及到他们的可靠性
-  Don't regard this very seriously./对此不必过分介意。
- In China, it is regarded as following suit. /在中国，这就叫做紧追趋势。
- unregarded
...
- _n._ [spasm](dic://spasm)
- _v._ [excrete](dic://excrete), [egest](dic://egest), [eliminate](dic://eliminate), [pass](dic://pass)
...
- a truck consisting of a tractor and trailer together
	- _synonymous：_ [trailer truck](dic://trailer truck), [tractor trailer](dic://tractor trailer), [trucking rig](dic://trucking rig), [articulated lorry](dic://articulated lorry), [semi](dic://semi)
- formation of masts, spars, sails, etc., on a vessel
	- _synonymous：_ [rigging](dic://rigging)
- a set of clothing (with accessories)
	- _synonymous：_ [outfit](dic://outfit), [getup](dic://getup), [turnout](dic://turnout)
- gear used in fishing
	- _synonymous：_ [fishing gear](dic://fishing gear), [tackle](dic://tackle), [fishing tackle](dic://fishing tackle), [fishing rig](dic://fishing rig)
- a vehicle with wheels drawn by one or more horses
	- _synonymous：_ [carriage](dic://carriage), [equipage](dic://equipage)
- the act of swindling by some fraudulent scheme
	- _synonymous：_ [swindle](dic://swindle), [cheat](dic://cheat)
- arrange the outcome of by means of deceit
	- rig a election
	- _synonymous：_ [set up](dic://set up)
- manipulate in a fraudulent manner
	- rig prices
	- _synonymous：_ [manipulate](dic://manipulate)
- connect or secure to
	- They rigged the bomb to the ignition
- equip with sails or masts
	- rig a ship
	- _synonymous：_ [set](dic://set), [set up](dic://set up)
- rigger
- rigor
- [asperity](dic://asperity), [grimness](dic://grimness), [hardship](dic://hardship), [rigour](dic://rigour), [severity](dic://severity), [severeness](dic://severeness), [rigorousness](dic://rigorousness), [rigourousness](dic://rigourousness)
- [cogency](dic://cogency), [validity](dic://validity), [rigour](dic://rigour)
- [severity](dic://severity), [severeness](dic://severeness), [harshness](dic://harshness), [rigour](dic://rigour), [rigorousness](dic://rigorousness), [rigourousness](dic://rigourousness), [inclemency](dic://inclemency), [hardness](dic://hardness), [stiffness](dic://stiffness)
- _n._ [difficulty](dic://difficulty), [difficultness](dic://difficultness), [credibility](dic://credibility), [credibleness](dic://credibleness), [believability](dic://believability), [sternness](dic://sternness), [strictness](dic://strictness)
...
- ritual
	- [rite](dic://rite)
	- _n._ [custom](dic://custom), [usage](dic://usage), [usance](dic://usance), [practice](dic://practice), [pattern](dic://pattern), [habit](dic://habit), [use](dic://use)
	- _adj._ [rite](dic://rite), [religious rite](dic://religious rite)
	- **rites**仪式;**ceremonial**礼仪的;**rite**仪式;**sacred**神圣的;**ceremony**典礼，仪式;**liturgy**礼拜仪式;**cleansing**清洁,使清洁的人或物;**tradition**传统;**sacrament**圣事,圣礼;**symbolic**使用符号的;**consecration**奉献;
	- ritulize
	- ritualistic
	- ritualist
...
- rosary
	...
	- _[rachitic rosary](dic://rachitic%20rosary)_  [内科] 串珠肋
...
- primrose
	- **sunflower**向日葵;**lilac**淡紫色;**lavender**淡紫色;**herb**香草，药草;**lily**百合花，百合;**orchid**兰花;**flax**亚麻;**flower**花;**fennel**茴香;**flowering**开花的;**violet**紫罗兰;
	- _n._ [herb](dic://herb), [herbaceous plant](dic://herbaceous plant)
	- [primula](dic://primula)
	- _evening primrose_ 月见草；<美>夜来香
...
- [course](dic://course)
-  [rowing](dic://rowing)
- _n._ [line](dic://line), [dispute](dic://dispute), [difference](dic://difference), [difference of opinion](dic://difference of opinion), [conflict](dic://conflict), [strip](dic://strip), [layer](dic://layer)
- _v._ [boat](dic://boat)
- **front**前面;**column**圆柱，柱形物;**consecutive**连续的;**consecutively**连续地;**seats**座椅，座位;**columns**名词column的复数形式;**table**桌子;**seat**座位;
- rowing
- rower
	- **swimmer**游泳者;**athlete**运动员，体育家;**sprinter**短跑选手;**gymnast**体操运动员;**runner**走私者;**skier**滑雪的人;**cyclist**骑自行车的人;**Olympian**威严的;**swimmers**游泳者;**sailor**水手，海员;**diver**潜水者;
	- the rowers sing to keep their stroke /划桨手唱着歌以保持节奏。
- rowdy
	- rowdyism, rowdyish, rowdydowdy, rowdydow
	- [bully](dic://bully), [tough](dic://tough), [hooligan](dic://hooligan), [ruffian](dic://ruffian), [roughneck](dic://roughneck), [yob](dic://yob), [yobo](dic://yobo), [yobbo](dic://yobbo)
	...
	- rowdy teenagers; a rowdy beer party /粗暴的青少年；喧闹的啤酒聚会
- rowdedow
	- _n._ 〈口〉喧闹;喧嚣;喧扰
- rowboat
...
rue
- (contrite, remorseful, rueful, ruthful, penitent repentant, excusatory, compunctious)
- n. 懊悔, 后悔; 芸香  
- v. 后悔, 悲伤, 懊悔
...
- _[sardonic facies](dic://sardonic%20facies)_ 苦笑面容
- _[sardonic patrimony](dic://sardonic%20patrimony)_ 祖传的财物
- Starkey attempted a sardonic smile /斯塔基勉强作了一个冷笑的表情。
...
- _v._ [work](dic://work), [restrict](dic://restrict), [supply](dic://supply), [provide](dic://provide), [render](dic://render), [furnish](dic://furnish)
- _adj._ [insufficient](dic://insufficient), [deficient](dic://deficient)
- _n._ [sufficient](dic://sufficient)
...
- [frighten](dic://frighten), [fright](dic://fright), [affright](dic://affright)
- [daunt](dic://daunt), [dash](dic://dash), [scare off](dic://scare off), [pall](dic://pall), [frighten off](dic://frighten off), [scare away](dic://scare away), [frighten away](dic://frighten away)
- _n._ [anxiety](dic://anxiety), [anxiousness](dic://anxiousness), [fear](dic://fear), [fearfulness](dic://fearfulness), [fright](dic://fright)
- _v._ [stimulate](dic://stimulate), [shake](dic://shake), [shake up](dic://shake up), [excite](dic://excite), [stir](dic://stir), [intimidate](dic://intimidate), [restrain](dic://restrain)
...
- **frighten**使惊吓;**scary**引起惊慌的;**intimidate**恐吓, 威胁;**fear**害怕;**frightening**令人恐惧的;**warn**警告，提醒;**dissuade**劝阻，劝止;**panic**恐慌，惊慌;**frightened**害怕的;**afraid**害怕的;**annoy**骚扰;
- unscared
- scary
- scaremonger
	- _[scaremonger](dic://scaremonger)_  n. 散布谣言的人
	- _n._ [alarmist](dic://alarmist)
	- **disinformation**故意的假情报;**scare**惊吓;**mislead**误导;**daft**愚蠢可笑的;**discredit**败坏…的名声;**propaganda**宣传, 宣传运动;**nonsense**谬论;**misinformation**错误信息;**smear**涂抹;**disingenuous**不真诚的;**criticise**批评;
- scareline
	- 惊吓线
- scarehead
	- _n._ 耸人听闻的大标题
...
-  [mule](dic://mule)
- [drag](dic://drag)
- _[scuffed](dic://scuffed)_  adj. 磨损的; v. 使磨损（scuff的过去式）；拖着脚走; 
- _[scuffing](dic://scuffing)_  n. 变形；划痕；擦伤; v. 使磨损（scuff的ing形式）；拖着脚走路; 
- _[scuff resistance](dic://scuff%20resistance)_  耐擦性能，抗揉搓性
- _[scuff plate](dic://scuff%20plate)_  防擦板
- _[scuff mark](dic://scuff%20mark)_  划伤; 擦伤(玻璃、陶瓷表面缺陷);
- **dents**花边边饰;**abrasion**磨损;**rust**锈;**stain**沾污;**skid**刹车;**scrape**用工具刮;**scratch**抓痕;**suede**绒面革;**dirt**污垢，泥土;**chipping**破片;**polish**磨光，擦亮;
- scuff one's shoes on a mat /在席垫上擦鞋
- he scuffed his feet boyishly /他稚气地拖着脚走。
- And then I'm wearing my scuffed up " Doctor Martens"/ 然后穿着我那破旧的马丁靴。
- Power connection, tiny little scuff marks around the edge of it. /电源插口，周围有细小的磨损痕迹。

scuffle
- [hassle](dic://hassle), [tussle](dic://tussle), [dogfight](dic://dogfight), [rough-and-tumble](dic://rough-and-tumble)
- [scuffle hoe](dic://scuffle hoe), [Dutch hoe](dic://Dutch hoe)
- [scramble](dic://scramble)
- [shuffle](dic://shuffle), [shamble](dic://shamble)
- [fight](dic://fight), [fighting](dic://fighting), [combat](dic://combat), [scrap](dic://scrap), [hoe](dic://hoe), [struggle](dic://struggle), [battle](dic://battle)
- [walk](dic://walk), [contend](dic://contend), [fight](dic://fight), [struggle](dic://struggle)
- **altercation**争执;**brawl**争吵;**confrontation**对抗, 对抗的事物;**skirmish**小冲突，小规模战斗;**commotion**暴乱;**spat**蚝卵;**quarrel**吵架;**incident**事件，事变;**standoff**冷淡;**stabbed**刺,中伤,刺穿;**feud**长期不和;
- _[scuffle with](dic://scuffle%20with)_ 乱打
- _[group scuffle](dic://group%20scuffle)_ 由多人参加的打架斗殴
- _[scuffle shuffle](dic://scuffle%20shuffle)_ 拖着脚走
- he heard the scuffle of feet /他听见匆忙的脚步声
- I expected to hear a scuffle in the hall or at least a smothered shriek/ 我期待能听见大厅里的冲突声或者至少是被压制住的尖叫声。

scull
- **rowing**划船;**skull**头盖骨，脑壳;**skeleton**骨架，骨骼;**canoe**独木舟;**slalom**障碍滑雪赛;**quad**四方院子;**medalist**奖牌获得者;**medal**勋章，奖章;**boat**小船;**swim**游泳;**swimmer**游泳者;

scullery
- **kitchen**炊具;**maid**女仆;**cupboard**食橱;**butler**男管家;**servant**仆人，佣人;**servants**仆人;**housekeeper**管家;**laundry**洗衣店，洗衣房;**pantry**食品储藏室;**verandah**走廊;**downstairs**楼下的;
- “Sweet of you, ” she replied, and she smiled as she left the scullery. /你真好，”她回答，微笑着离开了碗碟储藏室。

sculpt
- **torso**躯干;**sculptor**雕刻家;**carve**雕刻;**figurine**小雕像，小塑像;**sculpture**雕塑;**reshape**改造;**molds**模具;**paint**油漆;**figure**图形;**articulation**清晰度;**likeness**相似物;
...
- _n._ [apothecaries' unit](dic://apothecaries' unit), [apothecaries' weight](dic://apothecaries' weight), [anxiety](dic://anxiety), [principle](dic://principle)
- _v._ [hesitate](dic://hesitate), [pause](dic://pause), [fuss](dic://fuss), [niggle](dic://niggle), [fret](dic://fret), [wonder](dic://wonder), [question](dic://question)
...
- scrupulous
	...
	- _n._ [unscrupulous](dic://unscrupulous), [careless](dic://careless)
	...
	- a scrupulous businessman /正直的商人
	- unscrupulousness
	- unscrupulous 
		...
		- a wicked and unscrupulous politician. /邪恶无耻的政客。
	- scrupulously
- scrupulosity
	- _chariness circumspection scrupulosity_ 细心

schlep, schlepp
- [simpleton](dic://simpleton), [simple](dic://simple), [journey](dic://journey), [journeying](dic://journeying)
- [shlep](dic://shlep), [pull along](dic://pull along)
- **haul**用力拖拉;**hauling**搬运;**slog**猛击;**lug**拖，拉;**unload**卸;**commute**通勤;**unpack**卸下…;**trek**艰苦跋涉;**cram**塞满;**unpacking**取出货物, 拆包;**suitcase**手提箱;
- I would have preferred not to schlep all the way over there to run an errand /我原本不想费那么大劲远路去到那儿跑腿。
- Why else would anyone schlep out to Queens? /不然来皇后剧院干嘛？
...
schmaltz 
- (mawkish bathetic, drippy, hokey, maudlin, mushy, schmaltzy, schmalzy, sentimental, soppy, soupy, slushy, lugubrious, drippiness, )
- (Yiddish) excessive sentimentality in art or music
- **melodrama**情节剧;**cliches**陈腔滥调;**cheesy**干酪质的;**corny**谷类的;**cynicism**犬儒主义;**overdone**把…煮得过久;**lard**猪油;**crass**粗鲁的;**silliness**愚蠢;**nostalgia**对往事的怀恋, 怀旧;**cliche**陈词滥调;
- [shmaltz](dic://shmaltz), [schmalz](dic://schmalz)
- Teleology can guarantee the progress of history, but a sentimental mood hides in it.Kant's Schmaltz is undoubtedly rooted in Rousseauism /目的论虽然可以保证历史的进步，但其中透露出来的是一种伤感的基调，这种伤感无疑来源于卢梭主义的影响。

schmooze
- [chat](dic://chat), [confab](dic://confab), [confabulation](dic://confabulation), [schmoose](dic://schmoose)
- [shmooze](dic://shmooze), [shmoose](dic://shmoose), [schmoose](dic://schmoose), [jawbone](dic://jawbone)
- [chew the fat](dic://chew the fat), [shoot the breeze](dic://shoot the breeze), [chat](dic://chat), [confabulate](dic://confabulate), [confab](dic://confab), [chitchat](dic://chitchat), [chatter](dic://chatter)
- **mingle**混合;**socialize**交往,联谊;**flirt**调情;**dine**进餐，用餐;**booze**酒;**swag**赃物，掠夺品;**woo**寻求支持;**biz**商业;**hangout**巢穴，住所;**luncheon**午宴;**greet**欢迎，迎
- You have some nerve showing up here just to schmooze with the tenure committee. /你居然有脸跑这儿来找教职委员会的人闲聊。

schnapps
- **liqueur**利口酒;**brandy**白兰地酒;**vodka**伏特加酒;**whiskey**威士忌酒;**gin**杜松子酒;**cider**苹果汁;**rum**古怪的;**whisky**威士忌酒;**tequila**龙舌兰酒;**drink**喝，饮;**syrup**糖浆，果汁;
- [liquor](dic://liquor), [spirits](dic://spirits), [booze](dic://booze), [hard drink](dic://hard drink), [hard liquor](dic://hard liquor), [John Barleycorn](dic://John Barleycorn), [strong drink](dic://strong drink)
- _[shot cinnamon schnapps](dic://shot%20cinnamon%20schnapps)_ 肉桂蒸馏酒
- _[butterscotch schnapps](dic://butterscotch%20schnapps)_ 奶油糖果甜酒
- _[Shamrock schnapps](dic://Shamrock%20schnapps)_ 三叶草利口酒
- _[oz peppermint schnapps](dic://oz%20peppermint%20schnapps)_ 薄荷酒

schnauzer
- n. 髯狗，雪纳瑞狗（德国种刚毛犬的一种）
- **poodle**狮子狗;**terrier**一种活泼的小狗;**dog**狗;**puppy**小狗，幼犬;**bulldog**牛头犬，恶犬;**pup**小狗;**cat**猫;**dogs**瘦狗类;**Chihuahua**吉娃娃;**doggie**小狗，狗;**kitten**小猫;
- There's a schnauzer in Cincinnati that turned purple. /听说这是完全正常的。

schnitzel
- **sausages**香肠， 腊肠;**steak**牛排;**sausage**香肠;**burgers**汉堡包;**veal**小牛肉;**brisket**胸肉;**burger**汉堡包;**ravioli**略有馅的水饺;**hamburger**汉堡包;**pork**猪肉;**pancakes**薄烤饼;
- _[schnitzel](dic://schnitzel)_  n. 炸肉排
- _[Wiener schnitzel](dic://Wiener%20schnitzel)_  （德）维也纳炸小牛排

schnozzle
- **nose**鼻子;**snout**鼻子;**nostrils**鼻孔;**beak**鸟嘴;**sinuses**鼻窦;**bulldog**牛头犬，恶犬;**pooch**杂种狗;**skunk**臭鼬;**nasal**鼻的;**hump**圆形隆起物;
- n. 鼻子

schnorkel
- _[schnorkel](dic://schnorkel)_ 进气管; 潜水呼吸管;

schnorrer
- **Jew**犹太人;**beggar**乞丐;**Yiddish**意第绪语
- [moocher](dic://moocher), [mooch](dic://mooch), [cadger](dic://cadger), [scrounger](dic://scrounger)

schmuck, schnook, schmo, schmoe
- **moron**痴愚者;**idiot**白痴;**guy**男人，家伙;**asshole**屁眼儿,肛门;**dude**城里人;**bastard**私生的;**bitch**母狗，母狼;**lousy**多虱的;**dumb**哑的，无说话能力的;**shitty**较差的;**douche**灌注法;
- And you became a hero, and I became a schmuck. /你成了英雄，我成了笨人。
- I'm the schmuck they brought in to make things better. /我是被派来挽回局面的冤大头。
...
- **fury**狂怒;**rage**愤怒;**anger**怒，愤怒;**raging**愤怒的，狂暴的;**bubbling**冒泡，鼓泡;**resentment**愤恨,不满,怨恨;**indignation**愤怒, 愤慨, 气愤;**teeming**多产的，丰富的;**hatred**憎恨;**furious**狂怒的;**angry**生气的;
...
- Let's just shag ass before Leather face catches up/ 在它皮革脸咬到屁股之前 我们得快一点。
- shaggy
...
shanty
- [hovel](dic://hovel), [hut](dic://hut), [hutch](dic://hutch), [shack](dic://shack)
- [chantey](dic://chantey), [chanty](dic://chanty), [sea chantey](dic://sea chantey)
- _n._ [shelter](dic://shelter), [work song](dic://work song)
- **slum**贫民窟;**shack**小室;**slums**贫民，贫民区;**dilapidated**破旧的;**hut**小屋;**seaside**海滨;**makeshift**权宜之计, 临时代用的物品;**town**城镇，市镇;**village**村庄;**derelict**玩忽职守的;**wharf**码头;
- _[shanty town](dic://shanty%20town)_  棚户区; 贫民窟;
- James Collins' shanty was considered an uncommonly fine one /那是一间被视为极其出色的屋子。
- shantytown
	- _n._ [slum](dic://slum), [slum area](dic://slum area)
	- **slum**贫民窟;**slums**贫民，贫民区;**makeshift**权宜之计, 临时代用的物品;**impoverished**穷困的,无力的,用尽了的;**ghetto**少数民族聚居区;**dilapidated**破旧的;**shack**小室;**outskirts**郊区;**metropolis**一国的主要城市;**hillside**山坡，山腹;**urban**城市的;
	- _[shantytown renovation](dic://shantytown%20renovation)_ 棚户区改造
	- _[shantytowns transformation](dic://shantytowns%20transformation)_ 棚户区改造
...
-  [simulate](dic://simulate), [assume](dic://assume), [feign](dic://feign)
- [feign](dic://feign), [pretend](dic://pretend), [affect](dic://affect), [dissemble](dic://dissemble)
- [assumed](dic://assumed), [false](dic://false), [fictitious](dic://fictitious), [fictive](dic://fictive), [pretended](dic://pretended), [put on](dic://put on)
- _n._ [imitation](dic://imitation), [counterfeit](dic://counterfeit), [forgery](dic://forgery), [deceiver](dic://deceiver), [cheat](dic://cheat), [cheater](dic://cheater), [trickster](dic://trickster)
- _v._ [dissemble](dic://dissemble), [pretend](dic://pretend), [act](dic://act), [misrepresent](dic://misrepresent), [belie](dic://belie)
- _adj._ [counterfeit](dic://counterfeit), [imitative](dic://imitative)
- _n._ [genuine](dic://genuine), [echt](dic://echt)
- **phony**假的，欺骗的;**farce**笑剧,闹剧,滑稽戏;**ruse**诡计;**bogus**伪造的;**scam**骗局，诡计;**deception**欺骗;**fake**假货;**placebo**安慰剂;**ploy**策略;**fiasco**惨败;**fraud**欺骗;
- _[sham marriage](dic://sham%20marriage)_  假结婚
- _[sham operation](dic://sham%20operation)_  假手术
- _[sham rage](dic://sham%20rage)_  [生理] 假怒
...
- _v._ [restrain](dic://restrain), [confine](dic://confine), [hold](dic://hold)
- **lock**锁，锁上;**rope**绳，绳索;**winch**卷扬机,绞车,辘轳;**locking**锁定;**ratchet**棘轮;**clamps**夹子;**clamp**夹子;**axle**车轴;**yoke**轭;**bondage**奴役身份;**tether**系绳;
- [bond](dic://bond), [hamper](dic://hamper), [trammel](dic://trammel)
- [pinion](dic://pinion)
- [fetter](dic://fetter)
- unshackled
- unshackle
	- _[unshackled](dic://unshackled)_  adj. 不受束缚的; v. 解除…的桎梏（unshackle的过去式）; 
	- _[unshackle](dic://unshackle)_  vt. 除去...镣铐；释放
- ramshackle
	- _[ramshackle](dic://ramshackle)_  adj. （建筑物、车辆等）摇摇欲坠的，破烂不堪的；（组织或体制）松散的，东拼西凑的
	- _adj._ [damaged](dic://damaged)
	- _n._ [undamaged](dic://undamaged)
...
shallow (mallow, hallow, sallow, shallow, hollow, harrow, wallow, callow)
- 来自古英语 sceald,浅的，来自 Proto-Germanic*skalaz,晒干的，浅的，来自 PIE*skel,使变干，可能来自 PIE*skai,照耀，照射，词源同 shine,sheen.引申比喻义浅薄的。
- [shoal](dic://shoal)
- _n._ [body of water](dic://body of water), [water](dic://water)
- _v._ [change](dic://change), [alter](dic://alter), [modify](dic://modify)
- _adj._ [ankle-deep](dic://ankle-deep), [knee-deep](dic://knee-deep), [fordable](dic://fordable), [neritic](dic://neritic), [reefy](dic://reefy), [shelfy](dic://shelfy), [shelvy](dic://shelvy)_n._ [deep](dic://deep), [profound](dic://profound)
- **superficial**表面的;**deep**深处;**depth**深度;**submerged**在水中的;**deeper**更深;**hollow**空的;**sunken**沉没的;**self-centered**自我为中心的,利己主义的;**wading**涉水的;**muddy**泥泞的;**narrow**狭窄的，有限的;
...
sheen
- [shininess](dic://shininess), [luster](dic://luster), [lustre](dic://lustre)
- _n._ [radiance](dic://radiance), [radiancy](dic://radiancy), [shine](dic://shine), [effulgence](dic://effulgence), [refulgence](dic://refulgence), [refulgency](dic://refulgency)
- **luster**光泽;**shimmer**微光;**shimmery**闪烁的;**gloss**注释;**silvery**似银的，银色的;**matte**冰铜;**glossy**有光泽的;**shiny**有光泽的，擦亮的;**sparkle**发火花, 闪耀;**texture**质地;**satin**缎子;
- _[a metallic sheen](dic://a%20metallic%20sheen)_ 金属的光泽
- sheeny
...
- shifty-eyed
- shiftless
	- **lazy**懒惰的;**uneducated**未受良好教育的;**hard-working**勤勉的,努力工作的;**unemployed**被解雇的;**inept**不适当的;**hapless**运气不好的，倒霉的;**illiterate**目不识丁的,文盲的;**self-centered**自我为中心的,利己主义的;**incompetent**无能力的;**impoverished**穷困的,无力的,用尽了的;**destitute**赤贫的, 贫苦的;
	- _adj._ [unambitious](dic://unambitious), [ambitionless](dic://ambitionless)
	- _[impuissant inept shiftless talentless](dic://impuissant%20inept%20shiftless%20talentless)_ 无能的
- shifting
- shiftness
- shifter
- sceneshifter
- multishift
- manshift
	- _[manshift](dic://manshift)_  n. 一人工作量；轮班
- makeshift
	- _n._ [expedient](dic://expedient)
	- _adj._ [impermanent](dic://impermanent), [temporary](dic://temporary)
	- _n._ [permanent](dic://permanent), [lasting](dic://lasting)
	- **tent**帐篷;**tents**旅游帐篷;**home-made**常里做的;**impromptu**事先无准备, 临时;**huddled**挤成一团;**wooden**木制的;**shack**小室;**dilapidated**破旧的;**open-air**户外的,野外的;**cardboard**硬纸板;**barracks**兵营，营房;
	- _[makeshift](dic://makeshift)_  n. 权宜之计，凑合; adj. 临时的，权宜之计的; 
	- _[makeshift road](dic://makeshift%20road)_  临时道路
	- _[makeshift hospital](dic://makeshift%20hospital)_  临时医院
	- _[makeshift house](dic://makeshift%20house)_  简易房，临时搭建的住房
	- The accommodation for the press was makeshift at best. /迁就新闻界充其量只是个权宜之计
	- used a rock as a makeshift hammer. /用石块作临时代用的锤子
- gearshift
	- _n._ [mechanical device](dic://mechanical device)
	- **gearbox**变速箱;**shifter**移动装置;**lever**杠杆;**knob**把手;**steering**掌舵;**gears**齿轮，传动装置;**brake**刹车;**clutch**抓住;**throttle**节流阀;**brakes**刹车系统;**pedal**踩踏板;
- frameshift

shingle
- 1. n. 墙面板；木瓦；[口]小招牌（尤指医生或律师挂的营业招牌）；鹅卵石 vt. 用盖板覆盖
- _n._ [building material](dic://building material), [gravel](dic://gravel), [crushed rock](dic://crushed rock), [signboard](dic://signboard), [sign](dic://sign)
- _v._ [roof](dic://roof)
...
- school
- shallow
- _n._ [sandbank](dic://sandbank), [body of water](dic://body of water), [water](dic://water), [animal group](dic://animal group)
- _v._ [change](dic://change), [alter](dic://alter), [modify](dic://modify)
- **reef**暗礁;**reefs**群礁;**shore**岸;**cove**小湾;**buoy**浮标;**shoreline**海〔湖〕滨线;**waters**海域;**fish**捕鱼，钓鱼;**jetty**码头;**aground**搁浅地;**shipwreck**海难, 船只失事;
- _[shoaling](dic://shoaling)_  n. [海洋] 浅水作用; vt. 驶入（浅水等）；使变浅（shoal的现在分词）; vi. （鱼等）成群聚集；变浅（shoal的现在分词）; 
- _[shoals](dic://shoals)_  n. [地理] 浅滩（shoal的复数形式）；[水文] 沙洲; v. 变浅；使驶进浅水区（shoal的第三人称单数）; n. (Shoals)人名；(英)肖尔斯; 
- _[shoal water](dic://shoal%20water)_  浅水区
...
- [cheapjack](dic://cheapjack), [tawdry](dic://tawdry)
- [jerry-built](dic://jerry-built)
- [deceptive](dic://deceptive), [misleading](dic://misleading)
- **substandard**标准以下的;**crappy**糟糕的;**lousy**多虱的;**sloppy**草率的;**atrocious**恶毒的;**dodgy**狡猾的，逃避的;**abysmal**深不可测的;**flimsy**脆弱的;**mediocre**平凡的;**poor**可怜的;**shitty**较差的;
...
- showy
	...
	- a showy violin solo. /一段精彩的小提琴独奏
	- a cheap, showy rhinestone bracelet /廉价且引人注目的莱茵石手镯；
- showup
- showstopper

shrew
- [termagant](dic://termagant)
- [shrewmouse](dic://shrewmouse)
- _n._ [unpleasant woman](dic://unpleasant woman), [disagreeable woman](dic://disagreeable woman), [insectivore](dic://insectivore)
- **toad**蟾蜍;**rat**鼠;**weasel**逃避;**rodent**啮齿目动物;**mammal**哺乳动物;**squirrel**松鼠;**mole**痣;**frog**青蛙;**sparrow**麻雀;**otter**水獭;**cougar**美洲狮，美洲豹;

shrewd
- [astute](dic://astute), [sharp](dic://sharp)
- [calculating](dic://calculating), [calculative](dic://calculative), [conniving](dic://conniving), [scheming](dic://scheming)
- _adj._ [smart](dic://smart), [hard](dic://hard)
- _n._ [stupid](dic://stupid), [soft](dic://soft)
	- [bright](dic://bright) 口语常用词，多指年轻人，尤指小孩思路敏捷，理解力强，机灵等。  
	- [clever](dic://clever) 强调头脑灵活，接受新事物快，有智有谋，但不一定暗示全面妥当地考虑问题。
	- [wise](dic://wise) 侧重不是一般的聪明伶俐，而是有远见，有智慧，能明智地处理问题。
	- [brilliant](dic://brilliant) 指人的才华出众，思路敏捷，常令人赞叹不已。
	- [intelligent](dic://intelligent) 正式用词，指在理解新的、抽象东西或处理解决问题时，智力超过一般常人。
	- [ingenious](dic://ingenious) 指思路敏捷，并暗示有创造与发明的才能和技巧。
	- [smart](dic://smart) 普通用词，与bright和clever的意思很相近，但更强调机灵。
	- [shrewd](dic://shrewd) 指精明老练，有头脑，善于判断，把握有利机会。
	- **astute**机敏的;**cunning**狡猾的;**clever**聪明的;**skillful**熟练的;**sly**狡猾的;**savvy**悟性;**perceptive**敏感的;**deft**灵巧的;**ruthless**无情的，残忍的;**wise**聪明的;**devious**弯曲的;
- shrewd-looking
- shrewd-headed
- shrewd-brain

shriek
-  [scream](dic://scream), [screaming](dic://screaming), [shrieking](dic://shrieking), [screech](dic://screech), [screeching](dic://screeching)
-  [screech](dic://screech), [screeching](dic://screeching), [shrieking](dic://shrieking), [scream](dic://scream), [screaming](dic://screaming)
- [shrill](dic://shrill), [pipe up](dic://pipe up), [pipe](dic://pipe)
- _n._ [cry](dic://cry), [outcry](dic://outcry), [call](dic://call), [yell](dic://yell), [shout](dic://shout), [vociferation](dic://vociferation), [noise](dic://noise)
- _v._ [shout](dic://shout), [shout out](dic://shout out), [cry](dic://cry), [call](dic://call), [yell](dic://yell), [scream](dic://scream), [holler](dic://holler)
	- [cry](dic://cry) 一般指因恐惧、痛苦、惊奇等而喊叫。 
	- [shout](dic://shout) 指有意识地高声喊叫，常用于提出警告、发命令或唤起注意等。   
	- [exclaim](dic://exclaim) 多指因高兴、愤怒、痛苦、惊讶等突发感情而高声喊叫。  
	- [roar](dic://roar) 指发出大而深沉的声音、吼叫或咆哮。  
	- [scream](dic://scream) 指因恐具、快乐或痛苦而发出的尖叫声。  
	- [shriek](dic://shriek) 指因惊恐、痛苦等或其它感情而发出比scream更为尖锐、刺耳的叫声。  
	- [yell](dic://yell) 多指求援、鼓励时的呼叫。也可指因外界因素刺激而发出尖厉声音。  
	- [call](dic://call) 指大声说话或喊叫，以引起某人的注意。
- **scream**尖叫;**howl**怒吼;**screeching**发动机啸声;**groan**呻吟;**roar**吼;**screaming**尖叫的;**yell**大叫，叫喊;**wailing**哭号;**gasp**喘息;**moan**呻吟;**shout**呼喊;

shrill
- _v._ [shout](dic://shout), [shout out](dic://shout out), [cry](dic://cry), [call](dic://call), [yell](dic://yell), [scream](dic://scream), [holler](dic://holler)
- _adj._ [high](dic://high), [high-pitched](dic://high-pitched), [imperative](dic://imperative), [colorful](dic://colorful), [colourful](dic://colourful)
- _n._ [low](dic://low), [low-pitched](dic://low-pitched), [beseeching](dic://beseeching), [colorless](dic://colorless), [colourless](dic://colourless)
- **screeching**发动机啸声;**loud**大声的，高声的;**wailing**哭号;**deafening**震耳欲聋的;**whiny**烦躁的;**muffled**听不清的;**hysterical**情绪异常激动的, 歇斯底里般的;**obnoxious**可憎的;**incessant**不停的, 持续不断的;**scream**尖叫;**sounding**音响;
- [shriek](dic://shriek), [pipe up](dic://pipe up), [pipe](dic://pipe)
- [piercing](dic://piercing), [sharp](dic://sharp)
- [strident](dic://strident)
- _[not shrill](dic://not%20shrill)_ 低沉的
- _[Strangle Shrill](dic://Strangle%20Shrill)_ 勒命尖叫
- _[shrill call](dic://shrill%20call)_ 这边的尖叫
- _[shrill colors](dic://shrill%20colors)_ 鲜明的颜色
- _[shrill cries](dic://shrill%20cries)_ 灌木; 耸肩; 
- _[a shrill fife](dic://a%20shrill%20fife)_ 高音笛
- _[ghast and shrill](dic://ghast%20and%20shrill)_ 使人恐怖
- _[sad and shrill cries](dic://sad%20and%20shrill%20cries)_ 凄厉的喊叫声
- shrilly
- the shrill wail of a siren /警笛的尖啸
- a shrill scream rent the air./ 一阵尖声惊叫划破长空。

shrine
- shrine（神龛）：存放圣徒遗骸、供人崇拜的容器
- 来自古英语 scrin,箱子，圣物箱，来自拉丁语 scrinium,箱子，盒子，文件盒。引申词义圣地，圣祠，神龛等。
- 英语单词shrine来自拉丁语，原本指用来存放重要文件的盒子或箱子，一般都比较精美。  
- 在四世纪末以后，基督徒礼拜的对象除了神和耶稣基督之外，还逐渐出现了对圣母、圣徒、圣徒遗骸遗物、圣图像等的崇拜。圣徒的干尸、圣物、圣像成了教堂和修道院争夺的宝贝。这些圣物被信徒用镶满宝石的水晶容器供奉起来，供朝圣者瞻仰。中世纪时，圣物崇拜成为强制性要求，所有的教堂都要求供奉一件圣物或圣尸。照俄国东正教教规，圣徒死后都要做成干尸。用来存放圣徒遗骸或遗物的精美容器就被称为shrine。  
- 后来，shrine一词的范围有所扩大。人们将圣徒的墓地、盖在圣徒墓地上的建筑、保存圣徒遗骸或其他遗物的建筑都称为shrine，还可以表示我们中国人用来放置祖宗灵牌或神仙塑像的神龛。  
- shrine：[ʃraɪn] n.神龛，神殿，圣祠，圣徒墓地  
- enshrine：[ɪn'ʃraɪn] vt. 铭记，珍藏；把…置于神龛内；把…奉为神圣
	- vt. <正式>把（法律、权利等）奉为神圣，把……庄严地载入；<正式>珍藏（神圣或宝贵的物品）；把……置于神龛内
	- [saint](dic://saint)
	- _v._ [enclose](dic://enclose), [close in](dic://close in), [inclose](dic://inclose), [shut in](dic://shut in), [reverence](dic://reverence), [fear](dic://fear), [revere](dic://revere)
	- **uphold**支持;**enact**扮演;**legislate**制定法律;**abolish**废除，废止;**preserve**保存;**perpetuate**使永存;**ratify**批准;**redefine**重新定义;**embody**体现，使具体化;**safeguard**防护措施, 安全设施;**overturn**推翻;
	- memories enshrined in one's heart /珍藏在内心的回忆
	- relics are enshrined under altars. /圣物被置放在圣坛下。
	- the right of all workers to strike was enshrined in the new constitution. /新宪法保护所有工人的罢工权利神圣不可侵犯。
	- For the first time, environmental principles will be enshrined in law /环境保护原则将首次写入法案。
	- My mother enshrines our good days in her memory. /几个世纪以来，加冕誓言一直存在，并被写入法律。
	- Every country in the world must enshrine these new WHO guidelines into law now. /世界各国政府应该将更新的指导方针奉为法律。
	- That will be tantamount to enshrining in the global community in equality of the highest order. /这将等同于在国际社会中尊崇最高级别的平等。
...
- [reduce](dic://reduce)
- [contract](dic://contract)
- [shrivel](dic://shrivel)
- _n._ [specialist](dic://specialist), [medical specialist](dic://medical specialist)
- _v._ [decrease](dic://decrease), [diminish](dic://diminish), [lessen](dic://lessen), [fall](dic://fall), [move](dic://move), [minify](dic://minify)
- _n._ [stretch](dic://stretch)
	- [condense](dic://condense) 指将东西压缩得更紧密、紧凑，但不失去原有的内容。  
...
- Two years on, those hopes have shrivelled. /两年后，民众对执政联盟越来越失望。
...
shy
- _n._ [throw](dic://throw)
- _v._ [startle](dic://startle), [jump](dic://jump), [start](dic://start), [throw](dic://throw)
- _adj._ [unconfident](dic://unconfident), [timid](dic://timid), [insufficient](dic://insufficient), [deficient](dic://deficient), [wary](dic://wary)
- _n._ [confident](dic://confident), [bold](dic://bold), [sufficient](dic://sufficient), [unwary](dic://unwary)
- [diffident](dic://diffident), [timid](dic://timid), [unsure](dic://unsure)
- **timid**羞怯的;**aloof**冷淡的;**hesitant**踌躇的;**afraid**害怕的;**self-conscious**自觉的;**scared**害怕的;**apprehensive**忧虑的;**wary**机警的;**meek**温顺的;**cocky**自大的;**reluctant**不情愿的, 勉强的;

side
- etc..

sift
- 来自古英语 siftan,筛出，来自 Proto-Germanic*sib,筛，词源同 sieve,seep.引申比喻义筛选，检查等。
- unsifted
- sifting
- sifter
...
- sizzle
	...
	- _v._ [make noise](dic://make noise), [resound](dic://resound), [noise](dic://noise), [seethe](dic://seethe), [boil](dic://boil), [sear](dic://sear), [scorch](dic://scorch)
	- **crackling**轻微的爆裂声;**sausage**香肠;**sparks**无线电通信师;**sparkle**发火花, 闪耀;**ignite**点燃;**steamy**蒸汽的;**searing**灼热的;**scorching**极热的;**fry**油炸, 油煎;**griddle**矿筛;**buzz**发嗡嗡声;
	- _[Sizzling Rice with Seafood](dic://Sizzling%20Rice%20with%20Seafood)_ 三鲜锅巴
	- _[Sizzling Rice Prawns Platter](dic://Sizzling%20Rice%20Prawns%20Platter)_ 锅巴虾铁板
- sizzler
...
- [survey](dic://survey), [resume](dic://resume)
- [cartoon](dic://cartoon)
- [chalk out](dic://chalk out)
- [outline](dic://outline), [adumbrate](dic://adumbrate)
- _n._ [drawing](dic://drawing), [description](dic://description), [summary](dic://summary), [sum-up](dic://sum-up), [wit](dic://wit), [humor](dic://humor), [humour](dic://humour)
- _v._ [draw](dic://draw), [describe](dic://describe), [depict](dic://depict)
	- [draft](dic://draft) 用作动词时指按准确比例设计或打样；作名词时专指精确的草图或草案。  
	- [outline](dic://outline) 主要给出事物要点或轮廓，强调简化了的整体。  
	- [diagram](dic://diagram) 侧重指用图形、图表等来说明。  
	- [plot](dic://plot) 可与draft和diagram换用，但侧重于表示具体的点、面、部分或目标，从而使相互关系以及和整体的关系得以明确。  
	- [sketch](dic://sketch) 指用图、模型或语言描述来表示某一事物的整体情况。  
	- [blueprint](dic://blueprint) 主要指绘制蓝图或制定纲领或规划。这个词引申用来指详细而具体的行动计划。
- **sketchbook**速写集,素描册,速写簿,写生簿;**drawing**图画;**drawings**图纸;**watercolour**水彩;**caricature**漫画;**watercolor**水彩;**doodle**涂鸦;**skit**讽刺文;**illustration**说明;**pencil**铅笔;**cartoon**卡通片，动画片;
	- _sketch map_ 示意图，草图
	- _design sketch_ 设计图
	- _sketch out_ v. 概略地叙述；草拟
	- _sketch in_ 约略地补充
	- _rough sketch_ 草图
	- _sketch book_ 素描簿
	- _sketch design_ 设计草图
	- _freehand sketch_ 徒手画的草图
	- _pencil sketch_ 素描
- sketchy
- sketchpad
- sketching
...
- v. 演练（skit的三单形式）; n. 短剧；小品（skit的复数形式）;
- _n._ [acting](dic://acting), [playing](dic://playing), [playacting](dic://playacting), [performing](dic://performing)
...
- a skit on daytime magazine programmes. /一出针对日间刊行的杂志栏目的幽默小品。
- The comic skit sent up the foolishness of young men in love. /那幅画把沉溺于热恋中的青年男子的痴态勾勒得滑稽可笑。
- skittle
	- [ninepin](dic://ninepin), [skittle pin](dic://skittle pin)
	- _n._ [bowling pin](dic://bowling pin), [pin](dic://pin)
	- _v._ [bowl](dic://bowl)
	- **bowling**滚木球戏;**bowler**投球手;**pickle**腌汁;**alley**小径;**wicket**三柱门;**dart**镖;**darts**射镖游戏;**cricket**蟋蟀;
...
- skittish
	...
	- **timid**羞怯的;**wary**机警的;**frightened**害怕的;**fearful**可怕的;**cautious**谨慎的;**hesitant**踌躇的;**scared**害怕的;**apprehensive**忧虑的;**anxious**渴望的;**terrified**很害怕的,极度惊慌的,吓坏了的;**shy**害羞的;
	- _[excitable skittish](dic://excitable%20skittish)_ 易激动的
...
skull
- skull [skʌl] n.头盖骨；脑壳。它和shell [ʃel] n.贝壳；炮弹，v.剥落（皮）；炮轰，是同源的，只不过不是印欧层面的同源，而是都源自原始日耳曼语，核心含义是to cut。原始印欧语中的sk音在北欧语言中保留，但是在古英语中变成了sh音。维京人入侵英国时杀了不少人，脑袋没掉是head，掉了就是skull。 ​​​​
- thick-skulled
	- _adj._ [stupid](dic://stupid)
	- _n._ [smart](dic://smart)
...
- skullcap
	...
	- **beard**胡须;**scarf**围巾;**headband**头饰带;**helmet**钢盔，头盔;**hat**帽子;**tunic**束腰外衣;**skull**头盖骨，脑壳;**hoodie**冠鸦;**robe**长袍，礼服;**wearing**磨损的;**garb**装束;
	- You're removing part of my skullcap? Do you really have to do that? /你们要切掉我的部分颅骨？一定要这么做？
	- The skullcap, they said, was that of an ape, probably a gibbon, and not of any early human. /他们认为，那块头盖骨是猿猴的，很可能是长臂猿的，根本不是什么早期人类的。
...
- vt. 使变酸；使凝结 
- vi. 变酸；凝结
- [curdle](dic://curdle), [clot](dic://clot)
- [drivel](dic://drivel), [drool](dic://drool), [slaver](dic://slaver), [slobber](dic://slobber), [dribble](dic://dribble)
- _v._ [salivate](dic://salivate)
- all the slabbering you do gets Bobby into some trouble /你那没完的唠叨使鲍比遇到了麻烦。
- his trouser legs were slabbered with mud /他的裤腿上溅了泥巴
- The flavor of **clabber** is unique. The texture is uniform and smooth. The structure is exquisite. The cheese is creamy and thick. /实验室保藏乳酸杆菌的发酵产酸能力一般，此菌发酵所得的凝乳风味独特，质地均匀光滑，组织结构细腻。

slack
- [slump](dic://slump), [drop-off](dic://drop-off), [falloff](dic://falloff), [falling off](dic://falling off)
- [slack water](dic://slack water)
- [mire](dic://mire), [quagmire](dic://quagmire), [quag](dic://quag), [morass](dic://morass)
- [slackness](dic://slackness)
- [slacken](dic://slacken), [slack up](dic://slack up), [relax](dic://relax)
- [slow](dic://slow), [slow down](dic://slow down), [slow up](dic://slow up), [slacken](dic://slacken)
- [slake](dic://slake), [abate](dic://abate)
- [abate](dic://abate), [let up](dic://let up), [slack off](dic://slack off), [die away](dic://die away)
- [loose](dic://loose)
- slake
- [flaccid](dic://flaccid), [lax](dic://lax), [limp](dic://limp)
- [lax](dic://lax)
- _n._ [debris](dic://debris), [dust](dic://dust), [junk](dic://junk), [rubble](dic://rubble), [detritus](dic://detritus), [deterioration](dic://deterioration), [decline in quality](dic://decline in quality)
- _v._ [fiddle](dic://fiddle), [shirk](dic://shirk), [shrink from](dic://shrink from), [goldbrick](dic://goldbrick), [neglect](dic://neglect), [loosen](dic://loosen), [loose](dic://loose)
- _adj._ [lax](dic://lax), [weak](dic://weak), [negligent](dic://negligent)
- _n._ [tense](dic://tense), [strong](dic://strong), [diligent](dic://diligent)
	- [loose](dic://loose) 常用，通俗。指人的精神或东西的松驰。  
	- [slack](dic://slack) 强调缺乏牢固性或稳固性，不坚定。
- **cut**伤口;**loose**不牢固的;**leeway**风压差;**cutting**切断;**lazy**懒惰的;**straighten**弄直;**picking**掘，撬开;**trimming**整理;**pick**挑选;
- _slack off_ 偷懒；懈怠
- _slack season_ 淡季
- _slack wax_ 疏松石蜡；粗蜡
...
- [quench](dic://quench), [allay](dic://allay), [assuage](dic://assuage)
...
- **quench**熄灭;**thirst**口渴;**insatiable**不知足的;**satisfy**令人满意;**lust**性欲;**thirsty**口渴的，口干的;**appease**使平息;**quell**镇压;**appetite**食欲;**arouse**引起;**desire**欲望;
- slake one's lust of blood
- 1. vt. 消除；熄灭；使清凉 vi. （石灰）熟化；消除；平息
- slaker
- slaked lime
- airslake
	- _[airslake](dic://airslake)_  vt. 潮解；风化
- unslaked
- unslaked lime
- slakeless
	- _adj._ 无法消解的,不能满足的
...
- adv. 直接地；猛然地；恰好
- [smack](dic://smack)
- [smack](dic://smack), [smacking](dic://smacking)
- [bang](dic://bang), [slapdash](dic://slapdash), [smack](dic://smack), [bolt](dic://bolt)
- _slap on_ 随便穿上；胡乱涂上；断然拒绝
- _n._ [blow](dic://blow), [bump](dic://bump)
- _v._ [strike](dic://strike)
- **smack**掌击声;**shove**推, 猛推, 乱推;**whack**重打;**punch**按;**rub**擦;**jerk**肌肉抽搐;**stomp**跺;**shake**摇动;**bitch**母狗，母狼;**ass**驴子;**thump**重击;
- The thief ran slap into a policeman. /那小偷与警察撞个满怀。
- This path leads slap to the playground /这条小路直接通到运动场。
- Though heavy fines have been slapped on robocallers in the past /尽管过去也对预录电话发出者处以过高额罚款。
- How do you kids like my drip, it slaps, right? /看我这个搭配怎么样？酷吧？
- slapstick
	- _n._ [comedy](dic://comedy), [acoustic device](dic://acoustic device)
	- _adj._ [humorous](dic://humorous), [humourous](dic://humourous)
	- _n._ [humorless](dic://humorless), [humourless](dic://humourless), [unhumorous](dic://unhumorous)
	- **comedic**喜剧的;**comedy**喜剧;**comical**滑稽的，好笑的;**gags**塞口物;**silliness**愚蠢;**comedies**喜剧;**melodrama**情节剧;**humour**诙谐;**humor**幽默，诙谐;**light-hearted**轻松的;**satire**讽刺;
	- _slapstick comedy_ 闹剧；低级喜剧
- slapping
- slapman
- slapjack
	- _[slapjack](dic://slapjack)_  n. 薄煎饼；一种纸牌游戏
	- _[Slapjack spinebuster](dic://Slapjack%20spinebuster)_ 千斤脊背炸弹摔; 千斤顶脊违枪榴弹摔; 
	- _[chapatty hot cake slapjack](dic://chapatty%20hot%20cake%20slapjack)_ 薄煎饼
	- blackjack
		- _n._ [scrub oak](dic://scrub oak), [bludgeon](dic://bludgeon), [flag](dic://flag), [card game](dic://card game), [cards](dic://cards)
		- _v._ [influence](dic://influence), [act upon](dic://act upon), [work](dic://work)
		- **poker**纸牌戏;**roulette**轮盘赌;**casino**娱乐场;**casinos**乡间住宅;**gambling**赌博;**gambler**赌徒;**bingo**宾戈游戏;**gamblers**赌徒;**betting**打赌;**wagering**赌注;**wager**赌博;
- slaphappy
	- _adj._ 〈美俚〉头昏眼花的,愚蠢的,轻率的
	- _adj._ [irresponsible](dic://irresponsible), [confused](dic://confused)
	- _n._ [responsible](dic://responsible), [clearheaded](dic://clearheaded), [clear-thinking](dic://clear-thinking)
	- **wacky**乖僻的，古怪的;**goofy**傻瓜的，愚笨的;**manic**狂热的;**drunken**喝醉的;**frenetic**狂热的;**giddy**头晕的;**rowdy**吵闹的;**raucous**沙哑的;**boisterous**热闹的;**cranky**暴躁的;**silliness**愚蠢;
- slapdash
	- [haphazard](dic://haphazard), [slipshod](dic://slipshod), [sloppy](dic://sloppy)
	- [slam-bang](dic://slam-bang)
	- [bang](dic://bang), [slap](dic://slap), [smack](dic://smack), [bolt](dic://bolt)
	- _dj._ [careless](dic://careless)
	- _n._ [careful](dic://careful)
	- **shoddy**劣质的;**sloppy**草率的;**clumsy**笨拙的;**disjointed**脱离开的,不连贯的;**inept**不适当的;**contrived**不自然的;**hasty**匆忙的;**careless**粗心的;**crass**粗鲁的;**hastily**匆忙地;**messy**肮脏的，污秽的;
	- _[slapdash slipshod](dic://slapdash%20slipshod)_ 马虎的
	- _[selectirelationshiprless slapdash sloppy](dic://selectirelationshiprless%20slapdash%20sloppy)_ 粗枝大叶
- slap-up
	- _adj._ [good](dic://good)
	- _n._ [bad](dic://bad)
	- **marvellous**惊奇的;**ready-made**现成的;**assemblage**聚集;**splendid**辉煌的;**meal**一餐，一顿饭;**likewise**也;**sustenance**食物;**supper**晚餐，晚饭;**sumptuous**豪华的, 奢侈的;**nigh**近于;**first-rate**第一流的,最佳的;
	- _[lap up](dic://lap%20up)_  舔食；欣然接受
	- _[snap up](dic://snap%20up)_  抢购; 争购; 锁键调节式; 争相; 
	- _[clap up](dic://clap%20up)_  挂上; 那两人匆匆订了合同; 
	- _[slipping up](dic://slipping%20up)_  蹉跌
	- _[clapped up](dic://clapped%20up)_  匆忙议定
	- _[stap up](dic://stap%20up)_  不睡觉
	- _[Lap up](dic://Lap%20up)_  欣然接受; 舔; 舔食; 引起; 
	- _[slip up](dic://slip%20up)_  跌倒; 出错; 出差错; 疏忽;
- slap-bang
- backslap
...
- slavish
	...
	- abjectly submissive; characteristic of a slave or servant
		...
		- _synonymous：_ [subservient](dic://subservient), [submissive](dic://submissive)
	...
	- _[slavish copy](dic://slavish%20copy)_  依样画葫芦的摹写
	- _[slavish devotion to a leader](dic://slavish%20devotion%20to%20a%20leader)_ 对领导的盲目崇拜
	- a slavish translation /刻板的翻译
	- Here's Caravaggio's response to the slavish copying of the classics. /这就是卡瓦拉乔对古典作品泛滥模仿的一种回应。
- slavocracy
- unsalved
- etc..
...
sleigh
- [sled](dic://sled), [sledge](dic://sledge)
- _n._ [vehicle](dic://vehicle)
- _v._ [ride](dic://ride)
- **reindeer**驯鹿;**sled**雪橇;**snowmobile**摩托雪橇;**Santa**圣诞老人;**snowman**雪人;**elves**侏儒;**carriage**四轮马车;**chariot**二轮战车;**elf**小精灵;**Christmas**圣诞节;**moose**驼鹿;
- _[bob sleigh](dic://bob%20sleigh)_  二橇拖材车
- _[sleigh ride](dic://sleigh%20ride)_  乘雪橇
- _[sleigh car](dic://sleigh%20car)_  雪橇车
- _[sleigh bells](dic://sleigh%20bells)_  雪橇铃（系于雪橇或拖雪橇之鹿上的小铃）（sleigh bell的复数）
- They travelled across the snow in a sleigh. /他们乘着雪橇在雪地上穿行。
- According to folklore, Santa Claus' sleigh is pulled by eight flying reindeer. /民间传说，圣诞老人的雪橇是由八只会飞的驯鹿拉着的。

sleuth
- n. 警犬, 侦探  vi. 做侦探
- 来自古诺斯语 sloth,足迹，踪迹，词源不详。可能来自辅音丛 sl-,砍，劈，分开。引申比喻义侦查，调查，侦探等。
- [sleuthhound](dic://sleuthhound)
- [spy](dic://spy), [stag](dic://stag), [snoop](dic://snoop)
- _n._ [detective](dic://detective)
- _v._ [monitor](dic://monitor), [supervise](dic://supervise), [ride herd on](dic://ride herd on)
- **detective**侦探;**investigator**调查者;**mystery**神秘，秘密;**sidekick**伙伴,插袋;**mysteries**古代的秘密宗教仪式;**spy**侦察;**cop**抓住;**intrepid**无畏的;**archaeologist**考古学家;**novelist**小说家;**socialite**社会名流;
...
- slither
	...
	- a slither of bacon. /一片火腿
	- He slithered helplessly down the slope /他控制不住地滑下了坡。
	- slithery
- sliding
- slider
- slideback
- slidden
	- _[slIdden cardiac death](dic://slIdden%20cardiac%20death)_ 心脏性猝死
- slid
- microslide
	- _[microslide](dic://microslide)_  显微镜玻片
- landslide
- downslide
	- _[downslide](dic://downslide)_  n. 工商业下降；行市下跌
	- Price is on **downslide** /价格剧降。
- backslide
	- _vi._ 滑坡，倒退，退步；故态复萌
	- _v._ [slip](dic://slip), [drop off](dic://drop off), [drop away](dic://drop away), [fall away](dic://fall away)
	- **relapse**再度堕落;**repent**忏悔;**complacency**自满;**repentance**悔悟;**rut**车辙;**complacent**满足的;**stagnation**停滞;**downward**向下的，下降
	- He has the chance to stop Guatemala's democratic backslide. /他有机会阻止危地马拉的民主倒退。
	- And if there is backsliding, there will be no deal /如果其间有反复，协议也就不复存在了。
	- backslidden
	- backslid
...
-  [splinter](dic://splinter)
-  [paring](dic://paring), [shaving](dic://shaving)
- _n._ [bit](dic://bit), [chip](dic://chip), [flake](dic://flake), [fleck](dic://fleck), [scrap](dic://scrap), [fragment](dic://fragment)
- _v._ [divide](dic://divide), [split](dic://split), [split up](dic://split up), [separate](dic://separate), [dissever](dic://dissever), [carve up](dic://carve up), [break up](dic://break up)
- **glimmer**微光;**slice**薄片;**chunk**大块;**tiny**微小的;**swath**细长的列;**minuscule**小写字;**expanse**宽阔的区域;**portion**部分;**nugget**天然金块，矿块;**scant**不足的;**teeny**极小的;
...
- [dense](dic://dense), [dim](dic://dim), [dull](dic://dull), [dumb](dic://dumb), [obtuse](dic://obtuse)
-  [boring](dic://boring), [deadening](dic://deadening), [dull](dic://dull), [ho-hum](dic://ho-hum), [irksome](dic://irksome), [tedious](dic://tedious), [tiresome](dic://tiresome), [wearisome](dic://wearisome)
- [dull](dic://dull), [sluggish](dic://sluggish)
- [slowly](dic://slowly), [easy](dic://easy), [tardily](dic://tardily)
- [behind](dic://behind)
- _v._ [decrease](dic://decrease), [diminish](dic://diminish), [lessen](dic://lessen), [fall](dic://fall), [weaken](dic://weaken), [decelerate](dic://decelerate), [slow down](dic://slow down)
- _adj._ [bumper-to-bumper](dic://bumper-to-bumper), [dilatory](dic://dilatory), [laggard](dic://laggard), [poky](dic://poky), [pokey](dic://pokey), [dragging](dic://dragging), [drawn-out](dic://drawn-out)
- _n._ [fast](dic://fast), [smart](dic://smart), [interesting](dic://interesting), [active](dic://active)
- **sluggish**萧条的;**fast**快速的，迅速的;**rapid**迅速的，急促的;**painfully**痛苦地;**steady**稳定的;**pace**步速;**accelerate**加快, 增速;**gradual**逐渐的;**speed**加速，迅速前行;**faster**更快的;**accelerated**加速的;

slog
- work doggedly or persistently
	- [plug away](dic://plug away), [peg away](dic://peg away), [keep one's nose to the grindstone](dic://keep one's nose to the grindstone), [keep one's shoulder to the wheel](dic://keep one's shoulder to the wheel)
- walk heavily and firmly, as when weary, or through mud
	-  [footslog](dic://footslog), [plod](dic://plod), [trudge](dic://trudge), [pad](dic://pad), [tramp](dic://tramp)
- strike heavily, especially with the fist or a bat
	- [slug](dic://slug), [swig](dic://swig)
- _v._ [work](dic://work), [walk](dic://walk), [hit](dic://hit)
- **tedious**冗长乏味的;**arduous**费力的;**tiring**麻烦的;**wade**跋涉;**grueling**惩罚;**uphill**上坡的，向上的;**tiresome**烦人的，无聊的;**exhausting**使耗尽的;**laborious**勤劳的;**bogged**陷于泥沼的;**dreary**沉闷的，枯燥的;
- it would be a hard slog back to the camp /走回营地将是一段艰苦的跋涉。
- a slog hit the fielder on the helmet. /一记大力击球打在了外场球员的防护帽上。
- slogger
	- n. 猛击者；乱打者；勤劳的工作者
	- [trudger](dic://trudger), [plodder](dic://plodder)
	- [plodder](dic://plodder)
	- [slugger](dic://slugger)
	- _n._ [pedestrian](dic://pedestrian), [walker](dic://walker), [footer](dic://footer), [hack](dic://hack), [drudge](dic://drudge), [hacker](dic://hacker), [boxer](dic://boxer)
- footslog
...
- _v._ [eat](dic://eat) **gulp**狼吞虎咽地吃;**sip**抿;**mouthful**一口，满口;**lick**舔;**spit**吐口水;**nibble**细咬;**spoonful**一匙;**swallow**燕子;**suck**吸吮;**chew**咀嚼;**sucking**授乳的;
...
snib
- n. 插销 vt. 插上插销
- _[bolt latch snib](dic://bolt%20latch%20snib)_ 门闩

snell
- _[snell](dic://snell)_  n. 系钩线; adj. 精明的；敏捷的; n. (Snell)人名；(匈)什内尔；(英、德、芬、瑞典)斯内尔; 
- _[snell law](dic://snell%20law)_  斯内尔定律
...
- _[soggy bread](dic://soggy%20bread)_ 未烤透的面包；受潮的面包；水泡的面包

sooth
- _n._ [truthfulness](dic://truthfulness)
- **soothe**安慰;**nourish**滋养;**relieve**解除，减轻;**rejuvenate**使变得年轻, 使恢复活力;**calm**静的，平静的;**pamper**纵容;**appease**使平息;**irritate**激怒;**calming**平静的;**soften**使变柔软;**stimulate**刺激;
- soothsaying
- soothsayer
	- _n._ [visionary](dic://visionary), [illusionist](dic://illusionist), [seer](dic://seer)
	- **oracle**神谕;**prophet**先知;**prophecy**预言;**astrologer**占星家;**magician**魔术师，变戏法的人;**prophetic**预言的,先知的;**mystic**神秘的;**shaman**萨满教的道士;**pundit**博学者;**prediction**预言;**sage**圣人;
- soothfast
	- 忠实的,可靠的,真实的
- soothe
	...
	- soothing
	- soother
		- _[soother](dic://soother)_  n. 抚慰者；橡皮奶头；修光工具
		- _[joint soother](dic://joint%20soother)_  关节舒缓药
		- _[soother r](dic://soother%20r)_ 抚慰者
		- _[soother detail](dic://soother%20detail)_ 抚慰者
...
- _n._ [reputable](dic://reputable), [incorrupt](dic://incorrupt), [clean](dic://clean), [unacquisitive](dic://unacquisitive)
- **scandalous**令人反感的;**shameful**可耻的;**seedy**多种子的;**sleazy**质地薄的;**ghastly**可怕的;**depraved**堕落的;**vile**卑鄙的;**disgraceful**可耻的,丢脸的,不光彩的;**gruesome**可怕的;**despicable**可鄙的,卑鄙的;**nefarious**极坏的;
- _[sordid merchant](dic://sordid%20merchant)_  唯利是图的人; 市侩;
- _[sordid sixteen](dic://sordid%20sixteen)_ 污秽十六
- _[living in sordid poverty](dic://living%20in%20sordid%20poverty)_ 过着潦倒的生活
- _[lofty sordid](dic://lofty%20sordid)_ 高尚的
- _[sordid honor](dic://sordid%20honor)_ 肮脏
- _[sordid past](dic://sordid%20past)_ 肮脏的过去
- _[sordid noble](dic://sordid%20noble)_ 低贱的
...
- _adj._ [dependable](dic://dependable), [good](dic://good), [safe](dic://safe), [secure](dic://secure), [healthy](dic://healthy), [solid](dic://solid), [stable](dic://stable)
- _n._ [silence](dic://silence), [quiet](dic://quiet)
- _n._ [unsound](dic://unsound), [unreasonable](dic://unreasonable), [unhealthy](dic://unhealthy), [invalid](dic://invalid), [unrighteous](dic://unrighteous), [shallow](dic://shallow), [incomplete](dic://incomplete)
...
- **noises**噪音，响声，噪音;**audio**声音的;**muffled**听不清的;**audible**听得见的;**noise**响声;**sonic**音速的;**acoustics**音响;**loud**大声的，高声的;**stereo**立体声;**aural**耳的;**hear**听到, 听见;
- unsounded
- unsound
	- _adj._ [deep](dic://deep), [inaudible](dic://inaudible), [unhearable](dic://unhearable)
	- _n._ [shallow](dic://shallow), [audible](dic://audible), [hearable](dic://hearable)
	- **melancholy**忧郁, 悲哀;**echoing**回音;
	- _unsounded_  adj. 未经探测的，深度未明的；不发音的
	- unsoundness
- ultrasound
- supersound
- soundtrack
...
- resound
	...
	- resouding
		...
		- **emphatic**加强语气的;**unequivocal**只有一种含意的;**rousing**活泼的;**deafening**震耳欲聋的;**triumphant**胜利的, 成功的;**thumping**巨大的;**triumph**胜利，凯旋;**unanimous**全体一致的;**emphatically**断然地;**answer**符合;**overwhelmingly**压倒地;
		- _[resounding defeat](dic://resounding%20defeat)_ 彻底的失败
		- _[resounding echoes](dic://resounding%20echoes)_ 洪大的回声
		- _[front-page resounding](dic://front-page%20resounding)_ 轰动的
		- _[Resounding Silence](dic://Resounding%20Silence)_ 轰然静寂
		- _[Resounding Break](dic://Resounding%20Break)_ 余音未歇
- Soundex
- sounder
- soundboard
- soundbite
...
- n. 斯百克填料(一种抹墙粉的商标名)  
- vt. 以斯百克填料涂
- _n._ [plaster](dic://plaster)
- **drywall**纸面石膏板;**putty**油灰;**sealant**密封剂;**glue**粘合;**paint**油漆;**plaster**灰泥;**grout**用薄泥浆填塞;**epoxy**环氧的;**sanding**砂纸打磨;**stucco**粉饰，粉刷;**patching**修补;
- Do you remember which part of the wall is not spackle? /你记得哪面墙壁没补过吗？
- He planed the projected paint and **spackle** off the wall. /他把原来的油漆和抹墙粉从墙上刨掉了。

spar
- _n._ 圆材
- _vi._ (拳击练习中)不用力打, 试击; 争论, 争吵
...
sparta
-  古希腊城邦，Laconia 王国首府，人民以崇尚简朴，勇猛好战，说话简洁，国家实行军事化管理著称。名字可能来自希腊语 sparte,绳子，草绳，来自 PIE*sper,编织，词源同 spiral.据说斯巴达人投草为界，并以此为城。实际上，斯巴达也是既没有城墙，也没有像样的街道。参照百度百科及电影《斯巴达 300 勇士》。
...
- Spartan
	...
	- _adj._ [Sparta](dic://Sparta), [resolute](dic://resolute), [nonindulgent](dic://nonindulgent), [strict](dic://strict), [abstemious](dic://abstemious)
	- _n._ [irresolute](dic://irresolute), [indulgent](dic://indulgent), [gluttonous](dic://gluttonous)
	- **Athenian**雅典的;**Sparta**斯巴达;**Titan**泰坦，巨人;**Hellenic**希腊的;**Olympian**威严的;**Troy**特洛伊;**Brutus**布鲁特斯;**Athena**雅典娜;**Zeus**宙斯;**Greek**希腊语;**warrior**战士，勇士;
...
- _n._ [arachnid](dic://arachnid), [arachnoid](dic://arachnoid), [program](dic://program), [programme](dic://programme), [computer program](dic://computer program), [computer programme](dic://computer programme), [frying pan](dic://frying pan)
- **wasp**黄蜂;**insect**昆虫;**snake**蛇;**ant**蚂蚁;**frog**青蛙;**caterpillar**毛虫;**lizard**蜥蜴;**wasps**黄蜂;**butterfly**蝴蝶;**beetle**甲虫;**worm**虫，蠕虫;
- spidery
- spiderwort
	- _n._ [herb](dic://herb), [herbaceous plant](dic://herbaceous plant)
...
-  [twirl](dic://twirl), [twist](dic://twist), [twisting](dic://twisting), [whirl](dic://whirl)
-  [tailspin](dic://tailspin)
-  [spin around](dic://spin around), [whirl](dic://whirl), [reel](dic://reel), [gyrate](dic://gyrate)
- [whirl](dic://whirl), [birl](dic://birl), [twirl](dic://twirl)
- [spin out](dic://spin out)
- _n._ [rotation](dic://rotation), [revolution](dic://revolution), [gyration](dic://gyration), [rotary motion](dic://rotary motion), [drive](dic://drive), [ride](dic://ride), [acrobatics](dic://acrobatics)
- v._ [revolve](dic://revolve), [go around](dic://go around), [rotate](dic://rotate), [stream](dic://stream), [well out](dic://well out), [circumvolve](dic://circumvolve), [fabricate](dic://fabricate)
- **spinning**纺纱;**spinner**纺纱工人;**twist**捻;**spinners**纺织者，纺纱机;**whirl**旋转，回旋;**wobble**摇晃;**bounce**弹力;**swirl**漩涡;**rotating**旋转的;**toss**投掷;**weave**编织;
- _spin in_ 上床；睡午觉
- _spin off_ 副产品；创造新的事物而不影响原物的大小（稳定性）；甩掉
- _spin coating_ 旋转涂布
- _high spin_ 高自旋
- _spin up_ [天文学]自旋向上；加快自旋
- word-spinning
- tailspin
- spinster
	- n. 老姑娘；未婚女人
...
- _[splinting](dic://splinting)_  v. 用夹板固定（断肢）（splint 的现在分词）
- _[splints](dic://splints)_  n. [医] 夹板（splint的复数）；碎钻石; v. 用夹板固定（splint的第三人称单数形式）; 
- _[wooden splint](dic://wooden%20splint)_  木夹板
- _[back splint](dic://back%20splint)_  背夹
- wiresplint
- splinter
...
- 由英国 20 世纪喜剧家 Arthur Roberts 杜撰，原为一种酒吧赌胆量猜硬币游戏。可能来自拟声构词，模仿虚张声势的声音。比较 bluff,吓唬，愚弄，虚张声势。后用于指讽刺剧或滑稽模仿剧。
- spoofing
- spoofer 
	- n. 哄骗者, 幽默讽刺诗文的作者
...
- _[get one's spunk up](dic://get%20one%27s%20spunk%20up)_ 发怒 
- In the booth, her creativity in spunk knew no bounds /录音棚里 她给角色的勇敢带来了无穷无尽的创造力。
- I wouldn't give a dern for spunk–water." " You wouldn't, wouldn't you? /我不会在乎仙水。” “你不会，不是吗？
- That is, unless the man has spunK that's liKe the rOtten egg buffet /精液却有像烂鸡蛋般的怪味。
- Reagan said he lacked spunk; and his talk of " Big Mo" and " kicking ass" on the campaign trail often ended in retreat. /里根说他缺乏勇气；而他在竞选过程中的“大动作”和“大承诺”的言论大都以退却告终。
- I admired her independence and her **spunk** /我敬佩她的独立精神和她的勇气。
- spunky
	...
	- a spunky performance. /一次大胆的表演。
	- a top chick with a spunky boyfriend. /一个拥有性感男友的绝色少女。
...
- _n._ [encouragement](dic://encouragement), [projection](dic://projection), [plant process](dic://plant process), [enation](dic://enation), [prod](dic://prod), [goad](dic://goad), [line](dic://line)
- _v._ [promote](dic://promote), [advance](dic://advance), [boost](dic://boost), [further](dic://further), [encourage](dic://encourage), [strike](dic://strike), [goad](dic://goad)
- **impetus**促进;**stifle**使窒息;**stimulate**刺激;**pave**铺设;**accelerate**加快, 增速;**curb**抑制;**encourage**鼓励, 激励;**curtail**截断, 缩短;
	- _spur gear_ n. [机]正齿轮
	- _spur on_ 驱使；鼓励；飞驰
	- _spur dike_ 丁坝；排水坝；挑水坝
...
- [staff](dic://staff)
- [lag](dic://lag)
- [rung](dic://rung), [round](dic://round)
- _n._ [musical notation](dic://musical notation), [slat](dic://slat), [spline](dic://spline), [crosspiece](dic://crosspiece)
- _v._ [equip](dic://equip), [fit](dic://fit), [fit out](dic://fit out), [outfit](dic://outfit), [burst](dic://burst), [split](dic://split), [break open](dic://break open)
...
stent
- **catheter**导管;**prosthesis**弥补;**cannula**套管，插管;**implantation**培植,灌输;**stenosis**狭窄;**implant**灌输;**suture**缝合;**aneurysm**动脉瘤;**aorta**主动脉;**artery**动脉;**coronary**冠状的;
- _n._ [tube](dic://tube), [tubing](dic://tubing)
- _[eluting stent](dic://eluting%20stent)_  洗脱支架
- _[ureteral stent](dic://ureteral%20stent)_  输尿管展伸器
...
stink
- [malodor](dic://malodor), [malodour](dic://malodour), [stench](dic://stench), [reek](dic://reek), [fetor](dic://fetor), [foetor](dic://foetor), [mephitis](dic://mephitis)
- [smell](dic://smell), [odor](dic://odor), [odour](dic://odour), [olfactory sensation](dic://olfactory sensation), [olfactory perception](dic://olfactory perception)
...
- unstrap
	...
	- Here, hold my hoops while I unstrap the pistol on my shoe /来 拿着我耳环我把脚踝上的枪解下来。
- understrapper
- strapwork
- strapping
	- adj. 魁梧的，高大健壮的 
...
- strap-laid
- lap-strap
	- **podium**讲台;**snuggle**依偎;**sprint**冲刺，全速跑;**race**种族，人种;**seat**座位;**cuddle**拥抱;**sitting**入席，就坐;**sit**坐;**pole**杆;
- jockstrap
- bootstrap, bootstrapping
	- **startup**启动;**Bayesian**贝叶斯定理的;
...
- [heavy](dic://heavy), [lowering](dic://lowering), [threatening](dic://threatening)
- _[sullen economy](dic://sullen%20economy)_ 经济萧条
- _[affability sullen](dic://affability%20sullen)_ 和蔼的
- _[a sullen face](dic://a%20sullen%20face)_ 愠怒的面容
- _[a sullen sky](dic://a%20sullen%20sky)_ 阴沉的天空
sully
- vt. 玷污；使丢脸 n. 污点，损伤
- [defile](dic://defile), [corrupt](dic://corrupt), [taint](dic://taint), [cloud](dic://cloud)
- [tarnish](dic://tarnish), [stain](dic://stain), [maculate](dic://maculate), [defile](dic://defile)
- [defame](dic://defame), [slander](dic://slander), [smirch](dic://smirch), [asperse](dic://asperse), [denigrate](dic://denigrate), [calumniate](dic://calumniate), [smear](dic://smear), [besmirch](dic://besmirch)
- **tarnish**晦暗;**discredit**败坏…的名声;**smear**涂抹;**ruin**毁坏;**ruining**废墟;**disgrace**耻辱;**embarrass**使窘迫;**mar**损伤;**tainted**污染的;**undermine**在某物下挖洞或挖通道;**detract**转移，使分心;
- _[sully the nme](dic://sully%20the%20nme)_ 玷污了
...
sullage
- _[municipal sullage](dic://municipal%20sullage)_ 市政污泥
...
- **blond**金发的;**ere**在…以前;
- swarthy
	- [dark-skinned](dic://dark-skinned), [dusky](dic://dusky), [swart](dic://swart)
	- _adj._ [brunet](dic://brunet), [brunette](dic://brunette)
	- _n._ [blond](dic://blond), [blonde](dic://blonde), [light-haired](dic://light-haired)
...
- [swagger](dic://swagger), [bluster](dic://bluster)
- _n._ [wave](dic://wave), [moving ridge](dic://moving ridge)
- _v._ [travel](dic://travel), [go](dic://go), [move](dic://move), [locomote](dic://locomote), [scatter](dic://scatter), [sprinkle](dic://sprinkle), [dot](dic://dot)
- **buckles**带扣;**buckle**扣住;
- he water swashed and rippled around the car wheels /水在车轮附近飞溅。
- Slowly, slowly. Don't **swash** the soup. /慢一点，别把汤溅出来。
- swish-swash
- swashbuckle
	- swashbuckling
	- swashbuckler
...
sway
-  [rock](dic://rock), [shake](dic://shake)
- [carry](dic://carry), [persuade](dic://persuade)
- [power](dic://power), [powerfulness](dic://powerfulness), [lurch](dic://lurch), [pitch](dic://pitch), [pitching](dic://pitching)
- [move back and forth](dic://move back and forth), [influence](dic://influence), [act upon](dic://act upon), [work](dic://work), [move](dic://move), [displace](dic://displace)
- **hold**持有;**influence**影响;**shake**摇动;**topple**倾倒;**exert**运用，发挥;**tilt**倾斜;**swing**摇摆;**persuade**说服，劝说;**steer**驾驶;**overturn**推翻;**bend**使弯曲;
- unswayed
- swayback
...
swivel
- 来自古英语 swifan,旋转，转动，来自 Proto-Germanic*swif,旋转，来自 PIE*swei,弯，转，摇摆，词源同 swing,sweep.-el,工具格后缀。
-  [pivot](dic://pivot)
- _n._ [coupling](dic://coupling), [coupler](dic://coupler)
- _v._ [turn](dic://turn)
- **detachable**可分开的，可拆开的;**adjustable**可调整的;**retractable**可收回的，可撤消的，可缩回的，可缩进的;**tilting**倾卸台;**tilt**倾斜;**angled**成角的;**tripod**三脚架;**recline**依赖;**pivot**枢轴;**sling**投掷;**chair**椅子;
- _swivel chair_ n. 转椅
- _swivel joint_ [机]回转接头；旋转管接头
- slued the swivel chair around /旋转转椅
- She returned to the swivel chair behind her desk. /她回到桌子后面的转椅上。
- They reeled, whirled, swiveled, flounced, capered, gamboled, and spun. /他们旋转、回旋、转圈、跳动、雀跃、嬉戏，再旋转。
- swivelase
- swivel-eyed
- swivel-eye
...
## T
tamp  (tamp, temper, tamper, temping, tempt,)
...
- tamping
- tampicin
- tamper  (tamp, temper, tamper, temping, tempt,)
	- **interfere**干预;**sabotage**妨害;**manipulate**熟练控制;**proof**证明;**destroy**毁坏;**circumvent**设法克服或避免;**tarnish**晦暗;
	- [manipulate](dic://manipulate), [intervene](dic://intervene), [step in](dic://step in), [interfere](dic://interfere), [interpose](dic://interpose)
...
- entangle
	-  [mire](dic://mire)
	-  [tangle](dic://tangle), [mat](dic://mat), [snarl](dic://snarl)
	- _v._ [involve](dic://involve), [twist](dic://twist), [twine](dic://twine), [distort](dic://distort)
	- _n._ [disentangle](dic://disentangle), [unsnarl](dic://unsnarl), [straighten out](dic://straighten out)
	- **tangle**混乱状态;**tangled**纠缠的;**unravel**解开;**bind**捆绑, 捆扎;**obstruct**阻塞;**complicate**使复杂化;**injure**伤害，损害;**hinder**成为阻碍;**weaken**减少;**threaten**威胁;**confuse**使混乱;
	- The difficult problem present by him entangle the conferee /他所提出的问题使与会人士感到困惑。
	- nuclear matters are often entangled in a web of secrecy and misinformation. /核事件常与秘闻和假情报纠缠在一起。
	- unentangle
	- entanglement
	- disentangle
...
- [prostitute](dic://prostitute), [cocotte](dic://cocotte), [whore](dic://whore), [harlot](dic://harlot), [bawd](dic://bawd), [cyprian](dic://cyprian), [fancy woman](dic://fancy woman), [working girl](dic://working girl), [sporting lady](dic://sporting lady), [lady of pleasure](dic://lady of pleasure), [woman of the street](dic://woman of the street)
-  [lemony](dic://lemony), [lemonlike](dic://lemonlike), [sourish](dic://sourish), [tangy](dic://tangy)
- [sharp](dic://sharp), [sharp-worded](dic://sharp-worded)
- _n._ [woman](dic://woman), [adult female](dic://adult female), [pie](dic://pie), [pastry](dic://pastry)
- _adj._ [sour](dic://sour), [unpleasant](dic://unpleasant)
- _n._ [sweet](dic://sweet), [pleasant](dic://pleasant)
- **tangy**有刺激性的;**fruity**有果味的;**cheesecake**奶酪蛋糕;**rhubarb**大黄;**cherries**樱桃;**custard**蛋奶糊,牛奶沙司;**meringue**调合蛋白;**pear**梨树;**pie**馅饼;**apricot**杏树;**savory**可口的;
- _egg tart_ 蛋挞，蛋塔
- tartness
	- [sour](dic://sour), [sourness](dic://sourness)[sour](dic://sour), [sourness](dic://sourness)
	- [acerbity](dic://acerbity)
	-  [bitterness](dic://bitterness), [acrimony](dic://acrimony), [acerbity](dic://acerbity), [jaundice](dic://jaundice), [thorniness](dic://thorniness)
	- _n._ [taste](dic://taste), [taste sensation](dic://taste sensation), [gustatory sensation](dic://gustatory sensation), [taste perception](dic://taste perception), [gustatory perception](dic://gustatory perception), [sourness](dic://sourness), [sour](dic://sour)
	- **sweetness**美味;**tangy**有刺激性的;**acidity**酸度;**mouthfeel**口感;**aftertaste**回味;**bitterness**苦味;**flavor**滋味;**fruity**有果味的;**malty**麦芽的;**citrus**柑橘属果树;**carbonation**碳酸饱和,碳酸化作
- tartly
- tartlet
...
tax
- taxing
	-  [burdensome](dic://burdensome), [onerous](dic://onerous)
	- _adj._ [heavy](dic://heavy)
	- _n._ [light](dic://light)
	- **taxation**课税，征税;**burdensome**繁重的,烦累的,难以承担的;**onerous**繁重的;**punishing**十分吃力的;**exhausting**使耗尽的;**levy**征收;**draining**排水;**imposing**壮观的;**spending**开销;**excise**货物税;**tiring**麻烦的;
- etc..
...
tedium
-  [boredom](dic://boredom), [ennui](dic://ennui)
-  [tediousness](dic://tediousness), [tiresomeness](dic://tiresomeness)
- _n._ [dissatisfaction](dic://dissatisfaction), [dullness](dic://dullness)
- **boredom**厌倦;**tedious**冗长乏味的;**monotonous**无变化的, 单调乏味的;**tiresome**烦人的，无聊的;**slog**猛击;**futility**无用;**agony**极大的痛苦;**toil**苦工;**frustration**挫折;**excruciating**极为疼痛的;**silliness**愚蠢;
- tedious
...
-  [parsimony](dic://parsimony), [parsimoniousness](dic://parsimoniousness), [penny-pinching](dic://penny-pinching)
- _n._ [subshrub](dic://subshrub), [suffrutex](dic://suffrutex), [frugality](dic://frugality), [frugalness](dic://frugalness)
- **antique**古老的，年代久远的;**consignment**托付货物;**store**储备，贮藏;**vintage**收获;**flea**跳蚤;**shop**商店;**dresser**梳妆台;**secondhand**旧的;**Kmart**凯马特;**grocery**食品杂货店;**bookstore**书店;
- _[thrift store](dic://thrift%20store)_  二手店
- _[thrift institution](dic://thrift%20institution)_  储蓄机构
- unthrifty
- thrifty
- thriftless
- thriftily
...
-  [multitude](dic://multitude), [concourse](dic://concourse)
-  [mob](dic://mob), [pack](dic://pack), [pile](dic://pile), [jam](dic://jam)
- _n._ [gathering](dic://gathering), [assemblage](dic://assemblage)
- _v._ [crowd](dic://crowd), [crowd together](dic://crowd together)
- **crowd**群众，一伙;**crowds**人群;**hordes**游牧部落;**teeming**多产的，丰富的;**flocked**成群而行;**adoring**崇拜的;**crowded**拥挤的;**commotion**暴乱;**flock**群;**horde**游牧部落;**frenzied**狂乱的;
- _[ascend the throng](dic://ascend%20the%20throng)_ 登基
- _[throng into](dic://throng%20into)_ 拥进
- _[stampede throng](dic://stampede%20throng)_ 蜂拥
- _[to throng](dic://to%20throng)_ 蜂拥
- _[throng in](dic://throng%20in)_ 拥进
- _[patter throng](dic://patter%20throng)_ 人们发出急促的声响; 急促的人群; 
- _[jostling throng](dic://jostling%20throng)_ 摩肩接踵
- _[throng out](dic://throng%20out)_ 拥出
...
- a throng of cats and kittens mewing to be fed. /一群喵喵待喂的大小锚
...
- Too few shows are " Strictly" style hits; too many are tosh /有几个节目像“舞动奇迹”一样热门；大多数节目都在胡说八道。
...
- [column](dic://column), [pillar](dic://pillar)
- [tugboat](dic://tugboat), [tug](dic://tug), [towboat](dic://towboat)
- [loom](dic://loom), [predominate](dic://predominate), [hulk](dic://hulk)
- _n._ [structure](dic://structure), [construction](dic://construction), [shape](dic://shape), [form](dic://form), [boat](dic://boat)
- _v._ [rise](dic://rise), [lift](dic://lift), [rear](dic://rear)
- **skyscraper**摩天大楼;**spire**尖塔;**dome**圆屋顶;**building**建筑;**castle**城堡;**fortress**要塞;**tallest**最高的;**high-rise**有多层的;**citadel**城堡;**turret**角楼;**lighthouse**灯塔;
- towering ambition /远大的抱负。
- a towering intellect. /杰出的知识分子
- He was in a towering rage /他在大发雷霆。
- the tower is the centrepiece of the park. /这座塔是公园里最引人注目的东西。
- the ivory tower of academia. /学术界的象牙塔。
- a tower overlooking the city /俯瞰全市的塔楼
- Suppose that he builds some elaborate tower /假设他搭了座很精致的塔。
- The barrier included guard towers placed along large concrete walls. /障碍包括大型混凝土墙，并在其旁边设立警卫塔。
- and exposes a tower of fairy shrimp samples. /并露出一架子的仙女虾样本。
- watchtower
- towery
	- - adj. 高耸的；有塔的
	- 
...
- [fishnet](dic://fishnet), [fishing net](dic://fishing net), [pothook](dic://pothook), [restraint](dic://restraint), [constraint](dic://constraint)
- [capture](dic://capture), [catch](dic://catch), [control](dic://control), [hold in](dic://hold in), [hold](dic://hold), [contain](dic://contain), [check](dic://check)
- **shackles**手铐，脚镣;
- _[trammels](dic://trammels)_  n. [测] 椭圆规；拘束；枷锁；捕鱼网（trammel的复数）; v. 以网捕捉；限制；妨碍（trammel的单三形式）; 
- _[trammel net](dic://trammel%20net)_  n. 鸟网；鱼网
- untrammel
- entrammel

trebuchet (ballista)
- n. (中世的)抛石机, 小型秤, 小天平
- A trebuchet ([French](French_Language.html "French Language") _trébuchet_) is a type of [siege engine](Siege_engine.html "Siege engine") most frequently used in the [Middle Ages](Middle_Ages.html "Middle Ages"). It is sometimes called a counterweight trebuchet or counterpoise trebuchet, to distinguish it from an earlier weapon called the traction trebuchet, where men pulling ropes provided the power.
- [catapult](dic://catapult), [arbalest](dic://arbalest), [arbalist](dic://arbalist), [ballista](dic://ballista), [bricole](dic://bricole), [mangonel](dic://mangonel), [onager](dic://onager), [trebucket](dic://trebucket)
- _n._ [artillery](dic://artillery), [heavy weapon](dic://heavy weapon), [gun](dic://gun), [ordnance](dic://ordnance)
- **cannon**大炮;**rockets**火箭，烟火;**cannons**大炮;**gunpowder**火药;**launcher**发射者;**projectile**发射体;**castle**城堡;**archers**弓箭手;**rocket**火箭;**siege**围攻;**artillery**炮, 大炮;
...
- [spend](dic://spend), [pass](dic://pass), [act](dic://act), [behave](dic://behave), [do](dic://do), [consider](dic://consider), [take](dic://take)
...
trombone
- **saxophone**萨克斯管;**clarinet**单簧管;**trumpet**喇叭;**oboe**双簧管;**sax**萨克斯管;**flute**长笛;**violin**小提琴;**piano**钢琴;**percussion**碰撞;**harmonica**口琴;**cello**大提琴;
- There are some wonderful trumpet and trombone solos in the piece. /这支乐曲中有一些美妙的小号和长号的独奏。
- trombonist

troth
- n. 诚实；诺言  vt. 与……订婚
- **pledge**发誓;**thee**你;**vow**发誓;**oath**誓言，誓约;**mistress**情妇;**allegiance**忠诚;**thy**你的;**vows**婚誓;
- [betrothal](dic://betrothal), [engagement](dic://engagement)
- _[plight one's troth](dic://plight%20one%27s%20troth)_  发誓
...
- _n._ [sovereign](dic://sovereign), [crowned head](dic://crowned head), [monarch](dic://monarch)
- **czar**沙皇，皇帝;**emperor**皇帝，君主;**Putin**普京;**Russia**俄罗斯;**Bolshevik**布尔什维克;**Russian**俄国的;**Novgorod**诺夫哥罗德;**monarch**君主，帝王;**Stalin**斯大林;**sultan**苏丹;**Moscow**莫斯科;
- tsarist
	- **Bolshevik**布尔什维克;**Russian**俄国的;**Russia**俄罗斯;**USSR**苏维埃社会主义共和国联盟;**imperial**皇帝的;**Stalin**斯大林;**Prussian**普鲁士的;**Lenin**列宁;**KGB**克格勃，苏联国家安全委员会;**Moscow**莫斯科;**aristocracy**贵族;
	- [czarist](dic://czarist), [czaristic](dic://czaristic), [tsaristic](dic://tsaristic), [tzarist](dic://tzarist)
	- 
	- _[Tsarist Russia](dic://Tsarist%20Russia)_ 沙皇俄国; 帝俄; 沙俄; 
...
turret
-  来自拉丁语 turris,高塔，塔楼，高层建筑，词源同 tor,tower.-et,小词后缀。引申词义炮塔。
- n. 炮塔；角楼；小塔；攻城用的冲车 
- n. 防御塔（游戏《英雄联盟》中的防御建筑）
- [gun enclosure](dic://gun enclosure), [gun turret](dic://gun turret)
- _n._ [tower](dic://tower), [platform](dic://platform), [weapons platform](dic://weapons platform)
- **gunner**炮手，枪手;**cannon**大炮;**cannons**大炮;**armament**武器;**anti-aircraft**防空用的;**hull**船体;**tower**塔;**torpedo**鱼雷;**launcher**发射者;**artillery**炮, 大炮;**tank**坦克;
- _turret lathe_ 六角车床，转塔车床；多角车床
- _gun turret_ 炮塔
- the gunner injured his arm in the turret mechanism. /炮手在炮塔机械装置中伤了手臂。
- We're taking fire from an automated turret. /我们遭遇了自动炮塔。
- This was the same turret that was used on Germany's main battle ships. /这个炮塔与德国主战舰上使用的炮塔相同。
- Gun turret. Are you all right? /炮塔你还好吗？
...
## U
umbrage
- [offense](dic://offense), [offence](dic://offence)
- _n._ [anger](dic://anger), [choler](dic://choler), [ire](dic://ire)
...
-  _[take umbrage](dic://take%20umbrage)_  生气; 见怪;
- _[take umbrage over](dic://take%20umbrage%20over)_ 感到在…上受侮辱或委; 感到在…上受侮辱或委屈;
- sheltered in the umbrage of a rain forest. See also Synonyms at nuance /躲蔽在雨林树荫下

urchin
- _n._ [child](dic://child), [kid](dic://kid), [youngster](dic://youngster), [minor](dic://minor), [shaver](dic://shaver), [nipper](dic://nipper), [small fry](dic://small fry)
- **octopus**章鱼;**eel**鳝鱼;**squid**鱿鱼;**seaweed**海藻，海草;**jellyfish**水母;**turtle**海龟;**scallops**扇贝;**sea**海洋;**crabs**吊钳;**snail**蜗牛;**crab**螃蟹;
- _sea urchin_ 海胆
- 7 Kinds Nigiri Sushi (Tuna, Salmon, Kanpachi, Prawn, Salmon Roe, Urchin, Grilled Eel) /7种握卷（金枪鱼，三文鱼,红甘鱼,大虾,三文鱼籽,海胆,扒鳗）
- But you could spot us a mile away, the urchins from the lanes. We had that look /但你能在一英里外就认出我们的出身，小巷里的野孩子。我们有那种面相。
- Cobblers are Black Sea urchins, you don't see that anymore. /“Cobblers”是黑海海胆，现在你再也看不到了。
...
## V
vacillate (oscillate)
- _v._ [hesitate](dic://hesitate), [waver](dic://waver), [waffle](dic://waffle), [swing](dic://swing)
- _[vacillating and staggering](dic://vacillating%20and%20staggering)_  摇摇晃晃（vacillating是vacillate的现在分词，staggering是stagger的现在分词）
- **ambivalent**对某物、某人或某境况具有或显示矛盾情感的;**seeming**外观;**fluctuate**波动;**tend**趋向，倾向;**perpetually**持久地;**tendency**倾向，趋势;**loathe**讨厌，厌恶;**agonizing**使人极度痛苦的;**wildly**野生地;**fluctuating**上下浮动的;**fickle**易变的;
...
- vacillation (irresolution)
	-  [hesitation](dic://hesitation), [wavering](dic://wavering)
	-  [swing](dic://swing), [swinging](dic://swinging)
	- _n._ [indecision](dic://indecision), [indecisiveness](dic://indecisiveness), [irresolution](dic://irresolution), [motion](dic://motion), [movement](dic://movement), [move](dic://move)
	- **impatience**急躁;**reluctance**不愿意;**inconsistency**矛盾;**ambiguity**歧义;**uncertainty**不确定;**weakness**弱点;**inaction**不活动;**cowardice**懦弱;**indifference**不关心,不在乎;**contradiction**矛盾;**dissatisfaction**不满;
	- There is vacillation in his k's and self-esteem in his capitals. /他的k字写得不一律，大写的字母倒还工整。
	- But Trump has remained determined to carry out his trade agenda, in contrast to his vacillations on other issues. /但特朗普依然坚持要推行他的贸易议程，他的这一举动与他在其他问题上的犹豫不决形成了鲜明的对比。
	- And I think that's some of what he'd seen this week and the vacillations on immigration are all over the place /我认为这就是特朗普本周看到的情况，各地在移民问题上都犹豫不决。
- vacillating
...
- _[insipid vapid](dic://insipid%20vapid)_ 食物不好吃的
- _[vapid zesty](dic://vapid%20zesty)_ 乏味的
- lacklustre pulseless sapless spiritless vapid 无生气
- rapid sapid vapid 迅速的
- **inane**愚蠢的;**banal**陈腐的;**pretentious**自命不凡的;**drivel**淌口水,说傻话;**idiotic**白痴的;**crass**粗鲁的;**mindless**不小心的;**pathetic**可怜的，悲哀的;**trashy**碎屑的;**narcissistic**自我陶醉的;**whiny**烦躁的;
- vapidity
...
- **colloquial**口语的, 会话的;**idiom**成语，习语;**slang**俚语;**dialect**方言，土话;**lexicon**词典，辞典;**lingo**行话;**language**语言;**archaic**古代的;**dialects**乡土语言，方言;**vocabulary**词汇;**modernist**现代主义的;
- _[vernacular](dic://vernacular)_  adj. 本国的；地方的；用本地语写成的; n. 本地话，方言；动植物的俗名; 
- _[vernacular paper](dic://vernacular%20paper)_  本国文报纸
- _[vernacular chinese](dic://vernacular%20chinese)_  白话
- _[vernacular dwelling](dic://vernacular%20dwelling)_  民居
...
- an ornamental coating to a building
	- [facing](dic://facing)
- cover with veneer
- **wood**木材;**plywood**夹板，胶合板;**paneling**镶板;**facade**正面;**laminate**切成薄板;**faux**假的,伪的;**MDF**主配线架，总配线架;**hardwood**硬木，硬木材;**pretense**借口;**walnut**胡桃木;**cabinetry**内阁;
- _wood veneer_ 薄木片
- _veneer board_ 胶合板
- _core veneer_ 中心单板
- a veneer of western civilization. 一层西方文明的外表
...
- a long flag; often tapering
	- [pennant](dic://pennant), [pennon](dic://pennon), [streamer](dic://streamer)
- be driven or carried along, as by the air
- _n._ [flag](dic://flag)
- _v._ [float](dic://float), [drift](dic://drift), [be adrift](dic://be adrift), [blow](dic://blow)
- **whiff**喷出;**smell**嗅，闻;**aroma**芳香;**stench**恶臭;**breezes**轻而易举的事;**smelling**嗅诊;**scent**气味;**inhale**吸入;**linger**逗留, 徘徊;**scents**气味;**pungent**刺激性的;
...
- [wamble](dic://wamble)
- [wag](dic://wag)
- waggled down the steps /摇晃着下台阶
- waggled her foot impatiently /焦急地摆着她的脚
...
- Definitely! With the public disclosure, buyers' confidence seems to be waning /是啊，一经曝光，消费者就信心大减。
- wax and wane
- ebb and flow

warble (different from shirk/caterwauling)
-  可能来自拟声词，或来自 PIE*wer,弯，转，词源同 vibrate,wring.用于指颤音，莺啼鸟啭。
- n. 用颤音唱的歌, 鸟啭, 颤声; 牛皮下的肿块  v. 鸟鸣, 用柔和的颤声唱
-  [trill](dic://trill), [quaver](dic://quaver)
-  [yodel](dic://yodel), [descant](dic://descant)
- _n._ [animal disease](dic://animal disease)
- _v._ [sing](dic://sing)
...
- vt. 警告, 提醒, 通知  
- vi. 发出警告
- 来自 PIE*wer,覆盖，保护，看管，看护，词源同 ward,ware.引申词义提醒，警告。词义演变比较 monster,admonish.
-  [discourage](dic://discourage), [admonish](dic://admonish), [monish](dic://monish)
- _v._ [inform](dic://inform), [rede](dic://rede), [advise](dic://advise), [counsel](dic://counsel), [order](dic://order), [tell](dic://tell), [enjoin](dic://enjoin)
- [advise](dic://advise) 普通用词，泛指劝告，不涉及对方是否听从劝告。  
- [caution](dic://caution) 主要指针对有潜在危险而提出的警告，含小心从事的意味。  
- [warn](dic://warn) 含义与caution相同，但语气较重，尤指重后果。  
- [admonish](dic://admonish) 一般指年长者或领导对已犯错误的或有过失的人提出的忠告或警告以避免类似错误。  
- [counsel](dic://counsel) 正式用词，语气比advise强一些，侧重指对重要问题提出的劝告、建议或咨询。
- **beware**当心，小心;**heed**注意，留心;**advise**劝告，忠告;**advised**细想过的;**dissuade**劝阻，劝止;**reassure**使…安心，使消除疑虑;**tell**告诉，说;**frighten**使惊吓;**alerting**报警;**cautions**注意事项;**remind**提醒;
- warning shot
	- 警告性枪击：发出的警告性枪击。 警示行动：旨在警示的行动。
	- Video footage showed soldiers firing warning shots. /视频显示士兵们正在鸣枪示警。
	- They fired warning shots with machine guns and flares /这几只战斗机用机关枪和信号弹鸣枪警告。
	- That was just a **warning** **shot** /那只是给你们个警告。
- warning
- warner
- unwarned
- forewarn
...
- awash
	- overed with water
		-  [afloat(p)](dic://afloat(p)), [flooded](dic://flooded), [inundated](dic://inundated), [overflowing](dic://overflowing)
	- _adj._ [full](dic://full)
...
- wayworn
- wayward
	- (slapdash, sloppy, reckless, haphazard, wayward, arbitrary, erratic, helter-skelter, )
...
- wayleave
- waylay, waylaid
	- _[ambuscade ambush lurk wait waylay](dic://ambuscade%20ambush%20lurk%20wait%20waylay)_ 埋伏
	...
	- Scientific careers can be made or waylaid on the basis of publications /科研事业奠定的基础取决于论文的发表。
	- Capitan. Excuse me. The locals told me your voyage was waylaid, sir. /船长 打扰了 当地人说你们航行时遭受攻击。
- waygoing, wayfaring
- waybill
...
weave
- [tissue](dic://tissue)
- [interweave](dic://interweave)
- [waver](dic://waver)
- [wind](dic://wind), [thread](dic://thread), [meander](dic://meander), [wander](dic://wander)
- _n._ [design](dic://design), [pattern](dic://pattern), [figure](dic://figure)
- _v._ [twist](dic://twist), [twine](dic://twine), [distort](dic://distort), [create from raw material](dic://create from raw material), [create from raw stuff](dic://create from raw stuff), [swing](dic://swing), [sway](dic://sway)
- _n._ [unweave](dic://unweave)
	- [knit](dic://knit) 指用织钟把毛线等编织成衣物等。  
	- [weave](dic://weave) 指用机器或手工编织物品
- **interwoven**交织的;**tapestry**挂毯;**braided**编辫子的;**strands**线;**tangled**纠缠的;**braid**辫子;**tangle**混乱状态;**yarns**纱线;**knotted**多节的，有节的;**unravel**解开;**loom**织布机
- _satin weave_ 缎织；缎纹组织
- _weave structure_ 织物组织
- _weave through_ 穿梭
- _weave into_ 把...交织在一起
- weaving
- weaver
- weaverbird
- unweave
...
wheel
- wheelwright
	- _n._ [wright](dic://wright)
	- **blacksmith**铁匠;**carpenter**木工, 木匠;**apprentice**学徒, 徒弟;**craftsman**工匠;**miller**碾磨工;**clergyman**牧师;**carpentry**木工手艺;**smith**铁匠;**apprenticeship**学徒期;**barber**为…理发;**grocer**杂货店;
	- She was a wheelwright's orphan. And she was hungry. /她爹是车匠 父母双亡。她当时饥肠辘辘。
	- n. 车轮（尤指木轮）修造工，轮匠
- wheelsman
- wheelman
- wheelless
...
- wheeler
- wheelchair
	- _n._ [chair](dic://chair)
	- **handicapped**残疾的;**crutches**拐杖，支撑物;**walker**步行者;**scooter**小轮摩托车;**wheeled**有轮的;**handicap**障碍;**disability**无能力, 无力;**motorized**装上发动机的;**disabled**残废的，有缺陷的;**bicycle**自行车;**chair**椅子;
- wheelbase
	- _n._ 前后轮之车轮轴距离,轴距
	- _n._ [distance](dic://distance)
	- **chassis**底盘，底架;**sedan**轿车;**sedans**箱式轿车;**hatchback**装有向上开的后车门的小轿车;**coupe**小轿车;**axles**四轴;**axle**车轴;**fenders**防撞垫;**drivetrain**动力传动系统;**legroom**放脚空间;**cornering**转弯,股票囤积,回转;
	- Regulators multiply a car's wheelbase length by its width to get a footprint /监管机构将一辆车的轴距长度乘以其宽度，从而得到其足迹。
	- That's over the wheelbase. Are you completely unfamiliar with the suspension characteristics of a pre-1980 Pullmanbuilt Superliner Deluxe passenger coach? /这座位正好在轴距上，你难道一点不清楚80年代前所造豪华乘坐席悬挂系统的特性吗？
	- 
- wheelbarrow
	- _n._ [handcart](dic://handcart), [pushcart](dic://pushcart), [cart](dic://cart), [go-cart](dic://go-cart)
	- _v._ [transport](dic://transport)
	- **shovel**铁铲;**tractor**拖拉机;**hauling**搬运;**cart**二轮运货马车;**trolley**手推车;**wheeled**有轮的;**mulch**覆盖物，护盖物;**lorry**卡车;**forklift**铲车;**bucket**【C】水桶;**wagon**货车，四轮马车;
	- the wheelbarrow can be awkward to manoeuvre. /独轮手车很难操纵。
	- Is that wheelbarrow going to tump over? .那个手推车是不是快倒了?
	- we trundled a wheelbarrow down to the river and collected driftwood. /我们费力地推着手推车来到河边收集浮木。
	- So you've better have brought a wheelbarrow or something. /所以你最好带了个手推车什么的。
	- This ancient version of a wheelchair was basically a wheelbarrow that was refitted to carry someone around /这种古代版本的轮椅简单来说就是一辆经过改装的手推车，可以载人。
	- One lady brought biscuit on a wheelbarrow. It weighed nearly 500 pounds. /一位女士用手推车运来一个饼干，重达500磅左右。
- wheelage
- web-wheel
- waterwheel
- treadwheel
...
- drivewheel
- cogwheel
	- [gear](dic://gear), [gear wheel](dic://gear wheel), [geared wheel](dic://geared wheel)
	- _n._ [wheel](dic://wheel)
	- **cog**给…装配齿轮;**gears**齿轮，传动装置;
	- Take two cogwheels with two teeth /拿两个有两个齿的齿轮。
- cartwheel

weeny
- [bitty](dic://bitty), [bittie](dic://bittie), [teensy](dic://teensy), [teentsy](dic://teentsy), [teeny](dic://teeny), [wee](dic://wee), [weensy](dic://weensy), [teensy-weensy](dic://teensy-weensy), [teeny-weeny](dic://teeny-weeny), [itty-bitty](dic://itty-bitty), [itsy-bitsy](dic://itsy-bitsy)
- **teeny**极小的;**tiny**微小的;**wee**极小的;**little**小的;**minuscule**小写字;**small**少的，小的;**tad**少量;**bit**少量;**bugger**家伙;**dainty**秀丽的;**insignificant**无价值的, 无意义的, 无用的;
- _adj._ [small](dic://small), [little](dic://little)
- _n._ [large](dic://large), [big](dic://big)
- _[teeny weeny](dic://teeny%20weeny)_  小小的; 小额的;
- doesn't he have a teeny-weeny twinge of conscience?. /难道他一丁点儿都不感到内疚吗？。
- No, just for a teeny weeny bit. /没有啦，只是一点点。
- The weeny's waking up from a nap. /小狗从午睡中醒来。
- Look, the sunshine has made my plant grow a tiny weeny bit. /看，阳光让我的植物长出了一点点。

weep
- vi. 哭泣；流泪；哀悼；滴落；渗出液体
- vt. 悲叹；哭泣；流泪；流出或渗出液
- n. 哭泣；滴下；[俚]眼泪
- _v._ [express emotion](dic://express emotion), [express feelings](dic://express feelings)
- [cry](dic://cry) 普通用词。指因痛苦、悲哀或伤感等出声地哭。  
- [weep](dic://weep) 书面用词，指小哭或无声地哭，侧重流泪。  
- [sob](dic://sob) 指抽泣、呜咽。 cunning,sly
- **cry**叫喊;**mourn**哀悼;**lament**悲叹;**sorrow**悲伤;**sob**啜泣，呜咽;**cried**哭泣;**rejoice**高兴;**tears**眼泪;**tremble**战栗;**laugh**笑;**crying**叫喊的，嚎哭的;
- _weep for_ 为…而哭泣
- _weep over_ 因…而哭泣；为…流泪
- Don't weep about me. /别为我哭泣。
- weep sb.'s untimely death /为某人的早死而悲叹
- weep bitter tears of remorse. /流下悔恨痛苦的泪水
- Laugh and the world laughs with you, weep and you weep alone /当你笑时, 整个世界同你一起欢笑, 当你哭泣时, 却只有你一人独自悲哀。
- she was weeping loudly and her nose was running. /她大声哭泣，鼻子流着鼻涕。
- St Ambrose would weep bitter tears when confessing a sinner. /圣安布罗斯聆听罪人忏悔时，会流下悲苦的泪水。
- She swooned, she wept, she ravishingly died, a vision of unknowable Swedish beauty /她昏倒了，她哭泣了，她令人神魂颠倒地死去了，这是一种道不明的瑞典之美。
- She was weeping freely. I was extraordinarily touched /她的眼泪一个劲儿往下落。我心里难过极了。
- And the forest was weeping tears of sap begging to be saved. /森林洒下哭泣的树液，苦苦乞求救援。
- Yes! Did you want me to weep with joy? /废话 难不成你还想让我留下幸福的泪水？
- Do not weep, Princess, I have an idea /不要哭，公主，我有办法。
- weepy
	- _adj._ 要哭的；眼泪汪汪的
	- (故事、电影等)使人伤心的
	- _adj._ [tearful](dic://tearful)
	- _n._ [tearless](dic://tearless), [dry-eyed](dic://dry-eyed)
	- **sobbing**湿透的;**whiny**烦躁的;**cranky**暴躁的;**sad**悲哀的，令人悲痛的;**hysterical**情绪异常激动的, 歇斯底里般的;**sentimental**伤感的, 多愁善感的;**crying**叫喊的，嚎哭的;**weeping**哭泣的，滴水的;**giddy**头晕的;**melancholy**忧郁, 悲哀;**mushy**糊状的;
	- a weepy clingy child. /动不动就哭又离不开人的小孩
	- She is still feeling weepy /她仍觉得想哭。
	- Stop being weepy! I can’t stand you anymore! /别再哭哭啼啼的，我再也受不了你了！
	- Interesting. That might explain my weepy days in the middle of the month. /有意思 难怪我每月中旬都会两眼泪汪汪。
	- She was boisterous and garrulous one minute, then weepy and furious the next. /前一分钟她还在喧闹、喋喋不休，下一分钟就又哭又怒。
- weeping
- weeper

wedge
- [wedge shape](dic://wedge shape), [cuneus](dic://cuneus)
- [bomber](dic://bomber), [grinder](dic://grinder), [hero](dic://hero), [hero sandwich](dic://hero sandwich), [hoagie](dic://hoagie), [hoagy](dic://hoagy), [Cuban sandwich](dic://Cuban sandwich), [Italian sandwich](dic://Italian sandwich), [poor boy](dic://poor boy), [sub](dic://sub), [submarine](dic://submarine), [submarine sandwich](dic://submarine sandwich), [torpedo](dic://torpedo), [zep](dic://zep)
- [hacek](dic://hacek)
- [wedge heel](dic://wedge heel)
- [chock](dic://chock)
- [lodge](dic://lodge), [stick](dic://stick), [deposit](dic://deposit)
- [squeeze](dic://squeeze), [force](dic://force)
- _n._ [triangle](dic://triangle), [trigon](dic://trigon), [trilateral](dic://trilateral), [sandwich](dic://sandwich), [diacritical mark](dic://diacritical mark), [diacritic](dic://diacritic), [heel](dic://heel)
- _v._ [fasten](dic://fasten), [fix](dic://fix), [secure](dic://secure), [move](dic://move), [displace](dic://displace)
- **heel**脚后跟;**triangular**三角形的;**shaft**柄;**cone**圆锥体，圆锥形;**angled**成角的;**shank**胫;**conical**圆锥形的;**concave**凹的，凹面的;**toe**脚趾;**hole**洞，孔;
- a wedge of pie /一块楔形的馅饼
- wedge oneself into a crowd /挤在人群中间
- a wedge in the war on poverty. /引起对贫困宣战的一项起因
- wedge a window to prevent it from rattling /用楔将窗户塞紧, 使不作响
- The box won't wedge into such a narrow space. /那盒无法塞进那么小的地方去。
- I'm not trying to drive a wedge between you and your father. /我并非想使你和你父亲不和。
- He wedged himself through the narrow window. /他从狭窄的窗户中挤了过去。
- he invested his wedge in stocks and shares /他把他的收入投资股票。
- she wedged her holdall between two bags /她在两个袋子之间夹了一个手提包。
- Now wouldn't that drive a wedge in your relationship? /这难道不会破坏你们的关系吗？
- We share it across all the wedges that too often divide us /我们跨越所有经常使我们分裂的因素。
- Can't give a wedge to law enforcement, a way in. /不能给司法机关留有契机。
- What she's trying to do is, she's trying to drive a wedge between us. /这就是她想要做的，她想要挑拨我们的关系。
- wedgy
- wedging
- wedgie
- wedgewise
...
- [wallow](dic://wallow)
- _n._ [disorderliness](dic://disorderliness), [disorder](dic://disorder)
- _v._ [roll over](dic://roll over), [move](dic://move)
- there's such a welter of conflicting rules /有一大批杂乱的互相冲突的规定。
- a welter of papers and magazines /一堆混乱报纸与杂志
- amidst this welter of confusing signals, it's difficult to winnow out the truth. /在杂乱无章的信号之中，要辨别真相很困难。
- the attack petered out in a welter of bloody, confused fighting. /那次攻击结果变成了一次血腥的、一片混乱的战斗。
- They came in with a whole welter of songs /他们回来时带回了大量的歌曲。
- Grant's mind was a welter of broken ends and unrelated facts. /格兰特的脑子里满是支离破碎和不相关的事实。
- Gazing out at the bleak expanse of tents extending for miles over a trodden welter of slush and snow, Anthony saw the impracticability of trudging to a telephone that night. /安东尼凝视着在踩踏的泥泞和积雪的泥泞中延伸数英里的凄凉帐篷， 看到那天晚上跋涉到电话是不切实
...
- the film is an awkward blend of whimsy and moralizing. /这部电影是离奇情节和说教的蹩脚结合
- I have a strong suspicion our hosts are inclined to whimsy /我有很强的预感，这家主人喜欢奇思妙想。
- It’s in villages like these where common-sense has stood firm against the fickle winds of architectural whimsy /在这样的村庄里，奇异妙想的建筑风格敌不过平凡常见的建筑。
...
- the shortlist of fifteen was whittled down to five /15人的候选名单最后削减为5人。
...
whew
- _[whew](dic://whew)_  int. （惊讶、宽慰或感到很热、疲劳时发出的声音）哟，噢
- Whew! What a sizzler 唷! 多热的天哪!
...
- with a whisk of his hand /用手一拂
- The horse was whisking its tail. /马甩尾巴。
- a whisk round St Basil's cathedral. /走马观花地游览圣巴兹尔大教堂。
- whiskery
- whisker
	...
	- They came within a whisker of being killed /他们险些丟了性
	- You escaped serious injury by a whisker, so consider yourselves very lucky /你差一点就受重伤,你应该觉得自己很幸运。
...
- wonderous
- wonderment
	- **amazement**惊奇, 惊愕;**awe**使敬畏;**astonishment**惊讶, 惊奇;**delight**高兴;**excitement**兴奋, 激动;**curiosity**好奇心, 爱打听的癖性;**disbelief**不相信, 怀疑;**joy**欢乐，快乐;**wondrous**令人惊奇的;**marvel**奇迹;**trepidation**惊恐;
- wonderful
...
- your sense of judgement is a bit wonky at the moment /此刻你的判断力有点问题。
...
wreck
- [shipwreck](dic://shipwreck)
- [crash](dic://crash)
- [bust up](dic://bust up), [wrack](dic://wrack)
- _n._ [decline](dic://decline), [declination](dic://declination), [accident](dic://accident), [ship](dic://ship)
- _v._ [destroy](dic://destroy), [ruin](dic://ruin)
	- [break](dic://break) 普通用词，指某物因被打破或撕破而受到破坏，可指有形或无形的破坏。  
	- [destroy](dic://destroy) 多指彻底地、毁灭性地破坏，含导致无用，不能或很难再修复的意味。  
	- [ruin](dic://ruin) 多指因外部原因而受到严重破坏或毁灭，侧重破坏的彻底性，也可用于引申意义。  
	- [wreck](dic://wreck) 侧重指船只、车辆、房屋等受到严重破坏或完全毁坏，也可指计划、健康受到损害。  
	- [damage](dic://damage) 多指对无生命物体的损害，造成降低价值、破坏功能等后果。  
	- [spoil](dic://spoil) 强调不仅会削弱力量、精力或价值，而且会导致不可避免的毁灭。
- **wreckage**残骸;**shipwreck**海难, 船只失事;**accident**事故;**crash**碰撞;**collision**碰撞, 冲突, 抵触;**havoc**大破坏;**ruin**毁坏;**salvage**打捞;**derailed**出轨;**crashed**失事的;**disaster**不幸;
- wrecking
- wrecker
- wreckage
	- _n._ [part](dic://part), [portion](dic://portion)
	- **rubble**碎石，碎砖;**wreck**失事;**debris**散落的碎片, 残骸;**charred**烧黑了的，烧焦的;**wrecked**失事的;**shipwreck**海难, 船只失事;**ruins**废墟;**remnants**残余;**corpses**尸体;**crash**碰撞;**crashed**失事的;
- shipwreck
...
- _[Writhing Mound](dic://Writhing%20Mound)_ 痛苦之丘
- _[writhing snakes](dic://writhing%20snakes)_ 蠕动的蛇
...
- [yeastlike](dic://yeastlike)
- [zestful](dic://zestful), [zesty](dic://zesty), [barmy](dic://barmy)
- _adj._ [yeast](dic://yeast), [spirited](dic://spirited), [creative](dic://creative), [originative](dic://originative)
- _n._ [spiritless](dic://spiritless), [uncreative](dic://uncreative)
- **malty**麦芽的;**fruity**有果味的;**yeast**酵母;**mouthfeel**口感;**aroma**芳香;**malt**麦芽;**carbonation**碳酸饱和,碳酸化作用;**earthy**土的;**sourdough**酵母;**chewy**柔软而会黏着的;**tangy**有刺激性的;
- _[foamy spumescent spumous yeasty](dic://foamy%20spumescent%20spumous%20yeasty)_ 起泡沫的
- _[yeasty odor](dic://yeasty%20odor)_ 酵母昧
- _[yeasty aroma](dic://yeasty%20aroma)_ 酵母香
- _[A yeasty froth](dic://A%20yeasty%20froth)_ 发酵面团; 家酿发酵啤酒; 
- _[A yeasty comedy](dic://A%20yeasty%20comedy)_ 浅薄的喜剧
- yeasty
	- adj. 酵母的；起泡沫的；会发酵的；动荡的
...
- 在古代，法国人喝饮料时，喜欢在饮料中添加一些新鲜的柠檬皮或柑橘皮，用来增加饮料的口味。这种用来增加饮料口味的水果皮就被称为zeste，进入英语后演变成为zest，用来表示“可增添口味的东西”，进而引申为“风味、乐趣”等意思。  
	...
	- zesty：['zesti] adj. 兴致很高的vt. 给…增兴趣  
	- zestful：['zɛstfəl] adj. 风趣的；有风味的；热心的，有热情的
- zesty
- zestocautery
	- zest【n. 兴趣, 热情, 风味, 热心】 + caust-烧
	- 蒸汽烙管, 蒸汽烙器
	- zestocausis
		- 蒸汽灼法(用含有过热蒸汽的管,施行烧灼治疗)
- zestful
	- [yeasty](dic://yeasty), [zesty](dic://zesty), [barmy](dic://barmy)
	- _adj._ [spirited](dic://spirited)
	- _n._ [spiritless](dic://spiritless)
...
- a. 零的, 没有的
- vt. 调零, 对(炮火等)作协调校正
- zero - zero是又一个源于阿拉伯语的科技用词。意为“空的”或“零”的阿拉伯语sifr进入意大利语后，先是拼作zefiro，以后缩略为zero，法语从意大利语吸收了这个词，作zéro，仍用以指“零”，以后英语又从法语直接借了过来。但zero是直到17世纪初期才在英语里被用作数字零的名称。英语另有一个词cipher（亦作cypher），在被用以表示“密码”之前也一度指“零”。其实它也源于同一个阿拉伯词，即sifr。
- ground zero
	- “爆心投影点”组织；着地点；原爆点
	- This is ground zero for the immigration. /这里是移民的起点。
	- They have a helicopter to get into exactly ground zero. /直升机带领医生直达疫情中心。
	- It is destined to become ground zero for the retail apocalypse. /它注定会成为零售业末日的起点。
	- A metal cross he found at Ground Zero awards his helmets /他在世贸中心遗址上找到的一个金属十字架放在他的头盔上。
	- This is ground zero. This is the beginning of the African imprint on America. /这是完全未知的土地，也是非洲在美国留下烙印的开始。
- zeroth
- zeroize
- zeroing
- zerogel
