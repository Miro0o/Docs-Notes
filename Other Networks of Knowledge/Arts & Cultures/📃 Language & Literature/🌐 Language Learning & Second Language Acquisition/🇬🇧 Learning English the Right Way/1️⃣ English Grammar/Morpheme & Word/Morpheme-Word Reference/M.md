...
4. **migr-** = remove, 「latin」migrare "to wander, move"
	1. emigrant, emigrate, emigre
	3. immigrant, immigrate, 
	4. intermigration
	5. migrant, migrate
		1. migratory, migrator, migration, migrateur
	6. transmigrant, transmigrate, 
	7. transmogrify
...
8. dismiss
	...
	16. dismissal
		1. _n._ [judgment](dic://judgment), [judgement](dic://judgement), [judicial decision](dic://judicial%20decision), [notice](dic://notice), [permission](dic://permission), [termination](dic://termination), [ending](dic://ending)
		2. **resignation**辞职;**reinstatement**复职;**expulsion**喷出, 排出;**termination**终止;**dismiss**离开;**acquittal**宣告无罪;**revocation**废止;**disqualification**不合格;**refusal**拒绝;**indictment**起诉;**retaliation**报复;
		3. _unfair dismissal_ 不公平解雇
		4. He recriminated against his employers for dismissal. /他反诉他的雇主开除他。
		5. Bernice flapped a hand at him in dismissal. /伯尼斯一只手向他挥了挥，让他离开。
		6. To be insubordinate is to invite dismissal from a corporation. /不服从将会被公司解雇。
		7. On Wednesday, Trump wrote about Lauer's dismissal on Twitter. /周三，特朗普发推特调侃劳厄尔被解雇一事。
		8. I think we can expect them to refile this complaint. They may also appeal this dismissal. /我想我们可以期待他们再次提出申诉。他们也可以对这一驳回裁决提出上诉。
		9. Our dismissal was quiet and unpronounced. /我们的解散是悄无声息的。
9. admit
	...
	19. admitted
		1. unadmitted
		2. admittedly
			1. He is looking to improve on his admittedly modest achievements so far. /迄今为止，他的成就的确不算大，他打算更进一步。
			2. He is admittedly an atheist. /他被公认是位无神论者。
			3. Admittedly, self-improvement is crucial for new graduates to hunt jobs. /毋庸置疑，对于应届生而言，自我发展对于找工作尤为重要。
			4. Admittedly, all of London probably reeked high hell back then. /说实话，当时的整个伦敦可能都臭气熏天。
			5. Making movies admittedly had less drastic consequences in the most professions /诚然，跟其它职业相比，拍电影不会带来太严重的后果。
	20. admittance
		1. _n._ [right](dic://right), [entrance](dic://entrance), [entering](dic://entering), [entry](dic://entry), [ingress](dic://ingress), [incoming](dic://incoming)
			1. [entrance](dic://entrance) 含义广泛，作“进入”解时，可用于许多场合；作“入口”解时，指有门或栏的入口处。  
			2. [entry](dic://entry) 强调正式地、礼仪地进入。用作“入口”解时，多指房门、院门、门廊等。  
			3. [admittance](dic://admittance) 指许可进入某地或某建筑物。  
			4. [admission](dic://admission) 指被允许进入某公共场所或建筑物的权利，也指进入某一组织。
		2. **admission**承认;**entrance**入口;**acceptance**接受, 认可;**invitation**邀请;**admitted**公认的;
		3. _admittance matrix_ 导纳矩阵
		4. _no admittance_ 闲人免进；禁止入内
	21. admittable
	22. admission
		1. readmission
10. commit
