...
1. ==**cap-, capt-, cept-, ceiv-, cip-, cup-** = take, hold, seize; latin (capere)==
	...
	8.  percept
		...
		4. perceive
			1. per-完全的 + ceive=cip-抓住，理解。
			2.  - 来自拉丁语percipere,得到，抓住，来自per-,完全的，-cip,抓住，理解，词源同conceive,percipient.引申词义感觉，感知。
			3.  [comprehend](dic://comprehend)
			4. _v._ [understand](dic://understand), [realize](dic://realize), [realise](dic://realise), [see](dic://see)
			5. **perception**感知;**discern**识别;**comprehend**理解, 领会;**recognize**承认;**interpret**解释;**react**反应;**understand**懂;**distinguish**辨别, 区别;**observe**观察;**realize**实现;**infer**推断;
			6. _perceive as_ 视为；当作
			7. You are perceived to accept his offer. /有人得知, 你要接受他的条件。
			8. They perceived that they were unwelcome and left. /他们意识到他们是不受欢迎的, 于是就离开了。
			9. The thief was perceived to steal into the house. /有人看见小偷溜进那房子里去了。
			10. I can't perceive any difference between these coins. /我看不出这些硬币的区别。
		5. misperceive
		6. percipiency
		7. percipient
			1. a. 知觉的, 有知觉的, 目光敏锐的, 观察深刻的 
			2. n. 知觉者, 鉴赏力, 心灵感应者
			3. 1 - per-,完全的，-cip,抓住，词源同 capable,participate.引申词义完全理解的，敏锐的。
			4. per-完全 + cip-抓住 + -i- + ent
			...
			6. _adj._ k[discerning](dic://discerning)
			7. _n._ [undiscerning](dic://undiscerning)
			8. **perceptive**敏感的;**observer**遵守者;**perceptual**知觉的,有知觉的;**impartial**不偏不倚的;**lucid**易懂的;**consciousness**意识;**transcendental**超凡的;**immaterial**非物质的;**conscious**意识到的;
			9. The real space is public, the apparent space is private to the percipient. /真实空间是公共的， 表象空间对感知者来说是私人的。
			10. They did not prove that the colour is in the mind of the percipient. /他们没有证明颜色在感知者的脑海中。
		8. perceptual
			1. _adj._ [sensing](dic://sensing), [perception](dic://perception)
			...
			3. _perceptual knowledge_ 感性认识
			4. _perceptual experience_ 知觉经验；感性经验
			5. _perceptual organization_ 知觉组织
		9. percept
	...
	9. precept
		...
		3. _n._ [rule](dic://rule), [prescript](dic://prescript), [doctrine](dic://doctrine), [philosophy](dic://philosophy), [philosophical system](dic://philosophical%20system), [school of thought](dic://school%20of%20thought), [ism](dic://ism)
		...
		5. You won’t find this moral precept in the scriptures. /你在《圣经》中找不到这种道德规范。
		6. Armed with such a precept,a number of doctors may slip into deceptive practices. /有了这样一条指导原则,一些医生可能渐渐习惯于采取骗人的做法。
	...
	14. capture, recapture
		1. captive
			...
			3. [unfree](dic://unfree), [attentive](dic://attentive)
	...
	15. capable, 
		1. capacious
			1. capacity
				...
				2.  [content](dic://content)
				3.  [capacitance](dic://capacitance), [electrical capacity](dic://electrical capacity)
				4.  [mental ability](dic://mental ability)
				5. _n._ [capability](dic://capability), [capableness](dic://capableness), [susceptibility](dic://susceptibility), [susceptibleness](dic://susceptibleness), [volume](dic://volume), [production](dic://production), [function](dic://function)
				6. _n._ [incapacity](dic://incapacity)
					...
					5. [talent](dic://talent) 着重指人某方面具有可发展和培养的突出天赋才能，但语意比genius弱。  
				...
				7. **capability**能力;**throughput**生产量,生产能力,吞吐量;**power**能力;**maximum**极大，最大限度;**ability**能力，能耐;**utilization**利用;**sufficient**足够的;**accommodate**容纳;**demand**要求;
				8. _production capacity_ 生产能力；生产力
				9. _bearing capacity_ 承载量；结果能力；产仔能力
				10. _capacity for_ …的能力
				11. _carrying capacity_ 承载能力；载运容量
			2. _[To build capacity](dic://To%20build%20capacity)_ 培养能力
			3. _[building governing capacity](dic://building%20governing%20capacity)_ 执政能力建设
			4. _[building up governing capacity](dic://building%20up%20governing%20capacity)_ 加强执政能力建设
...
7. **hav- = possess, (habban 「old english」, "to have, hold")**
	1. behave
...
1. **cap-, cipit-** = head, latin (caput)
	...
	4. capitate
		1. a. 头状的
		2. decapitate
			2. decapitate - 古罗马军队常常在旷野上扎营操练。英语表示“军营”、“营地”等义的camp一词原先就有“旷野”之义，它源自拉丁语campus'field'（旷野，场地）。出自这一拉丁词源的还有campaign（战役），campus（校园），champion（冠军，斗士），decamp（撤营，逃亡）等词。古时的campaign通常也是在旷野上进行的，而campaign一词本身则是转由法语campagne 'open country'（空旷的地方）演化而来。campus虽被直接吸收用以指“校园”，但仍不失其原义field（场地）。champion乃运动场上的胜利者，多多少少保留了field的含义。decamp系camp加上前缀de-（表示“离开”）所构成。
			3. vt. 斩首, 杀头, 开除
			4. _v._ [kill](dic://kill)
			5. **kill**杀死;**assassinate**暗杀，行刺;**kidnap**绑架;**stab**刺;**injure**伤害，损害;**slay**杀害;**beheaded**身首异处的;**topple**倾倒;**killing**杀害的;**axe**斧;**chop**砍;
			6. _[decapitate](dic://decapitate)_  vt. 斩首；解雇；使无效
			7. _[decapitating hook](dic://decapitating%20hook)_  断胎头钩，胎儿断头钩
			8. Today, those foreign countries are fearful of dollar inflation, which could **decapitate** their own bank reserves. 今天，这些国家担心美元会通胀，进而可能导致它们的银行储备严重缩水。
		3. capitatum
		4. capitation
	...
	6. capitulates (recapitulate) (capitulate, subjugate, subdue, succumb)
		...
		4. _[capitulate](dic://capitulate)_  vi. 认输，屈服；屈从，停止反抗；有条件投降；让步
		5. the patriots had to capitulate to the enemy forces /爱国者不得不向敌军屈服。
		6. Or capitulating to bison at the entrance to Yellowstone. /或者在黄石公园入口处向野牛投降。
		7. But then, to the dismay of the Indian supporters, he capitulated, ending Carlsen an unassailable lead and the world crown. /但最后，令印度支持者失望的是，阿南德投降了，卡尔森当仁不让地领先一步，成为世界冠军。
		8. The ememy was warned to capitulate or face annihilation. /敌人受到警告，要么投降，要么全部被歼灭。
		9. capitulation, capitulationist
		...
		10. recapitulate (capitulate)
			...
			4. _[to recapitulate](dic://to%20recapitulate)_ 重述要点
			5. _[recapitulate detail](dic://recapitulate%20detail)_ 简述要旨; 摘要重述; 
			6. _[recapitulate vt](dic://recapitulate%20vt)_ 概括
			7. _[recapitulate summarize outline](dic://recapitulate%20summarize%20outline)_ 扼要; 说明;
			8. recapitulatory
			9. recapitulative
			10. recapitulation
	7. chief
	...
	9. kerchief
		...
		3. **handkerchief**手帕;**scarf**围巾;**shawl**围巾，长方形披巾;**tunic**束腰外衣;**hat**帽子;**robe**长袍，礼服;**cloak**斗蓬;**blouse**宽松的上衣;**headband**头饰带;**apron**围裙;**embroidered**绣花的;
		3. kerchieft
		4. kerchiefed
		5. handkerchief
			1. _n._ [piece of cloth](dic://piece of cloth), [piece of material](dic://piece of material)
			2. **napkin**餐巾;**cloth**布，织物;**towel**毛巾，手巾;**robe**长袍，礼服;**blouse**宽松的上衣;**scarf**围巾;**shirt**衬衫;**embroidered**绣花的;**napkins**餐巾纸;**cloths**织物;**cloak**斗蓬;
			3. _[handkerchief](dic://handkerchief)_  n. 手帕；头巾，围巾
			4. _[silk handkerchief](dic://silk%20handkerchief)_  丝帕
	10. mischief
		1. reckless or malicious behavior that causes discomfort or annoyance in others 
			1. [mischief-making](dic://mischief-making), [mischievousness](dic://mischievousness), [deviltry](dic://deviltry), [devilry](dic://devilry), [devilment](dic://devilment), [rascality](dic://rascality), [roguery](dic://roguery), [roguishness](dic://roguishness), [shenanigan](dic://shenanigan)
		2. the quality or nature of being harmful or evil
			1.  [maleficence](dic://maleficence), [balefulness](dic://balefulness)
		3. _n._ [misbehavior](dic://misbehavior), [misbehaviour](dic://misbehaviour), [misdeed](dic://misdeed), [evil](dic://evil), [evilness](dic://evilness)
		4. **mischievous**淘气的, 顽皮的;**mayhem**大混乱, 大破坏;**pranks**恶作剧;**malice**怨恨;**havoc**大破坏;**silliness**愚蠢;**treachery**背信弃义, 不忠, 背叛;**antics**滑稽动作;**wickedness**邪恶;**malicious**恶意的, 恶毒的;**devious**弯曲的;
		5. The broken window was the mischief of vandals. /被打碎的窗户是那些故意破坏公物人造成的
		6. cogitate mischief against sb /想坏主意害人
		7. The mischief arose from irresponsible gossip. /这种不幸的事是因无聊的闲话而引起的。
		8. Nobody took notice of the mischief of the matter /没有人注意到这件事情所带来的危害。
		9. mischievous (misgiving)
			1. _adj._ [playful](dic://playful), [bad](dic://bad), [harmful](dic://harmful)
			2. _n._ [unplayful](dic://unplayful), [serious](dic://serious), [sober](dic://sober), [good](dic://good), [harmless](dic://harmless)
			3. **playful**爱嬉戏的;**cheeky**无耻的;**devious**弯曲的;**mischief**伤害;**sly**狡猾的;**inquisitive**好问的;**naughty**顽皮的，淘气的;**childlike**天真的;**lovable**可爱的，讨人喜欢的;**malevolent**有恶意的;**whimsical**异想天开的,闹着玩的;
			4. _[mischievous](dic://mischievous)_  adj. 淘气的；（人、行为等）恶作剧的；有害的
		10. mischievously
		11. mischievousness
	12. precipitate
		...
		14. precipitation
			...
			4. _acid precipitation_ n. 酸性降水
			5. _electrostatic precipitation_ 静电沉淀
			6. _alcohol precipitation_ 酒精沉淀法
			7. _atmospheric precipitation_ 大气降水，大气沉降；降水
	...
	14. cap
		...
		14. madcap
			...
			2. characterized by undue haste and lack of thought or deliberation
				1. [hotheaded](dic://hotheaded), [impulsive](dic://impulsive), [impetuous](dic://impetuous), [tearaway(a)](dic://tearaway(a)), [brainish](dic://brainish)
			3. _n._ [adventurer](dic://adventurer), [venturer](dic://venturer)
			4. _adj._ [incautious](dic://incautious)
			5. _n._ [cautious](dic://cautious)
		...
		15. kneecap
			...
			4. **knee**膝盖，膝;**ankle**踝关节，踝;**elbow**弯头;**femur**股骨;**shin**胫骨;**groin**腹股沟;**thigh**大腿，股;**pelvis**骨盆;**ankles**踝;**leg**腿;**forearm**前臂;
		...
		19. handicap, handicapped
			...
			3. 英语单词handicap就来自hand in cap，指的是赌博或比赛时为了实现公平性而进行的各种调整和设置。除了设置赔率外，另外最常用的方式是给优势方设置障碍或不利条件，如在赛马比赛中，给优势赛马增加负重。因此，handicap又衍生出“障碍、不利条件”的含义。在现代英语中，常用handicapped代替disabled，用来委婉地表示“身体残疾的”，意思是你太优秀了，老天为了让其他人能与你公平竞争才给你设置了一些不利条件。  
				1. handicap：['hændɪkæp] n.障碍，不利条件vt.妨碍，阻碍，使不利  
				2. handicapped：['hændɪkæpt] adj.残疾的，有生理缺陷的n.残疾人，缺陷者  
				3. handicapping system：差别积分制，机会均等化比赛法
			4.  [disability](dic://disability), [disablement](dic://disablement), [impairment](dic://impairment)
			5.  [hindrance](dic://hindrance), [hinderance](dic://hinderance), [deterrent](dic://deterrent), [impediment](dic://impediment), [balk](dic://balk), [baulk](dic://baulk), [check](dic://check)
			6.  [disable](dic://disable), [invalid](dic://invalid), [incapacitate](dic://incapacitate)
			7.  [hinder](dic://hinder), [hamper](dic://hamper)
			8. _n._ [unfitness](dic://unfitness), [softness](dic://softness), [poor shape](dic://poor shape), [bad condition](dic://bad condition), [advantage](dic://advantage), [vantage](dic://vantage), [difficulty](dic://difficulty)
			9. _v._ [injure](dic://injure), [wound](dic://wound), [bias](dic://bias), [disadvantage](dic://disadvantage), [disfavor](dic://disfavor), [disfavour](dic://disfavour)
			10. **wheelchair**轮椅;**disability**无能力, 无力;**disadvantage**不利, 劣势, 短处;
	...
	16. capital
		...
		4. 英语单词cattle（牛）其实与capital完全同源。拉丁语capitale中世纪进入法语后，法国农民觉得该拉丁语借词拗口难读，将它改成了catel；进入英语后，拼写进一步演变成了cattle。它的本意是动产，即牲畜的“头数”，后来逐渐变为“牲畜”本身，后来又缩小至“牛”。  
		5. capital：['kæpitəl] adj.首都的，重要的，大写的n.资本，资金，首都，省会，大写字母  
		6. capitalize：['kæpɪtəlaɪz] vt. 使资本化；以大写字母写；估计价值vi. 利用；积累资本  
		7. capitalism：['kæpɪtəlɪzəm] n. 资本主义  
		8. capitalist：['kæpɪtəlɪst] n. 资本家；资本主义者adj. 资本主义的；资本家的  
		9. cattle：['kæt(ə)l] n.牛，家畜，牲畜
		10. supercapital
		11. capitally
		12. capitalize, capitalise
			1. undercapitalize
			2. recapitalize
			3. overcapitalize
			4. capitalization
	...
	20. capstone
		...
		4. _[capstone experience](dic://capstone%20experience)_  巅峰历程; 高峰体验; 
		5. _[capstone design](dic://capstone%20design)_  高级毕业设计; 顶点设计; 高等设计; 
	...
	22. escape
		...
		3. 在古代欧洲的战场上，被击败的战士为了保命，往往会使出“金蝉脱壳”的招数，在被敌人抓住斗篷时脱掉斗篷而摆脱敌人，或在被敌人追赶时主动脱掉斗篷，趁敌人去捡斗篷时赶紧逃掉。因为在古代，一件斗篷算是不菲的财产，有钱人才穿得起。英语单词escape（逃脱）就跟古人脱掉斗篷保命的做法有关。它来自拉丁语excappare，由ex（out of）和cappa（cape，斗篷）构成，字面意思就是“脱掉斗篷”。  
			1. escape：[ɪ'skeɪp; e-] n.逃跑，逃亡vt.逃避，避开，避免vi.逃脱，溜走  
			2. escapee：[ɪ,ske'pi] n. 逃避者；逃亡者  
			3. escapism：[ɪ'skepɪzəm] n. 逃避现实，空想；逃避主义  
			4. escapist： [əs'kepɪst] n. 逃避现实者adj. 逃避现实的  
			5. escapable：[i'skeipəbl] adj. 可逃脱的；可以避免的
		4. **flee**消失，消散;**evade**逃避;**trapped**陷入困境的;**refuge**避难;**fleeing**逃离;**trap**诱捕;**kidnap**绑架;**freed**释放的;**getaway**逃走;**fled**消逝;**thwart**反对;
		5. [running away](dic://running away), [diversion](dic://diversion), [recreation](dic://recreation), [discharge](dic://discharge), [outpouring](dic://outpouring), [run](dic://run), [valve](dic://valve)
		6. [flee](dic://flee), [fly](dic://fly), [take flight](dic://take flight), [avoid](dic://avoid), [perplex](dic://perplex), [vex](dic://vex), [stick](dic://stick)
		7. escapology
		...
		9. escaper, escapee
		10. escapement
			1. a piano with an escapement action. /有控键装置的钢琴。
			2. 擒纵器
		11. escape-proof
		12. escapade
			...
			3. _[escapades](dic://escapades)_  n. 越轨行为；恶作剧；劣迹（escapade的复数
			4. These sexual escapades are just a sampling of what goes on beneath the waves. /这些性行为只是波涛之下发生的一个样本。
	...
	32. chaperon, chaperone
		...
		4. **babysitter**临时照顾幼儿者;**chauffeur**司机;**escort**护送;**escorting**护送者;
...
3. **capill-** = hair, 表示“头发，毛发”，专业词汇里译作“毛细（血）管”。是表示“头”的词根 cap- 的指小形式。源自拉丁语 caput "head"
	1. capillarity
		...
		2. The impetus of water uptake is "transpiration pull"and **capillarity** phenomena /水分上升的动力主要来自于植物的蒸腾拉力和导管的毛细作用。
	2. capillary
...
1. **-ard** = 表名词，“不好的人”。源自日耳曼语 *-hart, *-hard "hold, hardy."
	1. bastard
		...
		2. 在中世纪法国普罗旺斯地区，当地的赶骡人在乡村小店投宿时，往往将驮鞍铺开当做临时床铺使用。有些赶骡人生性风流，免不了拈花惹草，不少私生子就诞生于这样的驮鞍上。因此，法国人管这种私生子称为bastard（驮鞍之子），由bast（驮鞍）和表示人的名词后缀-ard组成。后缀ard常含有蔑视之意，如coward（胆小鬼）。但bastard一词当初仅表示非婚生子，并无贬义，如征服英国的威廉一世就被称为Williamthe Bastard（私生子威廉）。14世纪后期才逐渐衍生出“不纯、不真实”的含义，19世纪后开始用作骂人的脏话，相当于中文中的“杂种、王八蛋”。  
	...
	4. coward
		...
		3. 至于英美人也有Coward这一姓氏，倒是和胆小鬼毫无关系，而是因为其祖上是cowherd（牧牛人）的缘故，cowherd古时的词形为coward。
		4. cowardly
		5. cowardliness
		6. cowardice
...
2. **carc-, carcino-** = 表示“螃蟹，癌症”。源自希腊语 karkinos "cancer, crab."
	...
	3. cancer
	4. canker
		1. [canker sore](dic://canker sore)
		2. [pestilence](dic://pestilence)
		3. _n._ [plant disease](dic://plant disease), [ulcer](dic://ulcer), [ulceration](dic://ulceration), [influence](dic://influence)
		4. _v._ [sicken](dic://sicken), [come down](dic://come down), [infect](dic://infect)
		5. **sores**褥疮;**blight**枯萎病;**fungal**真菌的;**rot**腐烂;**fungus**真菌，霉菌;**ulcers**溃疡，疡;**ulcer**溃疡;**disease**病，疾病;**infection**传染;**infestation**群袭,出没,横行;**herpes**疱疹;
		6. [plant disease](dic://plant disease), [ulcer](dic://ulcer), [ulceration](dic://ulceration), [influence](dic://influence)
...
4. **cracy-, crat-** = rule, ruler, 表示“统治或政体，统治者”，最初含义表示“力量”。也引申为“支持者，参加者”等。源自希腊语 kratos "strength, might, power."
	...
	9. gerontocracy
	10. gynaecocracy
		1. _[gynaecocracy](dic://gynaecocracy)_  n. 妇女当政；女权政治
	11. gynecocracy, gynocracy
	12. hagiocracy
		1. _n._ 圣徒政治,圣徒政治的政府
	13. hierocracy
		1. _[hierocracy](dic://hierocracy)_  n. 僧侣统治，教士政治
	...
	15. idiosyncracy
		...
		3. _[organizational idiosyncracy](dic://organizational%20idiosyncracy)_ 组织特质
		4. _[cultural idiosyncracy](dic://cultural%20idiosyncracy)_ 中国传统文化特质
...
1. **cata-** = 向下，相反，离开
	1. catabolic (catabolic, anabolic, metabolic)
		...
		4. **metabolic**新陈代谢的;**anabolic**合成代谢的;**metabolism**新陈代谢;**anaerobic**厌氧菌的;**glycogen**糖原;**biochemical**生物化学的;**aerobic**需氧的;**oxidative**氧化的;**oxidation**氧化;**enzymatic**酶的;**carbohydrate**碳水化合物;
		5. _[catabolic](dic://catabolic)_  adj. 分解代谢的；异化的
		6. _[catabolic process](dic://catabolic%20process)_  分解代谢过程
		7. _[catabolic reaction](dic://catabolic%20reaction)_  分解反应
		8. This catabolic state leaves people feeling hungry, also known as polyphagia; “Phagia” means eating, and “Poly” means a lot. /该分解代谢过程会让人感到饥饿，也叫多食Polyphagia；其中Phagia指吃食，而Poly指多。
		9. catabolism, catabolize
		10. katabolism
	3. catachresis
	4. cateclasite
	...
	17. catapult
		...
		4. n. 弹射器, 弹弓, 弩炮 vt. 发射
		5. **propel**推进;**topple**倾倒;**rocket**火箭;**launch**发射;**cannon**大炮;**rockets**火箭，烟火;**launching**发射;**projectile**发射体;**cannons**大炮;**smash**打碎;**launcher**发射者;
		6. [plaything](dic://plaything), [toy](dic://toy), [device](dic://device), [artillery](dic://artillery), [heavy weapon](dic://heavy weapon), [gun](dic://gun), [ordnance](dic://ordnance)
		7. [propel](dic://propel), [impel](dic://impel), [hurl](dic://hurl), [hurtle](dic://hurtle), [cast](dic://cast)
		8. [slingshot](dic://slingshot), [sling](dic://sling)
	...
	20. catastrophe (cataclysm)
		1. _n._ [misfortune](dic://misfortune), [bad luck](dic://bad luck), [adversity](dic://adversity), [hardship](dic://hardship), [hard knocks](dic://hard knocks), [geological phenomenon](dic://geological phenomenon)
			...
			4. [misfortune](dic://misfortune) 普通用词，多批较为严重的不幸，强调不幸多由外界因素所致。
		2. **calamity**不幸事件;**disaster**不幸;**catastrophic**灾难性的;**devastation**毁灭;**crisis**危机;**meltdown**熔化;**apocalypse**启示, 天启;**crises**危机，紧要关头;**tragedy**悲剧;**collapse**倒塌;**upheaval**剧变;
		3. catastrophism, catastrophic
	21. catatonia
		1. cata- + ton-张力 + -ia
		2. n. 紧张症
		3. catatonic
	...
	25. cathedral, cathedra
		...
		2. _adj._ [cathedra](dic://cathedra), [bishop's throne](dic://bishop's throne)
			...
			2. [cathedral](dic://cathedral) 指一个教区内最大的教堂，即主教堂或总教堂，通常是装饰精良，宏伟肃穆
		3. **basilica**长方形会堂;**chapel**小教堂;**abbey**大修道院，大寺院;**church**教堂;**Romanesque**罗马式的;**diocese**主教管区, 教区;**archbishop**大主教;**nave**中殿;**monastery**修道院;**bishop**主教;**spire**尖塔
		4. _[cathedral](dic://cathedral)_  n. 大教堂
...
1. **caust-** = to burn, 表示“烧”。calm 原指正午阳光。源自希腊语 kaiein "to burn."
	...
	3. caustic
		...
		2. [acerb](dic://acerb), [acerbic](dic://acerbic), [acid](dic://acid), [acrid](dic://acrid), [bitter](dic://bitter), [blistering](dic://blistering), [sulfurous](dic://sulfurous), [sulphurous](dic://sulphurous), [venomous](dic://venomous), [virulent](dic://virulent), [vitriolic](dic://vitriolic)
		3.  [corrosive](dic://corrosive), [erosive](dic://erosive), [vitriolic](dic://vitriolic), [mordant](dic://mordant)
		4. _n._ [compound](dic://compound), [chemical compound](dic://chemical compound)
		5. _adj._ [unpleasant](dic://unpleasant), [destructive](dic://destructive)
		6. _n._ [pleasant](dic://pleasant), [constructive](dic://constructive)
		7. **corrosive**腐蚀的;**abrasive**磨料;**sarcastic**讽刺的;**acidic**酸的，酸性的;**snarky**恶声恶气的，咬人的;**venomous**有毒的;**irreverent**不敬的;**scathing**严厉的;**incendiary**放火的;**witty**诙谐的;**harsh**粗糙的;
		8. _caustic soda_ [化]苛性钠；氢氧化钠
		9. _spent caustic_ 废碱液
		10. a caustic smile /讥讽的微笑。
		11. a caustic liquid which blisters the skin /一种使皮肤起疱的腐蚀性液体。
		12. He opened his mouth to make a caustic retort. /他张嘴开始进行刻薄的反击。
		13. cautery
			1. caut-烧 + -ery
			2. n. 烧灼, 烧灼器, 腐蚀
		14. thermocaustica
...
1. **ced-, ceed-, cess-** = go away; withdraw; yield; latin (cedere)
	...
	2. access
		...
		3. [recover](dic://recover), [retrieve](dic://retrieve), [find](dic://find), [regain](dic://regain), [reach](dic://reach), [make](dic://make), [attain](dic://attain)
...
2. **cras-, crat-, cret-** = mixing, 「Greeks」krasis, "a mixing"
	...
	2. dyscrasia
	3. idiosyncratic
	6. syncretism, syncretize
		1. syncretic, syncretise
		2. **assimilate**吸收, 消化;**pagan**异教的;**integrate**使结合成为整体;**mysticism**神秘主义;**unify**统一;**Christianity**基督教;**Catholicism**天主教;**assimilation**同化;
		3. [blend](dic://blend), [flux](dic://flux), [mix](dic://mix), [conflate](dic://conflate), [commingle](dic://commingle), [immix](dic://immix), [fuse](dic://fuse)
3. crater
4. uproar
...
4. **cur-, curr-, curs-, cours-** = run, 表示“跑，发生”。源自拉丁语 currere "to run."
	...
	9. cursor
		...
		8. cursory
			...
			2. [casual](dic://casual), [passing(a)](dic://passing(a)), [perfunctory](dic://perfunctory)
			3. _adj._ [careless](dic://careless)
			4. _n._ [careful](dic://careful)
			5. **thorough**彻底的;**glance**一瞥;**scant**不足的;**brief**简短的，简洁的;**in-depth**深入的;**exhaustive**全面的, 彻底的, 透彻的;**quick**迅速的，快的;**rudimentary**基本的;**superficial**表面的;**admittedly**诚然;**extensive**广阔的, 广泛的;
			6. _[a cursory demonstrate](dic://a%20cursory%20demonstrate)_ 旷日持久的景象
			7. _[a cursory inspection](dic://a%20cursory%20inspection)_ 草率的检查
			8. _[a cursory search](dic://a%20cursory%20search)_ 粗略调查
			9. a cursory inspection /草率的检查
			10. a cursory glance at the figures. /匆匆瞥了一眼数据。
			11. give a cursory glance at the headlines in a newspaper /草草地看一眼报纸的标题
		10. cursoriness
...
6. **clos-, clud-, clus-** = close, 表示“关闭”。源自拉丁语 claudere 及变体 cludere "to shut", 其过去分词 clusus.
	...
	16. foreclose
		...
		3. foreclosure [fɔː'kləʊʒə] n.丧失抵押品赎回权。这里的fore-并不是单词forehead和foresee等中表“前”的fore-，而是拉丁词根for-，本意是door，指outside(of the door)，字面意思是“shutting out the owner”。债务人无力清偿债务时，债权人向法院申请将债务人名下房屋拍卖，以拍卖所得抵债。
		4. _v._ [reclaim](dic://reclaim), [repossess](dic://repossess)
		5. _[foreclose](dic://foreclose)_  vt. 阻止；排除；取消抵押品赎回权; vi. 取消抵押品赎回权; 
		6. _[foreclosed assets](dic://foreclosed%20assets)_  没收的抵押财产
		7. _[foreclose shipping](dic://foreclose%20shipping)_ 碍航
	...
	25. sluice
		...
		4. [sluice down](dic://sluice down)
		5. [flush](dic://flush)
		6. [pour](dic://pour), [pelt](dic://pelt), [stream](dic://stream), [rain cats and dogs](dic://rain cats and dogs), [rain buckets](dic://rain buckets), [drench](dic://drench), [douse](dic://douse)
...
1. **crypt-** = secret, hidden, 表示“秘密，隐藏”。源自希腊语 kruptein "to hide."
	...
	4. decrypt
	5. procryptic
	6. apocryphal.  (contrived, factitious, planned, plotted, apocryphal) (illusory, )
...
11. **crit-, cris-** = judge, discern, 表示“判断，分辨”。源自希腊语 krinein "to separate, decide, judge."
	...
	4. hypocrisy (apocryphal)
		1. hypocrisy [hɪ'pɒkrɪsɪ] n.虚伪；伪善。伪善其实是一种表演，表演？希腊前缀hypo-表示under，与拉丁前缀sub-同源（你坐过subway体贴吧），希腊词根cri-表区分、辨别、判断，-sy名词后缀。台上（人前）衣冠楚楚，台下（人后）禽兽不如。伪善是在台上，台下是真恶，因为下了台你才能辨别出来真相。 ​​​​
		2. 1 - 来自希腊语 hypokrisis,舞台表演，演戏，来自 hypo-,在下，-kris,分开，筛选，评论，词源同crisis,critic.来自于古希腊时期的一种舞台表演形式，即边说边紧跟着发表看法，评论或进行阐释，引申词义表演，演戏。现义伪善，虚伪义可能来自于此，或来自 hypo-,下面，欠缺，-kris,评论，观点，即不敢发表观点和看法的，掩饰真实情感的，引申词义伪善，虚伪。
		3. hypo-下面 + cris-判断
		4. hypocrite
		5. hypocritic
		6. hypocritical
