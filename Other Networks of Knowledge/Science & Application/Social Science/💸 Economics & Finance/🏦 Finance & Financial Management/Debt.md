...
**Debt** is an obligation that requires one party, the [debtor](https://en.wikipedia.org/wiki/Debtor "Debtor"), to pay [money](https://en.wikipedia.org/wiki/Money "Money") [borrowed](https://en.wikipedia.org/wiki/Loan "Loan") or otherwise withheld from another party, the [creditor](https://en.wikipedia.org/wiki/Creditor "Creditor"). Debt may be owed by a [sovereign state](https://en.wikipedia.org/wiki/Sovereign_state "Sovereign state") or country, [local government](https://en.wikipedia.org/wiki/Local_government "Local government"), [company](https://en.wikipedia.org/wiki/Company "Company"), or an individual. Commercial debt is generally subject to [contractual terms](https://en.wikipedia.org/wiki/Contractual_term "Contractual term") regarding the amount and timing of repayments of [principal](https://en.wikipedia.org/wiki/Debt#Principal) and [interest](https://en.wikipedia.org/wiki/Interest "Interest"). [Loans](https://en.wikipedia.org/wiki/Loan "Loan"), [bonds](https://en.wikipedia.org/wiki/Bond_\(finance\) "Bond (finance)"), notes, and [mortgages](https://en.wikipedia.org/wiki/Mortgage_loan "Mortgage loan") are all types of debt. In [financial accounting](https://en.wikipedia.org/wiki/Financial_accounting "Financial accounting"), debt is a type of [financial transaction](https://en.wikipedia.org/wiki/Financial_transaction "Financial transaction"), as distinct from [equity](https://en.wikipedia.org/wiki/Equity_\(finance\) "Equity (finance)").

The term can also be used metaphorically to cover [moral](https://en.wikipedia.org/wiki/Morality "Morality") obligations and other interactions not based on a monetary value. For example, in Western cultures, a person who has been helped by a second person is sometimes said to owe a "debt of gratitude" to the second person.
...
### Types of Borrowers ⭐
#### Individuals
> 🔗 https://en.wikipedia.org/wiki/Debt#Individuals
...
#### Businesses
> 🔗 https://en.wikipedia.org/wiki/Debt#Businesses
...
#### Governments
> 🔗 https://en.wikipedia.org/wiki/Debt#Governments
...
Debt issued by the government of the United States, called [Treasuries](https://en.wikipedia.org/wiki/United_States_Treasury_security "United States Treasury security"), serves as a reference point for all other debt. There are deep, transparent, liquid, and open capital markets for Treasuries. Furthermore, Treasuries are issued in a wide variety of maturities, from one day to thirty years, which facilitates comparing the interest rates on other debt to a security of comparable maturity. In finance, the theoretical "[risk-free interest rate](https://en.wikipedia.org/wiki/Risk-free_interest_rate "Risk-free interest rate")" is often approximated by practitioners by using the current yield of a Treasury of the same duration.

The overall level of indebtedness by a government is typically shown as a ratio of [debt-to-GDP](https://en.wikipedia.org/wiki/Debt-to-GDP_ratio "Debt-to-GDP ratio"). This ratio helps to assess the speed of changes in government indebtedness and the size of the debt due.

The United Nations [Sustainable Development Goal 17](https://en.wikipedia.org/wiki/Sustainable_Development_Goal_17 "Sustainable Development Goal 17"), an integral part of the [2030 Agenda](https://en.wikipedia.org/wiki/Sustainable_Development_Goals "Sustainable Development Goals") has a target to address the external debt of highly indebted poor countries to reduce debt distress.
#### Municipalities
> 🔗 https://en.wikipedia.org/wiki/Debt#Municipalities
